...
package ru.tinkoff.api.payments;
...
import ru.tinkoff.api.payments.model.AuthenticationFailedResponse;
import ru.tinkoff.api.payments.model.AuthorizationFailedResponse;
import ru.tinkoff.api.payments.model.BusinessErrorResponse;
import ru.tinkoff.api.payments.model.CreatePaymentDraftRequest;
import ru.tinkoff.api.payments.model.CreatePaymentDraftResponse;
import ru.tinkoff.api.payments.model.CreatePaymentRequest;
import ru.tinkoff.api.payments.model.CreateSbpPaymentRequest;
import ru.tinkoff.api.payments.model.InternalServerErrorResponse;
import ru.tinkoff.api.payments.model.InvalidRequestResponse;
import ru.tinkoff.api.payments.model.PaymentStatusResponse;
import ru.tinkoff.api.payments.model.TooManyRequestsErrorResponse;
...
public class PaymentsApi {
    ...
    /**
     * Build call for paymentsCoreGetStatus
     * @param paymentId Идентификатор платежа (required)
     ...
     */
    public okhttp3.Call paymentsCoreGetStatusCall(String paymentId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call paymentsCoreGetStatusValidateBeforeCall(String paymentId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'paymentId' is set
        if (paymentId == null) {
            throw new ApiException("Missing the required parameter 'paymentId' when calling paymentsCoreGetStatus(Async)");
        }
        

        okhttp3.Call localVarCall = paymentsCoreGetStatusCall(paymentId, _callback);
        return localVarCall;
     ...
     */
    public PaymentStatusResponse paymentsCoreGetStatus(String paymentId) throws ApiException {
        ApiResponse<PaymentStatusResponse> localVarResp = paymentsCoreGetStatusWithHttpInfo(paymentId);
     ...
     */
    public ApiResponse<PaymentStatusResponse> paymentsCoreGetStatusWithHttpInfo(String paymentId) throws ApiException {
        okhttp3.Call localVarCall = paymentsCoreGetStatusValidateBeforeCall(paymentId, null);
        Type localVarReturnType = new TypeToken<PaymentStatusResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * 🔒 Получить статус платежа (asynchronously)
     *  Данный метод позволяет узнать статус выплаты, произведенной с помощью методов  &lt;a href&#x3D;\&quot;#payment/PaymentsCorePay\&quot;&gt;Выполнить платеж&lt;/a&gt; и &lt;a href&#x3D;\&quot;#payment/SbpPay\&quot;&gt;Выполнить платёж через систему быстрых платежей (СБП)&lt;/a&gt;. В поле scopes у токена должен присутствовать хотя бы один scope вида: opensme/inn/[{inn}]/kpp/[{kpp}]/payments/rub-pay, где {inn} — ИНН клиента, а {kpp} — КПП клиента. opensme/inn/[{inn}]/kpp/[{kpp}]/payments/sbp-pay, где {inn} — ИНН клиента, а {kpp} — КПП клиента.  &lt;b&gt;Примечание для партнёров&lt;/b&gt;: В этом методе учитывается clientId, если ваш clientId был изменён, вы не сможете получить статус платежа, созданного при использовании старого clientId. clientId выдается при регистрации партнера в tinkoff и отправляется на почту. 
     * @param paymentId Идентификатор платежа (required)
     ...
     */
    public okhttp3.Call paymentsCoreGetStatusAsync(String paymentId, final ApiCallback<PaymentStatusResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = paymentsCoreGetStatusValidateBeforeCall(paymentId, _callback);
        Type localVarReturnType = new TypeToken<PaymentStatusResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for paymentsCorePay
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Платеж поставлен в очередь на исполнение </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Некорректный запрос </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Ошибка аутентификации </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Ошибка авторизации </td><td>  -  </td></tr>
        <tr><td> 422 </td><td> Ошибка при обработке данных </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call paymentsCorePayCall(CreatePaymentRequest createPaymentRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = createPaymentRequest;

        // create path and map variables
        String localVarPath = "/api/v1/payment/ruble-transfer/pay";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call paymentsCorePayValidateBeforeCall(CreatePaymentRequest createPaymentRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'createPaymentRequest' is set
        if (createPaymentRequest == null) {
            throw new ApiException("Missing the required parameter 'createPaymentRequest' when calling paymentsCorePay(Async)");
        }
        

        okhttp3.Call localVarCall = paymentsCorePayCall(createPaymentRequest, _callback);
        return localVarCall;
     ...
     */
    public void paymentsCorePay(CreatePaymentRequest createPaymentRequest) throws ApiException {
        paymentsCorePayWithHttpInfo(createPaymentRequest);
    }
     ...
     */
    public ApiResponse<Void> paymentsCorePayWithHttpInfo(CreatePaymentRequest createPaymentRequest) throws ApiException {
        okhttp3.Call localVarCall = paymentsCorePayValidateBeforeCall(createPaymentRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * 🔒 Выполнить платёж (asynchronously)
     *  Данный метод позволяет выплачивать деньги с рублевых счетов компании. Выплаты могут производиться на счета юрлиц и физлиц в банках РФ. При передаче информации в блоке \&quot;налоги\&quot; появляется возможность совершать налоговые платежи и налоговые платежи за третьих лиц. Выплата денег со счета производится асинхронно. Результат запроса на выплату можно получить, вызвав метод &lt;a href&#x3D;\&quot;#operation/PaymentsCoreGetStatus\&quot;&gt;Получить статуса платежа&lt;/a&gt;, передав в него соответствующий &lt;b&gt;paymentId&lt;/b&gt;. В поле scope у токена должен присутствовать доступ вида  opensme/inn/[{inn}]/kpp/[{kpp}]/payments/rub-pay, где {inn} — ИНН клиента, а {kpp} — КПП клиента.  &lt;b&gt;Все вызовы метода дедуплицируются:&lt;/b&gt;  &lt;b&gt;Селф-сервис:&lt;/b&gt; Дедупликация происходит по paymentId в контексте вашей компании. Это значит, что paymentId должен быть уникален в рамках всех платежей от лица вашей компании. Если будет произведено два и более вызова метода с одинаковыми paymentId в рамках одной компании, то будет создан только один платеж.  &lt;b&gt;Партерский сценарий:&lt;/b&gt; Дедупликация происходит по paymentId + clientId. Это значит, что связка paymentId + clientId должна быть уникальна. Если будет произведено два и более вызова метода с одинаковыми paymentId и clientId, то будет создан только один платеж. clientId выдается при регистрации партнера в tinkoff и отправляется на почту.  &lt;b&gt;Лимиты:&lt;/b&gt; По умолчанию на выполнение платежей через API установлены следующие лимиты: &lt;ul&gt;   &lt;li&gt;максимальная сумма одного платежа - 100000 рублей&lt;/li&gt;   &lt;li&gt;максимальная сумма платежей в день - 100000 рублей&lt;/li&gt;   &lt;li&gt;максимальная сумма платежей в месяц - 1000000 рублей&lt;/li&gt;   &lt;li&gt;максимальное количество платежей в день на одного контрагента - 3&lt;/li&gt; &lt;/ul&gt; Для изменения лимитов по вашей компании напишите на openapi@tinkoff.ru. 
     * @param createPaymentRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call paymentsCorePayAsync(CreatePaymentRequest createPaymentRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = paymentsCorePayValidateBeforeCall(createPaymentRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for postApiV1PaymentCreate
     * @param createPaymentDraftRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call postApiV1PaymentCreateCall(CreatePaymentDraftRequest createPaymentDraftRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = createPaymentDraftRequest;

        // create path and map variables
        String localVarPath = "/api/v1/payment/create";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postApiV1PaymentCreateValidateBeforeCall(CreatePaymentDraftRequest createPaymentDraftRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'createPaymentDraftRequest' is set
        if (createPaymentDraftRequest == null) {
            throw new ApiException("Missing the required parameter 'createPaymentDraftRequest' when calling postApiV1PaymentCreate(Async)");
        }
        

        okhttp3.Call localVarCall = postApiV1PaymentCreateCall(createPaymentDraftRequest, _callback);
        return localVarCall;
     ...
     */
    public CreatePaymentDraftResponse postApiV1PaymentCreate(CreatePaymentDraftRequest createPaymentDraftRequest) throws ApiException {
        ApiResponse<CreatePaymentDraftResponse> localVarResp = postApiV1PaymentCreateWithHttpInfo(createPaymentDraftRequest);
        return localVarResp.getData();
    }
     ...
     * Необходимо согласие пользователя на: \&quot;Доступ к созданию черновиков платежных поручений\&quot;. Подробнее про поля платежного поручения и их форматы можно почитать здесь: https://glavkniga.ru/situations/k503207. В поле scope у токена должен присутствовать доступ вида opensme/inn/[{inn}]/kpp/[{kpp}]/payments/draft/create, где {inn} — ИНН клиента, а {kpp} — КПП клиента.
     * @param createPaymentDraftRequest  (required)
     * @return ApiResponse&lt;CreatePaymentDraftResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CreatePaymentDraftResponse> postApiV1PaymentCreateWithHttpInfo(CreatePaymentDraftRequest createPaymentDraftRequest) throws ApiException {
        okhttp3.Call localVarCall = postApiV1PaymentCreateValidateBeforeCall(createPaymentDraftRequest, null);
        Type localVarReturnType = new TypeToken<CreatePaymentDraftResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Создать черновик платежного поручения (asynchronously)
     * Необходимо согласие пользователя на: \&quot;Доступ к созданию черновиков платежных поручений\&quot;. Подробнее про поля платежного поручения и их форматы можно почитать здесь: https://glavkniga.ru/situations/k503207. В поле scope у токена должен присутствовать доступ вида opensme/inn/[{inn}]/kpp/[{kpp}]/payments/draft/create, где {inn} — ИНН клиента, а {kpp} — КПП клиента.
     * @param createPaymentDraftRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call postApiV1PaymentCreateAsync(CreatePaymentDraftRequest createPaymentDraftRequest, final ApiCallback<CreatePaymentDraftResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = postApiV1PaymentCreateValidateBeforeCall(createPaymentDraftRequest, _callback);
        Type localVarReturnType = new TypeToken<CreatePaymentDraftResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for sbpPay
     * @param createSbpPaymentRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call sbpPayCall(CreateSbpPaymentRequest createSbpPaymentRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = createSbpPaymentRequest;

        // create path and map variables
        String localVarPath = "/api/v1/payment/sbp/pay";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sbpPayValidateBeforeCall(CreateSbpPaymentRequest createSbpPaymentRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'createSbpPaymentRequest' is set
        if (createSbpPaymentRequest == null) {
            throw new ApiException("Missing the required parameter 'createSbpPaymentRequest' when calling sbpPay(Async)");
        }
        

        okhttp3.Call localVarCall = sbpPayCall(createSbpPaymentRequest, _callback);
        return localVarCall;
     ...
     */
    public void sbpPay(CreateSbpPaymentRequest createSbpPaymentRequest) throws ApiException {
        sbpPayWithHttpInfo(createSbpPaymentRequest);
    }
     ...
     */
    public ApiResponse<Void> sbpPayWithHttpInfo(CreateSbpPaymentRequest createSbpPaymentRequest) throws ApiException {
        okhttp3.Call localVarCall = sbpPayValidateBeforeCall(createSbpPaymentRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * 🔒 Выполнить платёж через систему быстрых платежей (СБП) (asynchronously)
     *  Данный метод позволяет производить выплаты с рублевых счетов компании через систему быстрых платежей (СБП). Выплаты производятся по номеру телефона на счета физлиц в банках РФ, подключенных к системе быстрых платежей. Выплата денег со счета производится асинхронно. Результат запроса на выплату можно получить, вызвав метод &lt;a href&#x3D;\&quot;#operation/PaymentsCoreGetStatus\&quot;&gt;Получить статуса платежа&lt;/a&gt;, передав в него соответствующий &lt;b&gt;paymentId&lt;/b&gt;. В поле scope у токена должен присутствовать доступ вида  opensme/inn/[{inn}]/kpp/[{kpp}]/payments/sbp-pay, где {inn} — ИНН клиента, а {kpp} — КПП клиента.  Для совершения выплаты необходимо указать идентификатор банка {bankId} в системе СБП.  &lt;b&gt;Список банков, поддерживающих переводы физлицам через систему СБП:&lt;/b&gt;  Наименование | bankId ----------------------|------------- Тинькофф Банк | 100000000004 ВТБ | 100000000005 ЮМани | 100000000022 Банк АВАНГАРД | 100000000028 Газэнергобанк | 100000000043 Экспобанк | 100000000044 КБ ПЛАТИНА | 100000000048 Банк ВБРР | 100000000049 ТОЧКА (ФК ОТКРЫТИЕ) | 100000000065 АБ РОССИЯ | 100000000095 КБ Модульбанк | 100000000099 Русское финансовое общество | 100000000104 МСП Банк | 100000000246  &lt;b&gt;Все вызовы метода дедуплицируются:&lt;/b&gt;  &lt;b&gt;Селф-сервис:&lt;/b&gt; Дедупликация происходит по paymentId в контексте вашей компании. Это значит, что paymentId должен быть уникален в рамках всех платежей от лица вашей компании. Если будет произведено два и более вызова метода с одинаковыми paymentId в рамках одной компании, то будет создан только один платеж.  &lt;b&gt;Партерский сценарий:&lt;/b&gt; Дедупликация происходит по paymentId + clientId. Это значит, что связка paymentId + clientId должна быть уникальна. Если будет произведено два и более вызова метода с одинаковыми paymentId и clientId, то будет создан только один платеж. clientId выдается при регистрации партнера в tinkoff и отправляется на почту.  &lt;b&gt;Лимиты:&lt;/b&gt; По умолчанию на выполнение платежей через API установлены следующие лимиты: &lt;ul&gt;   &lt;li&gt;максимальная сумма одного платежа - 100000 рублей&lt;/li&gt;   &lt;li&gt;максимальная сумма платежей в день - 100000 рублей&lt;/li&gt;   &lt;li&gt;максимальная сумма платежей в месяц - 1000000 рублей&lt;/li&gt;   &lt;li&gt;максимальное количество платежей в день на одного контрагента - 3&lt;/li&gt; &lt;/ul&gt; Для изменения лимитов по вашей компании напишите на openapi@tinkoff.ru. 
     * @param createSbpPaymentRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call sbpPayAsync(CreateSbpPaymentRequest createSbpPaymentRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = sbpPayValidateBeforeCall(createSbpPaymentRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
