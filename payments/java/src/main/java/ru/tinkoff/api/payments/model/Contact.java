...
import ru.tinkoff.api.payments.model.IdentificationDocument;
import ru.tinkoff.api.payments.model.Phone;
...
public class Contact {
  ...
  private List<IdentificationDocument> documents = null;
  ...
  **/
  ...
  public Contact documents(List<IdentificationDocument> documents) {
    
    this.documents = documents;
    return this;
  }

  public Contact addDocumentsItem(IdentificationDocument documentsItem) {
   ...
   /**
   * Документы удостоверяющие личность. Для роли REALTOR может быть пустым
   * @return documents
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Документы удостоверяющие личность. Для роли REALTOR может быть пустым")
  ...
  **/
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "Уникальный идентификатор контакта")
  ...
  **/
   ...
   * @return role
  **/
  @ApiModelProperty(required = true, value = "Роль")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.birthDate, contact.birthDate) &&
        Objects.equals(this.documents, contact.documents) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(birthDate, documents, firstName, id, lastName, middleName, phones, role);
  }
