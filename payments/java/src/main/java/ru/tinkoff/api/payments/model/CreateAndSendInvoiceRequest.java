...
import ru.tinkoff.api.payments.model.Email;
import ru.tinkoff.api.payments.model.InvoiceItemInfo;
import ru.tinkoff.api.payments.model.InvoicePayerInfo;
...
public class CreateAndSendInvoiceRequest {
  ...
  private List<Email> contacts = null;
  ...
  private List<InvoiceItemInfo> items = null;

  public static final String SERIALIZED_NAME_PAYER = "payer";
  @SerializedName(SERIALIZED_NAME_PAYER)
  private InvoicePayerInfo payer;


  public CreateAndSendInvoiceRequest accountNumber(String accountNumber) {
   ...
   /**
   * Рублевый расчетный счет отправителя. Если счет не указан, то для выставления счета будет использоваться главный счет компании.
   * @return accountNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Рублевый расчетный счет отправителя. Если счет не указан, то для выставления счета будет использоваться главный счет компании.")
  ...
  public CreateAndSendInvoiceRequest contacts(List<Email> contacts) {
    
    this.contacts = contacts;
    return this;
  }

  public CreateAndSendInvoiceRequest addContactsItem(Email contactsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Контакты для получения счета")
  ...
  public void setContacts(List<Email> contacts) {
    this.contacts = contacts;
  }


  public CreateAndSendInvoiceRequest dueDate(LocalDate dueDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Срок оплаты. Должен быть не меньше даты выставления счета.")
  ...
  public CreateAndSendInvoiceRequest invoiceDate(LocalDate invoiceDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Дата выставления счета. Если не указана, счет выставляется текущей датой.")
  ...
  public CreateAndSendInvoiceRequest invoiceNumber(String invoiceNumber) {
  ...
  **/
  ...
  public CreateAndSendInvoiceRequest items(List<InvoiceItemInfo> items) {
    
    this.items = items;
    return this;
  }

  public CreateAndSendInvoiceRequest addItemsItem(InvoiceItemInfo itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Позиции счета")
  ...
  public CreateAndSendInvoiceRequest payer(InvoicePayerInfo payer) {
  ...
  **/
  ...
  public InvoicePayerInfo getPayer() {
    return payer;
  }


  public void setPayer(InvoicePayerInfo payer) {
    this.payer = payer;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateAndSendInvoiceRequest createAndSendInvoiceRequest = (CreateAndSendInvoiceRequest) o;
    return Objects.equals(this.accountNumber, createAndSendInvoiceRequest.accountNumber) &&
        Objects.equals(this.contacts, createAndSendInvoiceRequest.contacts) &&
        Objects.equals(this.dueDate, createAndSendInvoiceRequest.dueDate) &&
        Objects.equals(this.invoiceDate, createAndSendInvoiceRequest.invoiceDate) &&
        Objects.equals(this.invoiceNumber, createAndSendInvoiceRequest.invoiceNumber) &&
        Objects.equals(this.items, createAndSendInvoiceRequest.items) &&
        Objects.equals(this.payer, createAndSendInvoiceRequest.payer);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, contacts, dueDate, invoiceDate, invoiceNumber, items, payer);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateAndSendInvoiceRequest {\n");
