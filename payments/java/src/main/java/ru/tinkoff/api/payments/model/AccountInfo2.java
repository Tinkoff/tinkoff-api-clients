...
import ru.tinkoff.api.payments.model.Balance;
import ru.tinkoff.api.payments.model.TransitAccount;
...
public class AccountInfo2 {
  ...
  public static final String SERIALIZED_NAME_TRANSIT_ACCOUNT = "transitAccount";
  @SerializedName(SERIALIZED_NAME_TRANSIT_ACCOUNT)
  private TransitAccount transitAccount;


  public AccountInfo2 accountNumber(String accountNumber) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Расчетный счет организации")
  ...
  public AccountInfo2 accountType(String accountType) {
   ...
   /**
   *  Тип счета. Может принимать одно из следующих значений(список вариантов значений может пополняться): &lt;ul&gt; &lt;li&gt;Current - расчетный счет&lt;/li&gt; &lt;li&gt;Tax - счет Тинькофф Бухгалтерии&lt;/li&gt; &lt;li&gt;Overnight - счет Overnight &lt;/li&gt; &lt;li&gt;Cashbox - бизнес-копилка &lt;/li&gt; &lt;li&gt;Tender - специальный счет для участия в госзакупках &lt;/li&gt; &lt;li&gt;Trust - специальный счет доверительного управляющего ПИФ &lt;/li&gt; &lt;li&gt;Broker - специальный брокерский счет&lt;/li&gt; &lt;li&gt;BankPaymentAgent - специальный счет банковского платежного агента &lt;/li&gt; &lt;li&gt;PaymentAgent - счет платежного агента &lt;/li&gt; &lt;li&gt;Nominal - номинальный счет &lt;/li&gt; &lt;li&gt;NominalIpo - номинальный счет оператора инвестиционной платформы&lt;/li&gt; &lt;li&gt;TrustManagementSmp - специальный счет доверительного управления &lt;/li&gt; &lt;/ul&gt; 
   * @return accountType
  **/
  @ApiModelProperty(required = true, value = " Тип счета. Может принимать одно из следующих значений(список вариантов значений может пополняться): <ul> <li>Current - расчетный счет</li> <li>Tax - счет Тинькофф Бухгалтерии</li> <li>Overnight - счет Overnight </li> <li>Cashbox - бизнес-копилка </li> <li>Tender - специальный счет для участия в госзакупках </li> <li>Trust - специальный счет доверительного управляющего ПИФ </li> <li>Broker - специальный брокерский счет</li> <li>BankPaymentAgent - специальный счет банковского платежного агента </li> <li>PaymentAgent - счет платежного агента </li> <li>Nominal - номинальный счет </li> <li>NominalIpo - номинальный счет оператора инвестиционной платформы</li> <li>TrustManagementSmp - специальный счет доверительного управления </li> </ul> ")
  ...
  public AccountInfo2 activationDate(LocalDate activationDate) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Дата активации")
  ...
  public AccountInfo2 balance(Balance balance) {
  ...
  **/
  ...
  public AccountInfo2 bankBik(String bankBik) {
  ...
  **/
  ...
  public AccountInfo2 currency(String currency) {
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "Код валюты счета по ОКВ (цифрами)")
  ...
  public AccountInfo2 name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Наименование счета")
  ...
  public AccountInfo2 transitAccount(TransitAccount transitAccount) {
  ...
  **/
  ...
  public TransitAccount getTransitAccount() {
    return transitAccount;
  }


  public void setTransitAccount(TransitAccount transitAccount) {
    this.transitAccount = transitAccount;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountNumber, accountInfo2.accountNumber) &&
        Objects.equals(this.accountType, accountInfo2.accountType) &&
        Objects.equals(this.activationDate, accountInfo2.activationDate) &&
        Objects.equals(this.balance, accountInfo2.balance) &&
        Objects.equals(this.bankBik, accountInfo2.bankBik) &&
        Objects.equals(this.currency, accountInfo2.currency) &&
        Objects.equals(this.name, accountInfo2.name) &&
        Objects.equals(this.transitAccount, accountInfo2.transitAccount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, accountType, activationDate, balance, bankBik, currency, name, transitAccount);
  }
  ...
  public String toString() {
    ...
    sb.append("    transitAccount: ").append(toIndentedString(transitAccount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
