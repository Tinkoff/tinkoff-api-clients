...
public class MerchantCategory {
  ...
  public static final String SERIALIZED_NAME_CATEGORY_WEIGHT = "categoryWeight";
  ...
  public static final String SERIALIZED_NAME_MERCHANT_CATEGORY_WEIGHT = "merchantCategoryWeight";
  @SerializedName(SERIALIZED_NAME_MERCHANT_CATEGORY_WEIGHT)
  private Integer merchantCategoryWeight;
  ...
  public MerchantCategory categoryId(Long categoryId) {
   ...
   * @return categoryId
  **/
  @ApiModelProperty(required = true, value = "Id категории.")
  ...
  public MerchantCategory categoryType(String categoryType) {
   ...
   /**
   * Тип категории. Доступные значения &#39;STANDARD&#39;, &#39;PROMO&#39;.
   * @return categoryType
  **/
  @ApiModelProperty(required = true, value = "Тип категории. Доступные значения 'STANDARD', 'PROMO'.")
  ...
  public MerchantCategory categoryWeight(Integer categoryWeight) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Вес категории.")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Код категории.")
  ...
  public MerchantCategory imagePath(String imagePath) {
   ...
   * @return imagePath
  **/
  @ApiModelProperty(required = true, value = "Ссылка на картинку категории.")
  ...
  public MerchantCategory merchantCategoryWeight(Integer merchantCategoryWeight) {
    
    this.merchantCategoryWeight = merchantCategoryWeight;
    return this;
  }

   /**
   * Вес партнера в категории.
   * @return merchantCategoryWeight
  **/
  @ApiModelProperty(required = true, value = "Вес партнера в категории.")

  public Integer getMerchantCategoryWeight() {
    return merchantCategoryWeight;
  }


  public void setMerchantCategoryWeight(Integer merchantCategoryWeight) {
    this.merchantCategoryWeight = merchantCategoryWeight;
  }


  public MerchantCategory name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Наименование категории.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.categoryId, merchantCategory.categoryId) &&
        Objects.equals(this.categoryType, merchantCategory.categoryType) &&
        Objects.equals(this.categoryWeight, merchantCategory.categoryWeight) &&
        Objects.equals(this.code, merchantCategory.code) &&
        Objects.equals(this.imagePath, merchantCategory.imagePath) &&
        Objects.equals(this.merchantCategoryWeight, merchantCategory.merchantCategoryWeight) &&
        Objects.equals(this.name, merchantCategory.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(categoryId, categoryType, categoryWeight, code, imagePath, merchantCategoryWeight, name);
  }
  ...
  public String toString() {
    ...
    sb.append("    merchantCategoryWeight: ").append(toIndentedString(merchantCategoryWeight)).append("\n");
