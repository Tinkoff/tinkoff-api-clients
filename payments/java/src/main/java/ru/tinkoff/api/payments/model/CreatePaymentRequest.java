...
import ru.tinkoff.api.payments.model.PayerRequisites;
import ru.tinkoff.api.payments.model.ReceiverRequisites;
import ru.tinkoff.api.payments.model.TaxPaymentParameters;
...
public class CreatePaymentRequest {
  ...
  public static final String SERIALIZED_NAME_COLLECTION_AMOUNT = "collectionAmount";
  @SerializedName(SERIALIZED_NAME_COLLECTION_AMOUNT)
  ...
  /**
   * Код вида выплаты. Подробнее: http://www.consultant.ru/document/cons_doc_LAW_353568/527cf8edd2262cb7068cafd44ed596d9a05dd237/
   */
  ...
  private TaxPaymentParameters tax;

  public static final String SERIALIZED_NAME_TO = "to";
  @SerializedName(SERIALIZED_NAME_TO)
  private ReceiverRequisites to;
  ...
  public CreatePaymentRequest amount(BigDecimal amount) {
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "Сумма платежа в рублях")
  ...
  public CreatePaymentRequest collectionAmount(BigDecimal collectionAmount) {
   ...
   /**
   * Удержанная сумма в рублях
   * @return collectionAmount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Удержанная сумма в рублях")
  ...
  public CreatePaymentRequest documentNumber(Integer documentNumber) {
   ...
   /**
   * Номер распоряжения, определяемый клиентом. Заполняется на усмотрение плательщика
   * minimum: 1
   * @return documentNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Номер распоряжения, определяемый клиентом. Заполняется на усмотрение плательщика")
  ...
  public CreatePaymentRequest dueDate(OffsetDateTime dueDate) {
   ...
   /**
   * Дата до которой необходимо провести платёж, при неуспешных попытках платежа он будет повторён вплоть до указанной даты. Если дату не передать, то платеж не будет повторён в случае неуспешной попытки. Время на проведение платежа не может быть больше 30 дней.
   * @return dueDate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Дата до которой необходимо провести платёж, при неуспешных попытках платежа он будет повторён вплоть до указанной даты. Если дату не передать, то платеж не будет повторён в случае неуспешной попытки. Время на проведение платежа не может быть больше 30 дней.")
  ...
  public CreatePaymentRequest executionOrder(Integer executionOrder) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Очерёдность платежа")
  ...
  public CreatePaymentRequest from(PayerRequisites from) {
  ...
  **/
  ...
  public PayerRequisites getFrom() {
    return from;
  }


  public void setFrom(PayerRequisites from) {
    this.from = from;
  }


  public CreatePaymentRequest id(String id) {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "Идентификатор платежа. Должен быть уникален в пределах интеграции")
  ...
  public CreatePaymentRequest meta(Object meta) {
   ...
   /**
   * Дополнительные метаданные в формате JSON. Сохраняются на создании платежа и возвращаются при получении статуса
   * @return meta
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Дополнительные метаданные в формате JSON. Сохраняются на создании платежа и возвращаются при получении статуса")
  ...
  public CreatePaymentRequest purpose(String purpose) {
   ...
   /**
   * Назначение платежа.  ВАЖНО: При заполнении назначения платежа для налоговых платежей за третьих лиц необходимо следовать шаблону:  ИНН того, кто перечисляет//КПП того, кто перечисляет//Наименование лица, за которого происходит оплата//назначение платежа.  Подробнее: https://glavkniga.ru/situations/s509587
   * @return purpose
  **/
  @ApiModelProperty(required = true, value = "Назначение платежа.  ВАЖНО: При заполнении назначения платежа для налоговых платежей за третьих лиц необходимо следовать шаблону:  ИНН того, кто перечисляет//КПП того, кто перечисляет//Наименование лица, за которого происходит оплата//назначение платежа.  Подробнее: https://glavkniga.ru/situations/s509587")
  ...
  public CreatePaymentRequest revenueTypeCode(RevenueTypeCodeEnum revenueTypeCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Код вида выплаты. Подробнее: http://www.consultant.ru/document/cons_doc_LAW_353568/527cf8edd2262cb7068cafd44ed596d9a05dd237/")
  ...
  public CreatePaymentRequest tax(TaxPaymentParameters tax) {
  ...
  **/
  ...
  public TaxPaymentParameters getTax() {
    return tax;
  }


  public void setTax(TaxPaymentParameters tax) {
    this.tax = tax;
  }


  public CreatePaymentRequest to(ReceiverRequisites to) {
  ...
  **/
  ...
  public ReceiverRequisites getTo() {
    return to;
  }


  public void setTo(ReceiverRequisites to) {
    this.to = to;
  }


  public CreatePaymentRequest uin(String uin) {
   ...
   /**
   * Уникальный идентификатор платежа. Поле платежки 22.  ВАЖНО: При налоговом платеже поле обязательно должно быть заполнено.  Подробнее: https://www.glavbukh.ru/art/98739-uin-v-platejnom-poruchenii-2021
   * @return uin
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Уникальный идентификатор платежа. Поле платежки 22.  ВАЖНО: При налоговом платеже поле обязательно должно быть заполнено.  Подробнее: https://www.glavbukh.ru/art/98739-uin-v-platejnom-poruchenii-2021")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, createPaymentRequest.amount) &&
        Objects.equals(this.collectionAmount, createPaymentRequest.collectionAmount) &&
        Objects.equals(this.documentNumber, createPaymentRequest.documentNumber) &&
        Objects.equals(this.dueDate, createPaymentRequest.dueDate) &&
        Objects.equals(this.executionOrder, createPaymentRequest.executionOrder) &&
        Objects.equals(this.from, createPaymentRequest.from) &&
        Objects.equals(this.id, createPaymentRequest.id) &&
        Objects.equals(this.meta, createPaymentRequest.meta) &&
        Objects.equals(this.purpose, createPaymentRequest.purpose) &&
        Objects.equals(this.revenueTypeCode, createPaymentRequest.revenueTypeCode) &&
        Objects.equals(this.tax, createPaymentRequest.tax) &&
        Objects.equals(this.to, createPaymentRequest.to) &&
        Objects.equals(this.uin, createPaymentRequest.uin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, collectionAmount, documentNumber, dueDate, executionOrder, from, id, meta, purpose, revenueTypeCode, tax, to, uin);
  }
