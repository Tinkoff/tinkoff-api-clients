 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-05-17T15:20:39.635Z[GMT]")
public class CreatePaymentDraftRequest {
  ...
  public static final String SERIALIZED_NAME_BANK_ACNT = "bankAcnt";
  @SerializedName(SERIALIZED_NAME_BANK_ACNT)
  private String bankAcnt;

  public static final String SERIALIZED_NAME_BANK_BIK = "bankBik";
  @SerializedName(SERIALIZED_NAME_BANK_BIK)
  private String bankBik;

  public static final String SERIALIZED_NAME_COLLECTION_AMOUNT_NUMBER = "collectionAmountNumber";
  @SerializedName(SERIALIZED_NAME_COLLECTION_AMOUNT_NUMBER)
  private BigDecimal collectionAmountNumber;
  ...
  public static final String SERIALIZED_NAME_RECIPIENT_CORR_ACCOUNT_NUMBER = "recipientCorrAccountNumber";
  @SerializedName(SERIALIZED_NAME_RECIPIENT_CORR_ACCOUNT_NUMBER)
  ...
  /**
   * Код вида выплаты. Обязательно заполняется при платежах в пользу физлиц. Подробнее: https://www.audit-it.ru/news/account/1013406.html
   */
  @JsonAdapter(RevenueTypeCodeEnum.Adapter.class)
  public enum RevenueTypeCodeEnum {
    _1("1"),
    ...
    RevenueTypeCodeEnum(String value) {
      this.value = value;
    }
    ...
    public static RevenueTypeCodeEnum fromValue(String value) {
      for (RevenueTypeCodeEnum b : RevenueTypeCodeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<RevenueTypeCodeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RevenueTypeCodeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RevenueTypeCodeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return RevenueTypeCodeEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_REVENUE_TYPE_CODE = "revenueTypeCode";
  @SerializedName(SERIALIZED_NAME_REVENUE_TYPE_CODE)
  private RevenueTypeCodeEnum revenueTypeCode;
  ...
  public static final String SERIALIZED_NAME_TAX_PAYER_STATUS = "taxPayerStatus";
  @SerializedName(SERIALIZED_NAME_TAX_PAYER_STATUS)
  ...
  public CreatePaymentDraftRequest accountNumber(String accountNumber) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Номер счета плательщика")
  ...
  public CreatePaymentDraftRequest amount(BigDecimal amount) {
  ...
  **/
  ...
  public CreatePaymentDraftRequest bankAcnt(String bankAcnt) {
   ...
   * @return bankAcnt
  **/
  @ApiModelProperty(required = true, value = "Номер счета получателя")
  ...
  public CreatePaymentDraftRequest bankBik(String bankBik) {
  ...
  **/
  ...
  public CreatePaymentDraftRequest collectionAmountNumber(BigDecimal collectionAmountNumber) {
   ...
   /**
   * Удержанная сумма в рублях. Актуально только при платежах в пользу физлиц.
   * @return collectionAmountNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Удержанная сумма в рублях. Актуально только при платежах в пользу физлиц.")

  public BigDecimal getCollectionAmountNumber() {
    return collectionAmountNumber;
  }


  public void setCollectionAmountNumber(BigDecimal collectionAmountNumber) {
    this.collectionAmountNumber = collectionAmountNumber;
  }


  public CreatePaymentDraftRequest date(OffsetDateTime date) {
   ...
   /**
   * Дата и время исполнения платежа. Может быть в будущем, либо данное поле может быть не передано. **Если поле не передано, подписанный документ будет принят к исполнению немедленно.**
   * @return date
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Дата и время исполнения платежа. Может быть в будущем, либо данное поле может быть не передано. **Если поле не передано, подписанный документ будет принят к исполнению немедленно.**")
  ...
  public CreatePaymentDraftRequest documentNumber(String documentNumber) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Номер распоряжения, определяемый клиентом.")
  ...
  public CreatePaymentDraftRequest executionOrder(Integer executionOrder) {
  ...
  **/
  ...
  public CreatePaymentDraftRequest inn(String inn) {
   ...
   /**
   * ИНН получателя. Если платеж выполняется в пользу физ. лица, и его ИНН неизвестен, в поле ИНН необходимо указать значение - \&quot;0\&quot;. Во всех остальных случаях необходимо передавать фактический ИНН получателя.
   * @return inn
  **/
  @ApiModelProperty(required = true, value = "ИНН получателя. Если платеж выполняется в пользу физ. лица, и его ИНН неизвестен, в поле ИНН необходимо указать значение - \"0\". Во всех остальных случаях необходимо передавать фактический ИНН получателя.")
  ...
  public CreatePaymentDraftRequest kbk(String kbk) {
   ...
   /**
   * Код бюджетной классификации. Поле платежки 104. Если платеж не налоговый, в запросе поставьте 0.
   * @return kbk
  **/
  @ApiModelProperty(required = true, value = "Код бюджетной классификации. Поле платежки 104. Если платеж не налоговый, в запросе поставьте 0.")
  ...
  public CreatePaymentDraftRequest kpp(String kpp) {
   ...
   /**
   * КПП. Если у получателя платежа нет КПП (например, это физлицо или ИП), то укажите КПП \&quot;0\&quot;
   * @return kpp
  **/
  @ApiModelProperty(required = true, value = "КПП. Если у получателя платежа нет КПП (например, это физлицо или ИП), то укажите КПП \"0\"")
  ...
  public CreatePaymentDraftRequest oktmo(String oktmo) {
   ...
   /**
   * Код ОКТМО территории, на которой мобилизуются денежные средства от уплаты налога, сбора и иного платежа. Если платеж не налоговый, в запросе поставьте 0.
   * @return oktmo
  **/
  @ApiModelProperty(required = true, value = "Код ОКТМО территории, на которой мобилизуются денежные средства от уплаты налога, сбора и иного платежа. Если платеж не налоговый, в запросе поставьте 0.")
  ...
  public CreatePaymentDraftRequest paymentPurpose(String paymentPurpose) {
  ...
  **/
  ...
  public CreatePaymentDraftRequest recipientCorrAccountNumber(String recipientCorrAccountNumber) {
   ...
   /**
   * Корреспондентский счёт банка получателя. В случае налогового платежа обязательно указывается номер счета банка получателя средств (номер банковского счета, входящего в состав единого казначейского счета (ЕКС)) (подробнее https://www.nalog.ru/rn50/news/activities_fts/10104005/)
   * @return recipientCorrAccountNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Корреспондентский счёт банка получателя. В случае налогового платежа обязательно указывается номер счета банка получателя средств (номер банковского счета, входящего в состав единого казначейского счета (ЕКС)) (подробнее https://www.nalog.ru/rn50/news/activities_fts/10104005/)")
  ...
  public CreatePaymentDraftRequest recipientName(String recipientName) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Получатель")
  ...
  public CreatePaymentDraftRequest revenueTypeCode(RevenueTypeCodeEnum revenueTypeCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Код вида выплаты. Обязательно заполняется при платежах в пользу физлиц. Подробнее: https://www.audit-it.ru/news/account/1013406.html")

  public RevenueTypeCodeEnum getRevenueTypeCode() {
    return revenueTypeCode;
  }


  public void setRevenueTypeCode(RevenueTypeCodeEnum revenueTypeCode) {
    this.revenueTypeCode = revenueTypeCode;
  }


  public CreatePaymentDraftRequest taxDocDate(String taxDocDate) {
   ...
   /**
   * Дата налогового документа. Поле платежки 109. Формат — ДД.ММ.ГГГГ. Если платеж не налоговый, в запросе поставьте 0.
   * @return taxDocDate
  **/
  @ApiModelProperty(required = true, value = "Дата налогового документа. Поле платежки 109. Формат — ДД.ММ.ГГГГ. Если платеж не налоговый, в запросе поставьте 0.")
  ...
  public CreatePaymentDraftRequest taxDocNumber(String taxDocNumber) {
   ...
   /**
   * Номер налогового документа. Поле платежки 108. Если платеж не налоговый, в запросе поставьте 0.
   * @return taxDocNumber
  **/
  @ApiModelProperty(required = true, value = "Номер налогового документа. Поле платежки 108. Если платеж не налоговый, в запросе поставьте 0.")
  ...
  public CreatePaymentDraftRequest taxEvidence(String taxEvidence) {
   ...
   /**
   * Основание налогового платежа. Поле платежки 106. Если платеж не налоговый, в запросе поставьте 0.
   * @return taxEvidence
  **/
  @ApiModelProperty(required = true, value = "Основание налогового платежа. Поле платежки 106. Если платеж не налоговый, в запросе поставьте 0.")
  ...
  public CreatePaymentDraftRequest taxPayerStatus(String taxPayerStatus) {
   ...
   /**
   * Статус составителя расчетного документа. Поле платежки 101. Если платеж не налоговый, в запросе поставьте 0.
   * @return taxPayerStatus
  **/
  @ApiModelProperty(required = true, value = "Статус составителя расчетного документа. Поле платежки 101. Если платеж не налоговый, в запросе поставьте 0.")
  ...
  public CreatePaymentDraftRequest taxPeriod(String taxPeriod) {
   ...
   /**
   * Налоговый период. Поле платежки 107. Формат — ДД.ММ.ГГГГ, первые два символа могут быть буквами. Если платеж не налоговый, в запросе поставьте 0.
   * @return taxPeriod
  **/
  @ApiModelProperty(required = true, value = "Налоговый период. Поле платежки 107. Формат — ДД.ММ.ГГГГ, первые два символа могут быть буквами. Если платеж не налоговый, в запросе поставьте 0.")
  ...
  public CreatePaymentDraftRequest uin(String uin) {
   ...
   /**
   * Уникальный идентификатор платежа. Если платеж не налоговый, в запросе поставьте 0.
   * @return uin
  **/
  @ApiModelProperty(required = true, value = "Уникальный идентификатор платежа. Если платеж не налоговый, в запросе поставьте 0.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountNumber, createPaymentDraftRequest.accountNumber) &&
        Objects.equals(this.amount, createPaymentDraftRequest.amount) &&
        Objects.equals(this.bankAcnt, createPaymentDraftRequest.bankAcnt) &&
        Objects.equals(this.bankBik, createPaymentDraftRequest.bankBik) &&
        Objects.equals(this.collectionAmountNumber, createPaymentDraftRequest.collectionAmountNumber) &&
        Objects.equals(this.date, createPaymentDraftRequest.date) &&
        Objects.equals(this.documentNumber, createPaymentDraftRequest.documentNumber) &&
        Objects.equals(this.executionOrder, createPaymentDraftRequest.executionOrder) &&
        Objects.equals(this.inn, createPaymentDraftRequest.inn) &&
        Objects.equals(this.kbk, createPaymentDraftRequest.kbk) &&
        Objects.equals(this.kpp, createPaymentDraftRequest.kpp) &&
        Objects.equals(this.oktmo, createPaymentDraftRequest.oktmo) &&
        Objects.equals(this.paymentPurpose, createPaymentDraftRequest.paymentPurpose) &&
        Objects.equals(this.recipientCorrAccountNumber, createPaymentDraftRequest.recipientCorrAccountNumber) &&
        Objects.equals(this.recipientName, createPaymentDraftRequest.recipientName) &&
        Objects.equals(this.revenueTypeCode, createPaymentDraftRequest.revenueTypeCode) &&
        Objects.equals(this.taxDocDate, createPaymentDraftRequest.taxDocDate) &&
        Objects.equals(this.taxDocNumber, createPaymentDraftRequest.taxDocNumber) &&
        Objects.equals(this.taxEvidence, createPaymentDraftRequest.taxEvidence) &&
        Objects.equals(this.taxPayerStatus, createPaymentDraftRequest.taxPayerStatus) &&
        Objects.equals(this.taxPeriod, createPaymentDraftRequest.taxPeriod) &&
        Objects.equals(this.uin, createPaymentDraftRequest.uin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, amount, bankAcnt, bankBik, collectionAmountNumber, date, documentNumber, executionOrder, inn, kbk, kpp, oktmo, paymentPurpose, recipientCorrAccountNumber, recipientName, revenueTypeCode, taxDocDate, taxDocNumber, taxEvidence, taxPayerStatus, taxPeriod, uin);
  }
  ...
  public String toString() {
    ...
    sb.append("    bankAcnt: ").append(toIndentedString(bankAcnt)).append("\n");
    sb.append("    bankBik: ").append(toIndentedString(bankBik)).append("\n");
    sb.append("    collectionAmountNumber: ").append(toIndentedString(collectionAmountNumber)).append("\n");
    ...
    sb.append("    recipientCorrAccountNumber: ").append(toIndentedString(recipientCorrAccountNumber)).append("\n");
    sb.append("    recipientName: ").append(toIndentedString(recipientName)).append("\n");
    sb.append("    revenueTypeCode: ").append(toIndentedString(revenueTypeCode)).append("\n");
    ...
    sb.append("    taxPayerStatus: ").append(toIndentedString(taxPayerStatus)).append("\n");
