...
import ru.tinkoff.api.payments.model.ActiveOfferAdvert;
import ru.tinkoff.api.payments.model.MerchantCategory;
...
public class ActiveOffer {
  public static final String SERIALIZED_NAME_ADVERT = "advert";
  @SerializedName(SERIALIZED_NAME_ADVERT)
  private ActiveOfferAdvert advert;

  public static final String SERIALIZED_NAME_BOUND_MONEY_MAX = "boundMoneyMax";
  @SerializedName(SERIALIZED_NAME_BOUND_MONEY_MAX)
  private Long boundMoneyMax;

  public static final String SERIALIZED_NAME_BOUND_MONEY_MIN = "boundMoneyMin";
  @SerializedName(SERIALIZED_NAME_BOUND_MONEY_MIN)
  private Long boundMoneyMin;
  ...
  public static final String SERIALIZED_NAME_CASHBACK_PERCENT = "cashbackPercent";
  @SerializedName(SERIALIZED_NAME_CASHBACK_PERCENT)
  private Long cashbackPercent;

  public static final String SERIALIZED_NAME_CLIENT_RATE = "clientRate";
  @SerializedName(SERIALIZED_NAME_CLIENT_RATE)
  ...
  public static final String SERIALIZED_NAME_IMAGE1252 = "image1252";
  @SerializedName(SERIALIZED_NAME_IMAGE1252)
  private String image1252;

  public static final String SERIALIZED_NAME_IMAGE280 = "image280";
  @SerializedName(SERIALIZED_NAME_IMAGE280)
  private String image280;

  public static final String SERIALIZED_NAME_IMAGE626 = "image626";
  @SerializedName(SERIALIZED_NAME_IMAGE626)
  private String image626;
  ...
  private List<MerchantCategory> merchantCategories = null;
  ...
  public static final String SERIALIZED_NAME_MERCHANT_SUBCATEGORY = "merchantSubcategory";
  @SerializedName(SERIALIZED_NAME_MERCHANT_SUBCATEGORY)
  private String merchantSubcategory;

  public static final String SERIALIZED_NAME_NUMBER_OF_CONTACTS = "numberOfContacts";
  @SerializedName(SERIALIZED_NAME_NUMBER_OF_CONTACTS)
  private Integer numberOfContacts;

  public static final String SERIALIZED_NAME_NUMBER_OF_REALISED = "numberOfRealised";
  @SerializedName(SERIALIZED_NAME_NUMBER_OF_REALISED)
  private Long numberOfRealised;

  public static final String SERIALIZED_NAME_OFFER_TYPE = "offerType";
  @SerializedName(SERIALIZED_NAME_OFFER_TYPE)
  private String offerType;

  public static final String SERIALIZED_NAME_ONLINE_SALE = "onlineSale";
  @SerializedName(SERIALIZED_NAME_ONLINE_SALE)
  ...
  public static final String SERIALIZED_NAME_QUANTITY_GRACE_STATEMENT = "quantityGraceStatement";
  @SerializedName(SERIALIZED_NAME_QUANTITY_GRACE_STATEMENT)
  private Long quantityGraceStatement;
  ...
  private Long topBorder;

  public static final String SERIALIZED_NAME_TRANCHE_DURATION = "trancheDuration";
  @SerializedName(SERIALIZED_NAME_TRANCHE_DURATION)
  private Long trancheDuration;

  public static final String SERIALIZED_NAME_TRANCHE_STATEMENT_COUNT = "trancheStatementCount";
  @SerializedName(SERIALIZED_NAME_TRANCHE_STATEMENT_COUNT)
  private Long trancheStatementCount;
  ...
  public ActiveOffer advert(ActiveOfferAdvert advert) {
  ...
  **/
  ...
  public ActiveOfferAdvert getAdvert() {
    return advert;
  }


  public void setAdvert(ActiveOfferAdvert advert) {
    this.advert = advert;
  }


  public ActiveOffer boundMoneyMax(Long boundMoneyMax) {
    
    this.boundMoneyMax = boundMoneyMax;
    return this;
  }

   /**
   * Ограничение по сумме покупке сверху
   * @return boundMoneyMax
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Ограничение по сумме покупке сверху")

  public Long getBoundMoneyMax() {
    return boundMoneyMax;
  }


  public void setBoundMoneyMax(Long boundMoneyMax) {
    this.boundMoneyMax = boundMoneyMax;
  }


  public ActiveOffer boundMoneyMin(Long boundMoneyMin) {
    
    this.boundMoneyMin = boundMoneyMin;
    return this;
  }

   /**
   * Ограничение по сумме покупке снизу
   * @return boundMoneyMin
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Ограничение по сумме покупке снизу")

  public Long getBoundMoneyMin() {
    return boundMoneyMin;
  }


  public void setBoundMoneyMin(Long boundMoneyMin) {
    this.boundMoneyMin = boundMoneyMin;
  }


  public ActiveOffer brandId(Long brandId) {
   ...
   /**
   * Уникальный id бренда
   * @return brandId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Уникальный id бренда")
  ...
  public ActiveOffer cashbackAmount(Long cashbackAmount) {
   ...
   /**
   * Фиксированный размер бонуса
   * @return cashbackAmount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Фиксированный размер бонуса")
  ...
  public ActiveOffer cashbackPercent(Long cashbackPercent) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Процент начисления бонуса")
  ...
  public ActiveOffer clientRate(Long clientRate) {
   ...
   /**
   * Процентная ставка годовых на рассрочку
   * @return clientRate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Процентная ставка годовых на рассрочку")

  public Long getClientRate() {
    return clientRate;
  }


  public void setClientRate(Long clientRate) {
    this.clientRate = clientRate;
  }


  public ActiveOffer closeDate(OffsetDateTime closeDate) {
   ...
   /**
   * Дата завершения действия оффера для клиентов
   * @return closeDate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Дата завершения действия оффера для клиентов")
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "Уникальный id оффера")
  ...
  public ActiveOffer image1252(String image1252) {
    
    this.image1252 = image1252;
    return this;
  }

   /**
   * Ссылка на картинку оффера размера 1252
   * @return image1252
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Ссылка на картинку оффера размера 1252")

  public String getImage1252() {
    return image1252;
  }


  public void setImage1252(String image1252) {
    this.image1252 = image1252;
  }


  public ActiveOffer image280(String image280) {
    
    this.image280 = image280;
    return this;
  }

   /**
   * Ссылка на лейбл, лого
   * @return image280
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Ссылка на лейбл, лого")

  public String getImage280() {
    return image280;
  }


  public void setImage280(String image280) {
    this.image280 = image280;
  }


  public ActiveOffer image626(String image626) {
    
    this.image626 = image626;
    return this;
  }

   /**
   * Ссылка на картинку оффера размера 626
   * @return image626
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Ссылка на картинку оффера размера 626")

  public String getImage626() {
    return image626;
  }


  public void setImage626(String image626) {
    this.image626 = image626;
  }


  public ActiveOffer merchantCategories(List<MerchantCategory> merchantCategories) {
    
    this.merchantCategories = merchantCategories;
    return this;
  }

  public ActiveOffer addMerchantCategoriesItem(MerchantCategory merchantCategoriesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Категории партнера")
  ...
  public void setMerchantCategories(List<MerchantCategory> merchantCategories) {
    this.merchantCategories = merchantCategories;
  }


  public ActiveOffer merchantId(Long merchantId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Уникальный id партнера")
  ...
  public ActiveOffer merchantName(String merchantName) {
   ...
   * @return merchantName
  **/
  @ApiModelProperty(required = true, value = "Наименование партнера")
  ...
  public ActiveOffer merchantSubcategory(String merchantSubcategory) {
   ...
   /**
   * Подкатегория партнера
   * @return merchantSubcategory
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Подкатегория партнера")
  ...
  public ActiveOffer numberOfContacts(Integer numberOfContacts) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Количество точек продаж")
  ...
  public ActiveOffer numberOfRealised(Long numberOfRealised) {
    
    this.numberOfRealised = numberOfRealised;
    return this;
  }

   /**
   * Количество покупок, на которое распространяется спецпредложение
   * @return numberOfRealised
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Количество покупок, на которое распространяется спецпредложение")

  public Long getNumberOfRealised() {
    return numberOfRealised;
  }


  public void setNumberOfRealised(Long numberOfRealised) {
    this.numberOfRealised = numberOfRealised;
  }


  public ActiveOffer offerType(String offerType) {
   ...
   /**
   * Тип оффера. Доступные значения &#39;STANDARD&#39;, &#39;SPECIAL_CREDIT&#39;
   * @return offerType
  **/
  @ApiModelProperty(required = true, value = "Тип оффера. Доступные значения 'STANDARD', 'SPECIAL_CREDIT'")
  ...
  public ActiveOffer onlineSale(Boolean onlineSale) {
   ...
   /**
   * Флаг онлайн признака - оффер действует на покупки онлайн
   * @return onlineSale
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Флаг онлайн признака - оффер действует на покупки онлайн")
  ...
  public ActiveOffer openDate(OffsetDateTime openDate) {
   ...
   /**
   * Дата начала действия оффера для клиентов
   * @return openDate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Дата начала действия оффера для клиентов")
  ...
  public ActiveOffer phone(String phone) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Телефон партнера")
  ...
  public ActiveOffer quantityGraceStatement(Long quantityGraceStatement) {
    
    this.quantityGraceStatement = quantityGraceStatement;
    return this;
  }

   /**
   * Количество беспроцентных расчетных периодов
   * @return quantityGraceStatement
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Количество беспроцентных расчетных периодов")

  public Long getQuantityGraceStatement() {
    return quantityGraceStatement;
  }


  public void setQuantityGraceStatement(Long quantityGraceStatement) {
    this.quantityGraceStatement = quantityGraceStatement;
  }


  public ActiveOffer single(Boolean single) {
   ...
   /**
   * Флаг оффера на одну покупку
   * @return single
  **/
  @ApiModelProperty(required = true, value = "Флаг оффера на одну покупку")
  ...
  public ActiveOffer topBorder(Long topBorder) {
   ...
   /**
   * Верхняя планка кэшбэка
   * @return topBorder
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Верхняя планка кэшбэка")

  public Long getTopBorder() {
    return topBorder;
  }


  public void setTopBorder(Long topBorder) {
    this.topBorder = topBorder;
  }


  public ActiveOffer trancheDuration(Long trancheDuration) {
    
    this.trancheDuration = trancheDuration;
    return this;
  }

   /**
   * Срок начисления ставки по рассрочке. В днях
   * @return trancheDuration
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Срок начисления ставки по рассрочке. В днях")

  public Long getTrancheDuration() {
    return trancheDuration;
  }


  public void setTrancheDuration(Long trancheDuration) {
    this.trancheDuration = trancheDuration;
  }


  public ActiveOffer trancheStatementCount(Long trancheStatementCount) {
    
    this.trancheStatementCount = trancheStatementCount;
    return this;
  }

   /**
   * Длина рассрочки в расчетных периодах
   * @return trancheStatementCount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Длина рассрочки в расчетных периодах")

  public Long getTrancheStatementCount() {
    return trancheStatementCount;
  }


  public void setTrancheStatementCount(Long trancheStatementCount) {
    this.trancheStatementCount = trancheStatementCount;
  }


  public ActiveOffer web(String web) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Сайт партнера")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advert, activeOffer.advert) &&
        Objects.equals(this.boundMoneyMax, activeOffer.boundMoneyMax) &&
        Objects.equals(this.boundMoneyMin, activeOffer.boundMoneyMin) &&
        Objects.equals(this.brandId, activeOffer.brandId) &&
        Objects.equals(this.cashbackAmount, activeOffer.cashbackAmount) &&
        Objects.equals(this.cashbackPercent, activeOffer.cashbackPercent) &&
        Objects.equals(this.clientRate, activeOffer.clientRate) &&
        Objects.equals(this.closeDate, activeOffer.closeDate) &&
        Objects.equals(this.id, activeOffer.id) &&
        Objects.equals(this.image1252, activeOffer.image1252) &&
        Objects.equals(this.image280, activeOffer.image280) &&
        Objects.equals(this.image626, activeOffer.image626) &&
        Objects.equals(this.merchantCategories, activeOffer.merchantCategories) &&
        Objects.equals(this.merchantId, activeOffer.merchantId) &&
        Objects.equals(this.merchantName, activeOffer.merchantName) &&
        Objects.equals(this.merchantSubcategory, activeOffer.merchantSubcategory) &&
        Objects.equals(this.numberOfContacts, activeOffer.numberOfContacts) &&
        Objects.equals(this.numberOfRealised, activeOffer.numberOfRealised) &&
        Objects.equals(this.offerType, activeOffer.offerType) &&
        Objects.equals(this.onlineSale, activeOffer.onlineSale) &&
        Objects.equals(this.openDate, activeOffer.openDate) &&
        Objects.equals(this.phone, activeOffer.phone) &&
        Objects.equals(this.quantityGraceStatement, activeOffer.quantityGraceStatement) &&
        Objects.equals(this.single, activeOffer.single) &&
        Objects.equals(this.topBorder, activeOffer.topBorder) &&
        Objects.equals(this.trancheDuration, activeOffer.trancheDuration) &&
        Objects.equals(this.trancheStatementCount, activeOffer.trancheStatementCount) &&
        Objects.equals(this.web, activeOffer.web);
  }

  @Override
  public int hashCode() {
    return Objects.hash(advert, boundMoneyMax, boundMoneyMin, brandId, cashbackAmount, cashbackPercent, clientRate, closeDate, id, image1252, image280, image626, merchantCategories, merchantId, merchantName, merchantSubcategory, numberOfContacts, numberOfRealised, offerType, onlineSale, openDate, phone, quantityGraceStatement, single, topBorder, trancheDuration, trancheStatementCount, web);
  }
  ...
  public String toString() {
    ...
    sb.append("    advert: ").append(toIndentedString(advert)).append("\n");
    sb.append("    boundMoneyMax: ").append(toIndentedString(boundMoneyMax)).append("\n");
    sb.append("    boundMoneyMin: ").append(toIndentedString(boundMoneyMin)).append("\n");
    ...
    sb.append("    clientRate: ").append(toIndentedString(clientRate)).append("\n");
    sb.append("    closeDate: ").append(toIndentedString(closeDate)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    image1252: ").append(toIndentedString(image1252)).append("\n");
    sb.append("    image280: ").append(toIndentedString(image280)).append("\n");
    sb.append("    image626: ").append(toIndentedString(image626)).append("\n");
    sb.append("    merchantCategories: ").append(toIndentedString(merchantCategories)).append("\n");
    sb.append("    merchantId: ").append(toIndentedString(merchantId)).append("\n");
    sb.append("    merchantName: ").append(toIndentedString(merchantName)).append("\n");
    sb.append("    merchantSubcategory: ").append(toIndentedString(merchantSubcategory)).append("\n");
    sb.append("    numberOfContacts: ").append(toIndentedString(numberOfContacts)).append("\n");
    sb.append("    numberOfRealised: ").append(toIndentedString(numberOfRealised)).append("\n");
    sb.append("    offerType: ").append(toIndentedString(offerType)).append("\n");
    sb.append("    onlineSale: ").append(toIndentedString(onlineSale)).append("\n");
    sb.append("    openDate: ").append(toIndentedString(openDate)).append("\n");
    sb.append("    phone: ").append(toIndentedString(phone)).append("\n");
    sb.append("    quantityGraceStatement: ").append(toIndentedString(quantityGraceStatement)).append("\n");
    sb.append("    single: ").append(toIndentedString(single)).append("\n");
    sb.append("    topBorder: ").append(toIndentedString(topBorder)).append("\n");
    sb.append("    trancheDuration: ").append(toIndentedString(trancheDuration)).append("\n");
    sb.append("    trancheStatementCount: ").append(toIndentedString(trancheStatementCount)).append("\n");
