...
import ru.tinkoff.api.payments.model.BankInfo1;
import ru.tinkoff.api.payments.model.Document;
import ru.tinkoff.api.payments.model.JobInfo;
import ru.tinkoff.api.payments.model.Phone1;
...
public class Employee {
  ...
  private List<Phone1> phones = null;

  /**
   * Статус сотрудника:&lt;br&gt;&lt;ul&gt;&lt;li&gt;ERROR - Ошибка создания анкеты сотрудника&lt;/li&gt;&lt;li&gt;DRAFT - Анкета сотрудника готова к отправке&lt;/li&gt;&lt;li&gt;PROCESSING_ERROR - Ошибка отправки анкеты (обатитесь к персональному менеджеру для уточнения причины)&lt;/li&gt;&lt;li&gt;PROCESSING - Обрабатываем анкету сотрудника&lt;/li&gt;&lt;li&gt;REJECTED - Отказ в открытии счета (конечный статус добавления)&lt;/li&gt;&lt;li&gt;MTNG_WAIT - Сотрудник ожидает назначения встречи для доставки карты &lt;/li&gt;&lt;li&gt;MTNG_SCHD - Встреча для доставки карты сотруднику назначена&lt;/li&gt;&lt;li&gt;MTNG_CANC - Встреча для доставки карты сотруднику отменена&lt;/li&gt;&lt;li&gt;ACTIVE - Сотрудник добавлен (конечный статус добавления)&lt;/li&gt;&lt;li&gt;FIRED - Сотрудник уволен&lt;/li&gt;&lt;li&gt;DELETED - Сотрудник удален из Зарплатного проекта&lt;/li&gt;&lt;ul&gt;
   */
  ...
  public Employee bankInfo(BankInfo1 bankInfo) {
  ...
  **/
  ...
  public BankInfo1 getBankInfo() {
    return bankInfo;
  }


  public void setBankInfo(BankInfo1 bankInfo) {
    this.bankInfo = bankInfo;
  }
  ...
  **/
  ...
  public Employee documents(List<Document> documents) {
    
    this.documents = documents;
    return this;
  }

  public Employee addDocumentsItem(Document documentsItem) {
  ...
  **/
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "Идентификатор сотрудника")
  ...
  public Employee jobInfo(JobInfo jobInfo) {
  ...
  **/
  ...
  public Employee phones(List<Phone1> phones) {
    
    this.phones = phones;
    return this;
  }

  public Employee addPhonesItem(Phone1 phonesItem) {
    if (this.phones == null) {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "Статус сотрудника:<br><ul><li>ERROR - Ошибка создания анкеты сотрудника</li><li>DRAFT - Анкета сотрудника готова к отправке</li><li>PROCESSING_ERROR - Ошибка отправки анкеты (обатитесь к персональному менеджеру для уточнения причины)</li><li>PROCESSING - Обрабатываем анкету сотрудника</li><li>REJECTED - Отказ в открытии счета (конечный статус добавления)</li><li>MTNG_WAIT - Сотрудник ожидает назначения встречи для доставки карты </li><li>MTNG_SCHD - Встреча для доставки карты сотруднику назначена</li><li>MTNG_CANC - Встреча для доставки карты сотруднику отменена</li><li>ACTIVE - Сотрудник добавлен (конечный статус добавления)</li><li>FIRED - Сотрудник уволен</li><li>DELETED - Сотрудник удален из Зарплатного проекта</li><ul>")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bankInfo, employee.bankInfo) &&
        Objects.equals(this.birthDate, employee.birthDate) &&
        Objects.equals(this.documents, employee.documents) &&
        Objects.equals(this.firstName, employee.firstName) &&
        Objects.equals(this.id, employee.id) &&
        Objects.equals(this.jobInfo, employee.jobInfo) &&
        Objects.equals(this.lastName, employee.lastName) &&
        Objects.equals(this.middleName, employee.middleName) &&
        Objects.equals(this.phones, employee.phones) &&
        Objects.equals(this.status, employee.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankInfo, birthDate, documents, firstName, id, jobInfo, lastName, middleName, phones, status);
  }
