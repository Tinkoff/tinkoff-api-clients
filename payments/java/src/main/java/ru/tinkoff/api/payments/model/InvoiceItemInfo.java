...
public class InvoiceItemInfo {
   ...
   * НДС, \&quot;None\&quot; -- Без НДС
   */
  @JsonAdapter(VatEnum.Adapter.class)
  public enum VatEnum {
    NONE("None"),
    ...
    public static VatEnum fromValue(String value) {
      for (VatEnum b : VatEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<VatEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final VatEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public VatEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return VatEnum.fromValue(value);
      }
    }
  }
  ...
  public InvoiceItemInfo amount(BigDecimal amount) {
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "Количество единиц")
  ...
  public InvoiceItemInfo name(String name) {
  ...
  **/
  ...
  public InvoiceItemInfo price(BigDecimal price) {
   ...
   * @return price
  **/
  @ApiModelProperty(required = true, value = "Цена за единицу в рублях")
  ...
  public InvoiceItemInfo unit(String unit) {
   ...
   * @return unit
  **/
  @ApiModelProperty(required = true, value = "Единицы измерения")
  ...
  public InvoiceItemInfo vat(VatEnum vat) {
   ...
   * @return vat
  **/
  @ApiModelProperty(required = true, value = "НДС, \"None\" -- Без НДС")
  ...
  public void setVat(VatEnum vat) {
    this.vat = vat;
  }
  ...
  public boolean equals(Object o) {
    ...
    InvoiceItemInfo invoiceItemInfo = (InvoiceItemInfo) o;
    return Objects.equals(this.amount, invoiceItemInfo.amount) &&
        Objects.equals(this.name, invoiceItemInfo.name) &&
        Objects.equals(this.price, invoiceItemInfo.price) &&
        Objects.equals(this.unit, invoiceItemInfo.unit) &&
        Objects.equals(this.vat, invoiceItemInfo.vat);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, name, price, unit, vat);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InvoiceItemInfo {\n");
