...
import ru.tinkoff.api.payments.model.SbpPayerRequisites;
import ru.tinkoff.api.payments.model.SbpReceiverRequisites;
...
public class CreateSbpPaymentRequest {
  ...
  private SbpPayerRequisites from;
  ...
  private SbpReceiverRequisites to;


  public CreateSbpPaymentRequest amount(BigDecimal amount) {
  ...
  **/
  ...
  public CreateSbpPaymentRequest documentNumber(Integer documentNumber) {
  ...
  **/
  ...
  public CreateSbpPaymentRequest from(SbpPayerRequisites from) {
  ...
  **/
  ...
  public SbpPayerRequisites getFrom() {
    return from;
  }


  public void setFrom(SbpPayerRequisites from) {
    this.from = from;
  }


  public CreateSbpPaymentRequest id(String id) {
   ...
   /**
   *  Идентификатор платежа. Должен быть уникален в пределах интеграции как для платежей через СБП, так и &lt;a href&#x3D;\&quot;#operation/PaymentsCorePay\&quot;&gt;платежей по банковским реквизитам&lt;/a&gt;.
   * @return id
  **/
  @ApiModelProperty(required = true, value = " Идентификатор платежа. Должен быть уникален в пределах интеграции как для платежей через СБП, так и <a href=\"#operation/PaymentsCorePay\">платежей по банковским реквизитам</a>.")
  ...
  public CreateSbpPaymentRequest purpose(String purpose) {
   ...
   /**
   * Назначение платежа, обязательна информация по НДС
   * @return purpose
  **/
  @ApiModelProperty(required = true, value = "Назначение платежа, обязательна информация по НДС")
  ...
  public CreateSbpPaymentRequest revenueTypeCode(RevenueTypeCodeEnum revenueTypeCode) {
  ...
  **/
  ...
  public CreateSbpPaymentRequest to(SbpReceiverRequisites to) {
  ...
  **/
  ...
  public SbpReceiverRequisites getTo() {
    return to;
  }


  public void setTo(SbpReceiverRequisites to) {
    this.to = to;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, createSbpPaymentRequest.amount) &&
        Objects.equals(this.documentNumber, createSbpPaymentRequest.documentNumber) &&
        Objects.equals(this.from, createSbpPaymentRequest.from) &&
        Objects.equals(this.id, createSbpPaymentRequest.id) &&
        Objects.equals(this.purpose, createSbpPaymentRequest.purpose) &&
        Objects.equals(this.revenueTypeCode, createSbpPaymentRequest.revenueTypeCode) &&
        Objects.equals(this.to, createSbpPaymentRequest.to);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, documentNumber, from, id, purpose, revenueTypeCode, to);
  }
