...
import ru.tinkoff.api.payments.model.CreateAddress1;
import ru.tinkoff.api.payments.model.CreateDocument1;
import ru.tinkoff.api.payments.model.CreatePhone1;
import ru.tinkoff.api.payments.model.CreateSelfEmployedRegistrationInfo;
...
public class CreateSelfEmployedData {
  public static final String SERIALIZED_NAME_ADDRESSES = "addresses";
  @SerializedName(SERIALIZED_NAME_ADDRESSES)
  private List<CreateAddress1> addresses = null;
  ...
  private List<CreateDocument1> documents = null;
  ...
  public static final String SERIALIZED_NAME_LATIN_FIRST_NAME = "latinFirstName";
  @SerializedName(SERIALIZED_NAME_LATIN_FIRST_NAME)
  private String latinFirstName;

  public static final String SERIALIZED_NAME_LATIN_LAST_NAME = "latinLastName";
  @SerializedName(SERIALIZED_NAME_LATIN_LAST_NAME)
  ...
  private List<CreatePhone1> phones = null;

  public static final String SERIALIZED_NAME_REGISTRATION_INFO = "registrationInfo";
  @SerializedName(SERIALIZED_NAME_REGISTRATION_INFO)
  private CreateSelfEmployedRegistrationInfo registrationInfo;


  public CreateSelfEmployedData addresses(List<CreateAddress1> addresses) {
    
    this.addresses = addresses;
    return this;
  }

  public CreateSelfEmployedData addAddressesItem(CreateAddress1 addressesItem) {
   ...
   /**
   * Необходимо указать следующие адреса: Жительства, Регистрации
   * @return addresses
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Необходимо указать следующие адреса: Жительства, Регистрации")

  public List<CreateAddress1> getAddresses() {
    return addresses;
  }


  public void setAddresses(List<CreateAddress1> addresses) {
    this.addresses = addresses;
  }


  public CreateSelfEmployedData birthDate(LocalDate birthDate) {
  ...
  **/
  ...
  public CreateSelfEmployedData birthPlace(String birthPlace) {
   ...
   * @return birthPlace
  **/
  @ApiModelProperty(required = true, value = "Место рождения")
  ...
  public CreateSelfEmployedData citizenship(String citizenship) {
   ...
   * @return citizenship
  **/
  @ApiModelProperty(required = true, value = "Гражданство")
  ...
  public CreateSelfEmployedData documents(List<CreateDocument1> documents) {
    
    this.documents = documents;
    return this;
  }

  public CreateSelfEmployedData addDocumentsItem(CreateDocument1 documentsItem) {
   ...
   /**
   * &lt;br&gt; &lt;b&gt;Для граждан РФ&lt;/b&gt; необходимо указать: &lt;ul&gt;   &lt;li&gt;Данные паспорта&lt;/li&gt; &lt;/ul&gt; &lt;b&gt;Для иностранных граждан&lt;/b&gt; необходимо указать: &lt;ul&gt;   &lt;li&gt;Один из основных документов: \&quot;Иностранный паспорт\&quot;, \&quot;Загр. паспорт иностранного гр.\&quot;, \&quot;Служебный/официальный паспорт\&quot;, \&quot;Дипломатический паспорт\&quot;&lt;/li&gt;   &lt;li&gt;Один из миграционных документов: \&quot;Миграционная карта\&quot;, \&quot;Разр. на временное проживание\&quot;, \&quot;Вид на жительство\&quot;&lt;/li&gt; &lt;/ul&gt; 
   * @return documents
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br> <b>Для граждан РФ</b> необходимо указать: <ul>   <li>Данные паспорта</li> </ul> <b>Для иностранных граждан</b> необходимо указать: <ul>   <li>Один из основных документов: \"Иностранный паспорт\", \"Загр. паспорт иностранного гр.\", \"Служебный/официальный паспорт\", \"Дипломатический паспорт\"</li>   <li>Один из миграционных документов: \"Миграционная карта\", \"Разр. на временное проживание\", \"Вид на жительство\"</li> </ul> ")

  public List<CreateDocument1> getDocuments() {
    return documents;
  }


  public void setDocuments(List<CreateDocument1> documents) {
    this.documents = documents;
  }


  public CreateSelfEmployedData email(String email) {
  ...
  **/
  ...
  public CreateSelfEmployedData firstName(String firstName) {
   ...
   * @return firstName
  **/
  @ApiModelProperty(required = true, value = "Имя (кириллица)")
  ...
  public CreateSelfEmployedData lastName(String lastName) {
   ...
   * @return lastName
  **/
  @ApiModelProperty(required = true, value = "Фамилия (кириллица)")
  ...
  public CreateSelfEmployedData latinFirstName(String latinFirstName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Имя (латиница)")
  ...
  public CreateSelfEmployedData latinLastName(String latinLastName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Фамилия (латиница)")
  ...
  public CreateSelfEmployedData middleName(String middleName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Отчество (кириллица)")
  ...
  public CreateSelfEmployedData number(Integer number) {
   ...
   * @return number
  **/
  @ApiModelProperty(required = true, value = "Идентификатор самозанятого на стороне клиента")
  ...
  public CreateSelfEmployedData phones(List<CreatePhone1> phones) {
    
    this.phones = phones;
    return this;
  }

  public CreateSelfEmployedData addPhonesItem(CreatePhone1 phonesItem) {
    if (this.phones == null) {
   ...
   /**
   * Необходимо указать: Мобильный телефон
   * @return phones
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Необходимо указать: Мобильный телефон")

  public List<CreatePhone1> getPhones() {
    return phones;
  }


  public void setPhones(List<CreatePhone1> phones) {
    this.phones = phones;
  }


  public CreateSelfEmployedData registrationInfo(CreateSelfEmployedRegistrationInfo registrationInfo) {
  ...
  **/
  ...
  public CreateSelfEmployedRegistrationInfo getRegistrationInfo() {
    return registrationInfo;
  }


  public void setRegistrationInfo(CreateSelfEmployedRegistrationInfo registrationInfo) {
    this.registrationInfo = registrationInfo;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateSelfEmployedData createSelfEmployedData = (CreateSelfEmployedData) o;
    return Objects.equals(this.addresses, createSelfEmployedData.addresses) &&
        Objects.equals(this.birthDate, createSelfEmployedData.birthDate) &&
        Objects.equals(this.birthPlace, createSelfEmployedData.birthPlace) &&
        Objects.equals(this.citizenship, createSelfEmployedData.citizenship) &&
        Objects.equals(this.documents, createSelfEmployedData.documents) &&
        Objects.equals(this.email, createSelfEmployedData.email) &&
        Objects.equals(this.firstName, createSelfEmployedData.firstName) &&
        Objects.equals(this.lastName, createSelfEmployedData.lastName) &&
        Objects.equals(this.latinFirstName, createSelfEmployedData.latinFirstName) &&
        Objects.equals(this.latinLastName, createSelfEmployedData.latinLastName) &&
        Objects.equals(this.middleName, createSelfEmployedData.middleName) &&
        Objects.equals(this.number, createSelfEmployedData.number) &&
        Objects.equals(this.phones, createSelfEmployedData.phones) &&
        Objects.equals(this.registrationInfo, createSelfEmployedData.registrationInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addresses, birthDate, birthPlace, citizenship, documents, email, firstName, lastName, latinFirstName, latinLastName, middleName, number, phones, registrationInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSelfEmployedData {\n");
    ...
    sb.append("    latinFirstName: ").append(toIndentedString(latinFirstName)).append("\n");
    sb.append("    latinLastName: ").append(toIndentedString(latinLastName)).append("\n");
