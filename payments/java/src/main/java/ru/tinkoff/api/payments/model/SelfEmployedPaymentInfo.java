...
import ru.tinkoff.api.payments.model.SelfEmployeeInfo;
...
public class SelfEmployedPaymentInfo {
  ...
  public static final String SERIALIZED_NAME_SELF_EMPLOYED_INFO = "selfEmployedInfo";
  @SerializedName(SERIALIZED_NAME_SELF_EMPLOYED_INFO)
  private SelfEmployeeInfo selfEmployedInfo;

  /**
   * Статус платежа:&lt;br&gt;&lt;ul&gt;&lt;li&gt;WAITING - Платёж ожидает отправки реестра&lt;/li&gt;&lt;li&gt;ACCEPTED - Платёж ожидает исполнения реестра&lt;/li&gt;&lt;li&gt;EXECUTED - Платёж исполнен&lt;/li&gt;&lt;li&gt;REJECTED - Платёж отклонён банком&lt;/li&gt;&lt;li&gt;CANCELLED - Платёж отменён&lt;/li&gt;&lt;li&gt;DELETED - Платёж удалён&lt;/li&gt;&lt;ul&gt;
   */
  ...
  public SelfEmployedPaymentInfo accountNumber(String accountNumber) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Номер счета самозанятого")
  ...
  public SelfEmployedPaymentInfo collectionAmount(BigDecimal collectionAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Удержанная сумма")
  ...
  public SelfEmployedPaymentInfo number(Integer number) {
   ...
   /**
   * Идентификатор платежа на стороне клиента. Не возвращается в случае, если платежный реестр был создан через Личный Кабинет
   * @return number
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Идентификатор платежа на стороне клиента. Не возвращается в случае, если платежный реестр был создан через Личный Кабинет")
  ...
  public SelfEmployedPaymentInfo paymentPurpose(String paymentPurpose) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Назначение платежа")
  ...
  public SelfEmployedPaymentInfo revenueTypeCode(RevenueTypeCodeEnum revenueTypeCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Код вида дохода")
  ...
  public SelfEmployedPaymentInfo selfEmployedInfo(SelfEmployeeInfo selfEmployedInfo) {
   ...
   /**
   * Get selfEmployedInfo
   * @return selfEmployedInfo
  **/
  @ApiModelProperty(required = true, value = "")

  public SelfEmployeeInfo getSelfEmployedInfo() {
    return selfEmployedInfo;
  }


  public void setSelfEmployedInfo(SelfEmployeeInfo selfEmployedInfo) {
    this.selfEmployedInfo = selfEmployedInfo;
  }


  public SelfEmployedPaymentInfo status(StatusEnum status) {
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "Статус платежа:<br><ul><li>WAITING - Платёж ожидает отправки реестра</li><li>ACCEPTED - Платёж ожидает исполнения реестра</li><li>EXECUTED - Платёж исполнен</li><li>REJECTED - Платёж отклонён банком</li><li>CANCELLED - Платёж отменён</li><li>DELETED - Платёж удалён</li><ul>")
  ...
  public SelfEmployedPaymentInfo sum(BigDecimal sum) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SelfEmployedPaymentInfo selfEmployedPaymentInfo = (SelfEmployedPaymentInfo) o;
    return Objects.equals(this.accountNumber, selfEmployedPaymentInfo.accountNumber) &&
        Objects.equals(this.collectionAmount, selfEmployedPaymentInfo.collectionAmount) &&
        Objects.equals(this.number, selfEmployedPaymentInfo.number) &&
        Objects.equals(this.paymentPurpose, selfEmployedPaymentInfo.paymentPurpose) &&
        Objects.equals(this.revenueTypeCode, selfEmployedPaymentInfo.revenueTypeCode) &&
        Objects.equals(this.selfEmployedInfo, selfEmployedPaymentInfo.selfEmployedInfo) &&
        Objects.equals(this.status, selfEmployedPaymentInfo.status) &&
        Objects.equals(this.sum, selfEmployedPaymentInfo.sum);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, collectionAmount, number, paymentPurpose, revenueTypeCode, selfEmployedInfo, status, sum);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SelfEmployedPaymentInfo {\n");
    ...
    sb.append("    selfEmployedInfo: ").append(toIndentedString(selfEmployedInfo)).append("\n");
