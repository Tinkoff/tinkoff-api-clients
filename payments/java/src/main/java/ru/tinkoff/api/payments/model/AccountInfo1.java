...
public class AccountInfo1 {
  ...
  /**
   *  Тип счета. Может принимать одно из четырех значений: &lt;ul&gt; &lt;li&gt;Current - расчетный счет&lt;/li&gt; &lt;li&gt;Tax - счет Тинькофф Бухгалтерии&lt;/li&gt; &lt;li&gt;Tender - специальный счет для участия в госзакупках&lt;/li&gt; &lt;li&gt;Overnight - счет Overnight &lt;/li&gt; &lt;/ul&gt; 
   */
  ...
  public AccountInfo1 accountNumber(String accountNumber) {
  ...
  **/
  ...
  public AccountInfo1 accountType(AccountTypeEnum accountType) {
   ...
   * @return accountType
  **/
  @ApiModelProperty(required = true, value = " Тип счета. Может принимать одно из четырех значений: <ul> <li>Current - расчетный счет</li> <li>Tax - счет Тинькофф Бухгалтерии</li> <li>Tender - специальный счет для участия в госзакупках</li> <li>Overnight - счет Overnight </li> </ul> ")
  ...
  public AccountInfo1 balance(Balance balance) {
  ...
  **/
  ...
  public AccountInfo1 bankBik(String bankBik) {
  ...
  **/
  ...
  public AccountInfo1 currency(String currency) {
  ...
  **/
  ...
  public AccountInfo1 name(String name) {
  ...
  **/
  ...
  public AccountInfo1 transitAccount(TransitAccount transitAccount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccountInfo1 accountInfo1 = (AccountInfo1) o;
    return Objects.equals(this.accountNumber, accountInfo1.accountNumber) &&
        Objects.equals(this.accountType, accountInfo1.accountType) &&
        Objects.equals(this.balance, accountInfo1.balance) &&
        Objects.equals(this.bankBik, accountInfo1.bankBik) &&
        Objects.equals(this.currency, accountInfo1.currency) &&
        Objects.equals(this.name, accountInfo1.name) &&
        Objects.equals(this.transitAccount, accountInfo1.transitAccount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, accountType, balance, bankBik, currency, name, transitAccount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccountInfo1 {\n");
