...
/**
 * Адрес, по которому необходимо получить доступные интервалы для назначения встречи
 */
@ApiModel(description = "Адрес, по которому необходимо получить доступные интервалы для назначения встречи")
...
public class Address {
  ...
  **/
  ...
  public Address construction(String construction) {
  ...
  **/
   ...
   * @return fullAddress
  **/
  @ApiModelProperty(required = true, value = "Полный адрес")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Поселение")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(area, building, city, construction, country, flat, fullAddress, house, region, settlement, street, zipCode);
  }
