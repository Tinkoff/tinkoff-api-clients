...
public class CardInfoResponse {
  ...
  public static final String SERIALIZED_NAME_CARD_LAST_FOUR_DIGITS = "cardLastFourDigits";
  ...
  /**
   *  Статус карты:&lt;ul&gt; &lt;li&gt;\&quot;NORM\&quot; &amp;ndash; карта активна&lt;/li&gt; &lt;li&gt;\&quot;CLOSED\&quot; &amp;ndash; карта неактивна&lt;/li&gt; &lt;li&gt;\&quot;BLOCKED\&quot; &amp;ndash; карта заблокирована&lt;/li&gt; &lt;/ul&gt;
   */
  ...
  public static final String SERIALIZED_NAME_UCID = "ucid";
  @SerializedName(SERIALIZED_NAME_UCID)
  private Long ucid;


  public CardInfoResponse accountNumber(String accountNumber) {
   ...
   /**
   * Номер рассчётного счёта, к которому привязана карта
   * @return accountNumber
  **/
  @ApiModelProperty(required = true, value = "Номер рассчётного счёта, к которому привязана карта")
  ...
  public CardInfoResponse cardBin(String cardBin) {
   ...
   * @return cardBin
  **/
  @ApiModelProperty(required = true, value = "Первые 6 цифр номера карты (BIN карты)")
  ...
  public CardInfoResponse cardLastFourDigits(String cardLastFourDigits) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Последние 4 цифры номера карты")
  ...
  public CardInfoResponse embossedName(String embossedName) {
   ...
   * @return embossedName
  **/
  @ApiModelProperty(required = true, value = "Имя держателя карты")
  ...
  public CardInfoResponse isActive(Boolean isActive) {
   ...
   * @return isActive
  **/
  @ApiModelProperty(required = true, value = "Флаг активации карты")
  ...
  public CardInfoResponse status(StatusEnum status) {
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = " Статус карты:<ul> <li>\"NORM\" &ndash; карта активна</li> <li>\"CLOSED\" &ndash; карта неактивна</li> <li>\"BLOCKED\" &ndash; карта заблокирована</li> </ul>")
  ...
  public CardInfoResponse ucid(Long ucid) {
   ...
   * @return ucid
  **/
  @ApiModelProperty(required = true, value = "Уникальный идентификатор карты")
  ...
  public boolean equals(Object o) {
    ...
    CardInfoResponse cardInfoResponse = (CardInfoResponse) o;
    return Objects.equals(this.accountNumber, cardInfoResponse.accountNumber) &&
        Objects.equals(this.cardBin, cardInfoResponse.cardBin) &&
        Objects.equals(this.cardLastFourDigits, cardInfoResponse.cardLastFourDigits) &&
        Objects.equals(this.embossedName, cardInfoResponse.embossedName) &&
        Objects.equals(this.isActive, cardInfoResponse.isActive) &&
        Objects.equals(this.status, cardInfoResponse.status) &&
        Objects.equals(this.ucid, cardInfoResponse.ucid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, cardBin, cardLastFourDigits, embossedName, isActive, status, ucid);
  }
