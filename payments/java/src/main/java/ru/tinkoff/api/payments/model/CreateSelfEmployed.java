...
public class CreateSelfEmployed {
  ...
  /**
   * Статус создания:&lt;br&gt;&lt;ul&gt;&lt;li&gt;QUEUED - самозанятый в данный момент стоит в очереди на создание&lt;/li&gt;&lt;li&gt;CREATED - самозанятый создан&lt;/li&gt;&lt;li&gt;ERROR - самозанятый не был создан (ошибки перечислены в поле &lt;b&gt;errors&lt;/b&gt;)&lt;/li&gt;&lt;ul&gt;
   */
  ...
  public CreateSelfEmployed errors(List<FieldValidationError1> errors) {
    
    this.errors = errors;
    return this;
  }

  public CreateSelfEmployed addErrorsItem(FieldValidationError1 errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public List<FieldValidationError1> getErrors() {
    return errors;
  }


  public void setErrors(List<FieldValidationError1> errors) {
    this.errors = errors;
  }


  public CreateSelfEmployed firstName(String firstName) {
  ...
  **/
  ...
  public CreateSelfEmployed lastName(String lastName) {
  ...
  **/
  ...
  public CreateSelfEmployed middleName(String middleName) {
  ...
  **/
  ...
  public CreateSelfEmployed number(Integer number) {
   ...
   * @return number
  **/
  @ApiModelProperty(required = true, value = "Номер самозанятого, переданный клиентом при создании")
  ...
  public CreateSelfEmployed recipientId(Integer recipientId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Идентификатор самозанятого. Может не прийти, если при создании самозанятого возникли ошибки.")
  ...
  public CreateSelfEmployed status(StatusEnum status) {
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "Статус создания:<br><ul><li>QUEUED - самозанятый в данный момент стоит в очереди на создание</li><li>CREATED - самозанятый создан</li><li>ERROR - самозанятый не был создан (ошибки перечислены в поле <b>errors</b>)</li><ul>")
  ...
  public boolean equals(Object o) {
    ...
    CreateSelfEmployed createSelfEmployed = (CreateSelfEmployed) o;
    return Objects.equals(this.errors, createSelfEmployed.errors) &&
        Objects.equals(this.firstName, createSelfEmployed.firstName) &&
        Objects.equals(this.lastName, createSelfEmployed.lastName) &&
        Objects.equals(this.middleName, createSelfEmployed.middleName) &&
        Objects.equals(this.number, createSelfEmployed.number) &&
        Objects.equals(this.recipientId, createSelfEmployed.recipientId) &&
        Objects.equals(this.status, createSelfEmployed.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errors, firstName, lastName, middleName, number, recipientId, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSelfEmployed {\n");
