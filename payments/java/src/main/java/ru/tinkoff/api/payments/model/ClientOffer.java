...
import ru.tinkoff.api.payments.model.ClientMerchantCategory;
...
public class ClientOffer {
  public static final String SERIALIZED_NAME_CB_AMOUNT = "cbAmount";
  @SerializedName(SERIALIZED_NAME_CB_AMOUNT)
  private Long cbAmount;

  public static final String SERIALIZED_NAME_CB_PERCENT = "cbPercent";
  @SerializedName(SERIALIZED_NAME_CB_PERCENT)
  private Long cbPercent;

  public static final String SERIALIZED_NAME_COUNT_OF_REALISED = "countOfRealised";
  @SerializedName(SERIALIZED_NAME_COUNT_OF_REALISED)
  private Integer countOfRealised;
  ...
  private List<ClientMerchantCategory> merchantCategories = null;

  public static final String SERIALIZED_NAME_VIEW_DATE = "viewDate";
  @SerializedName(SERIALIZED_NAME_VIEW_DATE)
  ...
  public ClientOffer cbAmount(Long cbAmount) {
  ...
  **/
  ...
  public ClientOffer cbPercent(Long cbPercent) {
    
    this.cbPercent = cbPercent;
    return this;
  }
  ...
  **/
  ...
  public Long getCbPercent() {
    return cbPercent;
  }


  public void setCbPercent(Long cbPercent) {
    this.cbPercent = cbPercent;
  }


  public ClientOffer countOfRealised(Integer countOfRealised) {
    
    this.countOfRealised = countOfRealised;
    return this;
  }

   /**
   * Количество совершённых покупок по спецпредложению
   * @return countOfRealised
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Количество совершённых покупок по спецпредложению")

  public Integer getCountOfRealised() {
    return countOfRealised;
  }


  public void setCountOfRealised(Integer countOfRealised) {
    this.countOfRealised = countOfRealised;
  }


  public ClientOffer id(Long id) {
  ...
  **/
  ...
  public ClientOffer merchantCategories(List<ClientMerchantCategory> merchantCategories) {
    
    this.merchantCategories = merchantCategories;
    return this;
  }

  public ClientOffer addMerchantCategoriesItem(ClientMerchantCategory merchantCategoriesItem) {
   ...
   /**
   * Список категорий партнера у клиента
   * @return merchantCategories
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Список категорий партнера у клиента")

  public List<ClientMerchantCategory> getMerchantCategories() {
    return merchantCategories;
  }


  public void setMerchantCategories(List<ClientMerchantCategory> merchantCategories) {
    this.merchantCategories = merchantCategories;
  }


  public ClientOffer viewDate(OffsetDateTime viewDate) {
   ...
   /**
   * Дата просмотра оффера
   * @return viewDate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Дата просмотра оффера")
  ...
  public void setViewDate(OffsetDateTime viewDate) {
    this.viewDate = viewDate;
  }


  public ClientOffer web(String web) {
   ...
   /**
   * Персонализированная ссылка для клиента
   * @return web
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Персонализированная ссылка для клиента")
  ...
  public ClientOffer weight(Integer weight) {
   ...
   /**
   * Вес партнера для клиента. Относительная величина для персонального ранжирования списка офферов
   * @return weight
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Вес партнера для клиента. Относительная величина для персонального ранжирования списка офферов")
  ...
  public boolean equals(Object o) {
    ...
    ClientOffer clientOffer = (ClientOffer) o;
    return Objects.equals(this.cbAmount, clientOffer.cbAmount) &&
        Objects.equals(this.cbPercent, clientOffer.cbPercent) &&
        Objects.equals(this.countOfRealised, clientOffer.countOfRealised) &&
        Objects.equals(this.id, clientOffer.id) &&
        Objects.equals(this.merchantCategories, clientOffer.merchantCategories) &&
        Objects.equals(this.viewDate, clientOffer.viewDate) &&
        Objects.equals(this.web, clientOffer.web) &&
        Objects.equals(this.weight, clientOffer.weight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cbAmount, cbPercent, countOfRealised, id, merchantCategories, viewDate, web, weight);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ClientOffer {\n");
    sb.append("    cbAmount: ").append(toIndentedString(cbAmount)).append("\n");
    sb.append("    cbPercent: ").append(toIndentedString(cbPercent)).append("\n");
    sb.append("    countOfRealised: ").append(toIndentedString(countOfRealised)).append("\n");
