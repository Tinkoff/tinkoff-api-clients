...
import ru.tinkoff.api.payments.model.FieldValidationError;
...
public class EmployeesResponse {
  ...
  private List<FieldValidationError> errors = null;
  ...
  /**
   * Статус создания:&lt;br&gt;&lt;ul&gt;&lt;li&gt;QUEUED - сотрудник в данный момент стоит в очереди на создание&lt;/li&gt;&lt;li&gt;CREATED - сотрудник создан в Зарплатном Проекте&lt;/li&gt;&lt;li&gt;ERROR - сотрудник не был создан в Зарплатном Проекте (ошибки перечислены в поле &lt;b&gt;errors&lt;/b&gt;)&lt;/li&gt;&lt;ul&gt;
   */
  ...
  public EmployeesResponse employeeId(Integer employeeId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Идентификатор сотрудника в Зарплатном Проекте. Может не прийти, если при создании сотрудника возникли ошибки.")
  ...
  public EmployeesResponse errors(List<FieldValidationError> errors) {
    
    this.errors = errors;
    return this;
  }

  public EmployeesResponse addErrorsItem(FieldValidationError errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public EmployeesResponse firstName(String firstName) {
  ...
  **/
  ...
  public EmployeesResponse lastName(String lastName) {
  ...
  **/
  ...
  public EmployeesResponse middleName(String middleName) {
  ...
  **/
  ...
  public EmployeesResponse number(Integer number) {
   ...
   * @return number
  **/
  @ApiModelProperty(required = true, value = "Номер сотрудника, переданный клиентом при создании")
  ...
  public EmployeesResponse status(StatusEnum status) {
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "Статус создания:<br><ul><li>QUEUED - сотрудник в данный момент стоит в очереди на создание</li><li>CREATED - сотрудник создан в Зарплатном Проекте</li><li>ERROR - сотрудник не был создан в Зарплатном Проекте (ошибки перечислены в поле <b>errors</b>)</li><ul>")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.employeeId, employeesResponse.employeeId) &&
        Objects.equals(this.errors, employeesResponse.errors) &&
        Objects.equals(this.firstName, employeesResponse.firstName) &&
        Objects.equals(this.lastName, employeesResponse.lastName) &&
        Objects.equals(this.middleName, employeesResponse.middleName) &&
        Objects.equals(this.number, employeesResponse.number) &&
        Objects.equals(this.status, employeesResponse.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(employeeId, errors, firstName, lastName, middleName, number, status);
  }
