...
import ru.tinkoff.api.payments.model.BankInfo2;
import ru.tinkoff.api.payments.model.Document1;
import ru.tinkoff.api.payments.model.Phone2;
import ru.tinkoff.api.payments.model.RegistrationInfo;
...
public class SelfEmployed {
  public static final String SERIALIZED_NAME_BANK_INFO = "bankInfo";
  @SerializedName(SERIALIZED_NAME_BANK_INFO)
  private BankInfo2 bankInfo;
  ...
  private List<Phone2> phones = null;
  ...
  /**
   * Статус самозанятости (в будущем возможно разширение возможных статусов):&lt;br&gt;&lt;ul&gt;&lt;li&gt;ACTIVE - Получатель самозанятый, привязан к Тинькофф. Доступны выплаты с чеками&lt;/li&gt;&lt;li&gt;NOT_ACTIVE - Получатель не самозанятый или не привязан к Тинькофф. Выплаты с чеками недоступны&lt;/li&gt;&lt;li&gt;REGISTRATION_WAIT - Получатель ожидает постановки на учет в качестве самозанятого. Статус возможен в случае, если в методе создания самозанятого было передано значение registrationInfo&lt;/li&gt;&lt;li&gt;NOT_CONFIRM - Статус самозанятости неизвестен&lt;/li&gt;&lt;ul&gt;
   */
  @JsonAdapter(SelfEmployedStatusEnum.Adapter.class)
  public enum SelfEmployedStatusEnum {
    ...
    SelfEmployedStatusEnum(String value) {
      this.value = value;
    }
    ...
    public static SelfEmployedStatusEnum fromValue(String value) {
      for (SelfEmployedStatusEnum b : SelfEmployedStatusEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<SelfEmployedStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SelfEmployedStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SelfEmployedStatusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SelfEmployedStatusEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_SELF_EMPLOYED_STATUS = "selfEmployedStatus";
  @SerializedName(SERIALIZED_NAME_SELF_EMPLOYED_STATUS)
  private SelfEmployedStatusEnum selfEmployedStatus;

  /**
   * Статус самозанятого:&lt;br&gt;&lt;ul&gt;&lt;li&gt;ERROR - Ошибка создания анкеты самозанятого&lt;/li&gt;&lt;li&gt;DRAFT - Анкета самозанятого готова к отправке&lt;/li&gt;&lt;li&gt;PROCESSING_ERROR - Ошибка отправки анкеты (обатитесь к персональному менеджеру для уточнения причины)&lt;/li&gt;&lt;li&gt;PROCESSING - Обрабатываем анкету самозанятого&lt;/li&gt;&lt;li&gt;REJECTED - Отказ в открытии счета (конечный статус добавления)&lt;/li&gt;&lt;li&gt;MTNG_WAIT - Самозанятый ожидает назначения встречи для доставки карты &lt;/li&gt;&lt;li&gt;MTNG_SCHD - Встреча для доставки карты самозанятому назначена&lt;/li&gt;&lt;li&gt;MTNG_CANC - Встреча для доставки карты самозанятому отменена&lt;/li&gt;&lt;li&gt;ACTIVE - Самозанятый добавлен (конечный статус добавления)&lt;/li&gt;&lt;li&gt;DELETED - Самозанятый удален&lt;/li&gt;&lt;ul&gt;
   */
  ...
  public SelfEmployed bankInfo(BankInfo2 bankInfo) {
  ...
  **/
  ...
  public BankInfo2 getBankInfo() {
    return bankInfo;
  }


  public void setBankInfo(BankInfo2 bankInfo) {
    this.bankInfo = bankInfo;
  }


  public SelfEmployed birthDate(LocalDate birthDate) {
  ...
  **/
  ...
  public SelfEmployed documents(List<Document1> documents) {
    
    this.documents = documents;
    return this;
  }

  public SelfEmployed addDocumentsItem(Document1 documentsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Документы")
  ...
  public SelfEmployed firstName(String firstName) {
  ...
  **/
  ...
  public SelfEmployed id(Integer id) {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "Идентификатор самозанятого")
  ...
  public SelfEmployed lastName(String lastName) {
  ...
  **/
  ...
  public SelfEmployed middleName(String middleName) {
  ...
  **/
  ...
  public SelfEmployed phones(List<Phone2> phones) {
    
    this.phones = phones;
    return this;
  }

  public SelfEmployed addPhonesItem(Phone2 phonesItem) {
    if (this.phones == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Номера телефонов")
  ...
  public SelfEmployed registrationInfo(RegistrationInfo registrationInfo) {
  ...
  **/
  ...
  public SelfEmployed selfEmployedStatus(SelfEmployedStatusEnum selfEmployedStatus) {
    
    this.selfEmployedStatus = selfEmployedStatus;
    return this;
  }

   /**
   * Статус самозанятости (в будущем возможно разширение возможных статусов):&lt;br&gt;&lt;ul&gt;&lt;li&gt;ACTIVE - Получатель самозанятый, привязан к Тинькофф. Доступны выплаты с чеками&lt;/li&gt;&lt;li&gt;NOT_ACTIVE - Получатель не самозанятый или не привязан к Тинькофф. Выплаты с чеками недоступны&lt;/li&gt;&lt;li&gt;REGISTRATION_WAIT - Получатель ожидает постановки на учет в качестве самозанятого. Статус возможен в случае, если в методе создания самозанятого было передано значение registrationInfo&lt;/li&gt;&lt;li&gt;NOT_CONFIRM - Статус самозанятости неизвестен&lt;/li&gt;&lt;ul&gt;
   * @return selfEmployedStatus
  **/
  @ApiModelProperty(required = true, value = "Статус самозанятости (в будущем возможно разширение возможных статусов):<br><ul><li>ACTIVE - Получатель самозанятый, привязан к Тинькофф. Доступны выплаты с чеками</li><li>NOT_ACTIVE - Получатель не самозанятый или не привязан к Тинькофф. Выплаты с чеками недоступны</li><li>REGISTRATION_WAIT - Получатель ожидает постановки на учет в качестве самозанятого. Статус возможен в случае, если в методе создания самозанятого было передано значение registrationInfo</li><li>NOT_CONFIRM - Статус самозанятости неизвестен</li><ul>")

  public SelfEmployedStatusEnum getSelfEmployedStatus() {
    return selfEmployedStatus;
  }


  public void setSelfEmployedStatus(SelfEmployedStatusEnum selfEmployedStatus) {
    this.selfEmployedStatus = selfEmployedStatus;
  }


  public SelfEmployed status(StatusEnum status) {
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "Статус самозанятого:<br><ul><li>ERROR - Ошибка создания анкеты самозанятого</li><li>DRAFT - Анкета самозанятого готова к отправке</li><li>PROCESSING_ERROR - Ошибка отправки анкеты (обатитесь к персональному менеджеру для уточнения причины)</li><li>PROCESSING - Обрабатываем анкету самозанятого</li><li>REJECTED - Отказ в открытии счета (конечный статус добавления)</li><li>MTNG_WAIT - Самозанятый ожидает назначения встречи для доставки карты </li><li>MTNG_SCHD - Встреча для доставки карты самозанятому назначена</li><li>MTNG_CANC - Встреча для доставки карты самозанятому отменена</li><li>ACTIVE - Самозанятый добавлен (конечный статус добавления)</li><li>DELETED - Самозанятый удален</li><ul>")
  ...
  public boolean equals(Object o) {
    ...
    SelfEmployed selfEmployed = (SelfEmployed) o;
    return Objects.equals(this.bankInfo, selfEmployed.bankInfo) &&
        Objects.equals(this.birthDate, selfEmployed.birthDate) &&
        Objects.equals(this.documents, selfEmployed.documents) &&
        Objects.equals(this.firstName, selfEmployed.firstName) &&
        Objects.equals(this.id, selfEmployed.id) &&
        Objects.equals(this.lastName, selfEmployed.lastName) &&
        Objects.equals(this.middleName, selfEmployed.middleName) &&
        Objects.equals(this.phones, selfEmployed.phones) &&
        Objects.equals(this.registrationInfo, selfEmployed.registrationInfo) &&
        Objects.equals(this.selfEmployedStatus, selfEmployed.selfEmployedStatus) &&
        Objects.equals(this.status, selfEmployed.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankInfo, birthDate, documents, firstName, id, lastName, middleName, phones, registrationInfo, selfEmployedStatus, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SelfEmployed {\n");
    ...
    sb.append("    selfEmployedStatus: ").append(toIndentedString(selfEmployedStatus)).append("\n");
