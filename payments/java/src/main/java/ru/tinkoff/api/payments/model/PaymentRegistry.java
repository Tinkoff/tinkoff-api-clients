...
import ru.tinkoff.api.payments.model.PaymentInfo;
...
public class PaymentRegistry {
  public static final String SERIALIZED_NAME_COMPANY_ACCOUNT_NUMBER = "companyAccountNumber";
  @SerializedName(SERIALIZED_NAME_COMPANY_ACCOUNT_NUMBER)
  ...
  /**
   * Статус платежного реестра:&lt;br&gt;&lt;ul&gt;&lt;li&gt;DRAFT - Платежный реестр готов к отправке&lt;/li&gt;&lt;li&gt;ERROR - Ошибка создания платежного реестра&lt;/li&gt;&lt;li&gt;ACCEPTED - Реестр ожидает поступления денежных средств&lt;/li&gt;&lt;li&gt;EXECUTED - Реестр исполнен&lt;/li&gt;&lt;li&gt;PART_EXEC - Реестр исполнен частично&lt;/li&gt;&lt;li&gt;REJECTED - Реестр отклонён банком&lt;/li&gt;&lt;li&gt;CANCELLED - Реестр отменён&lt;/li&gt;&lt;li&gt;DELETED - Реестр удалён&lt;/li&gt;&lt;ul&gt;
   */
  ...
  public PaymentRegistry companyAccountNumber(String companyAccountNumber) {
   ...
   /**
   *  Номер счёта компании, с которого будут списаны деньги, для оплаты реестра (при наличии РКО в Тинькофф).&lt;br&gt; Если номер счёта не передан - средства будут списаны с основного счёта компании.         
   * @return companyAccountNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = " Номер счёта компании, с которого будут списаны деньги, для оплаты реестра (при наличии РКО в Тинькофф).<br> Если номер счёта не передан - средства будут списаны с основного счёта компании.         ")
  ...
  public PaymentRegistry loadDate(String loadDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Дата отправки реестра")
  ...
  public PaymentRegistry payments(List<PaymentInfo> payments) {
    
    this.payments = payments;
    return this;
  }

  public PaymentRegistry addPaymentsItem(PaymentInfo paymentsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Список платежей внутри реестра")
  ...
  public PaymentRegistry paymentsCount(Integer paymentsCount) {
   ...
   /**
   * Кол-во платежей в реестре
   * @return paymentsCount
  **/
  @ApiModelProperty(required = true, value = "Кол-во платежей в реестре")
  ...
  public PaymentRegistry status(StatusEnum status) {
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "Статус платежного реестра:<br><ul><li>DRAFT - Платежный реестр готов к отправке</li><li>ERROR - Ошибка создания платежного реестра</li><li>ACCEPTED - Реестр ожидает поступления денежных средств</li><li>EXECUTED - Реестр исполнен</li><li>PART_EXEC - Реестр исполнен частично</li><li>REJECTED - Реестр отклонён банком</li><li>CANCELLED - Реестр отменён</li><li>DELETED - Реестр удалён</li><ul>")
  ...
  public PaymentRegistry totalSum(BigDecimal totalSum) {
   ...
   * @return totalSum
  **/
  @ApiModelProperty(required = true, value = "Общая сумма платежей в реестре")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.companyAccountNumber, paymentRegistry.companyAccountNumber) &&
        Objects.equals(this.loadDate, paymentRegistry.loadDate) &&
        Objects.equals(this.payments, paymentRegistry.payments) &&
        Objects.equals(this.paymentsCount, paymentRegistry.paymentsCount) &&
        Objects.equals(this.status, paymentRegistry.status) &&
        Objects.equals(this.totalSum, paymentRegistry.totalSum);
  }

  @Override
  public int hashCode() {
    return Objects.hash(companyAccountNumber, loadDate, payments, paymentsCount, status, totalSum);
  }
  ...
  public String toString() {
    ...
    sb.append("    companyAccountNumber: ").append(toIndentedString(companyAccountNumber)).append("\n");
