...
/**
 * IdentificationDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IdentificationDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdentificationDocument';
    ...
    {
        $this->container['division_name'] = $data['division_name'] ?? null;
     ...
     * Sets division_name
     *
     * @param string|null $division_name Подразделение
     *
     * @return self
     */
     ...
     * Sets issue_date
     *
     * @param \DateTime|null $issue_date Дата выдачи документа
     *
     * @return self
     */
