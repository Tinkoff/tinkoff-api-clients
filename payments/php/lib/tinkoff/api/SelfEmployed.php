...
/**
 * SelfEmployed Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployed';
    ...
    protected static $openAPITypes = [
        'bank_info' => '\OpenAPI\Client\tinkoff\api\\BankInfo2',
        'birth_date' => '\DateTime',
        'documents' => '\OpenAPI\Client\tinkoff\api\\Document1[]',
        'first_name' => 'string',
        'id' => 'int',
        'last_name' => 'string',
        'middle_name' => 'string',
        'phones' => '\OpenAPI\Client\tinkoff\api\\Phone2[]',
        'registration_info' => '\OpenAPI\Client\tinkoff\api\\RegistrationInfo',
        'self_employed_status' => 'string',
        'status' => 'string'
    ];
    ...
    protected static $setters = [
        ...
        'phones' => 'setPhones',
        'registration_info' => 'setRegistrationInfo',
        'self_employed_status' => 'setSelfEmployedStatus',
        'status' => 'setStatus'
    ];
    ...
    protected static $getters = [
        ...
        'phones' => 'getPhones',
        'registration_info' => 'getRegistrationInfo',
        'self_employed_status' => 'getSelfEmployedStatus',
        'status' => 'getStatus'
    ];
    ...
    const SELF_EMPLOYED_STATUS_REGISTRATION_WAIT = 'REGISTRATION_WAIT';
    const SELF_EMPLOYED_STATUS_NOT_CONFIRM = 'NOT_CONFIRM';
    const SELF_EMPLOYED_STATUS_NOT_ACTIVE = 'NOT_ACTIVE';
    const SELF_EMPLOYED_STATUS_ACTIVE = 'ACTIVE';
    ...
    const STATUS_MTNG_SCHD = 'MTNG_SCHD';
    const STATUS_MTNG_WAIT = 'MTNG_WAIT';
    const STATUS_MTNG_CANC = 'MTNG_CANC';
     ...
     * @return string[]
     */
    public function getSelfEmployedStatusAllowableValues()
    {
        return [
            self::SELF_EMPLOYED_STATUS_REGISTRATION_WAIT,
            self::SELF_EMPLOYED_STATUS_NOT_CONFIRM,
            self::SELF_EMPLOYED_STATUS_NOT_ACTIVE,
            self::SELF_EMPLOYED_STATUS_ACTIVE,
        ];
    }
    ...
    public function getStatusAllowableValues()
    {
        return [
            ...
            self::STATUS_DELETED,
            self::STATUS_MTNG_SCHD,
            self::STATUS_MTNG_WAIT,
            self::STATUS_MTNG_CANC,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['registration_info'] = $data['registration_info'] ?? null;
        $this->container['self_employed_status'] = $data['self_employed_status'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bank_info'] === null) {
            $invalidProperties[] = "'bank_info' can't be null";
        }
        ...
        if ($this->container['self_employed_status'] === null) {
            $invalidProperties[] = "'self_employed_status' can't be null";
        }
        $allowedValues = $this->getSelfEmployedStatusAllowableValues();
        if (!is_null($this->container['self_employed_status']) && !in_array($this->container['self_employed_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'self_employed_status', must be one of '%s'",
                $this->container['self_employed_status'],
     ...
     * Gets bank_info
     *
     * @return \OpenAPI\Client\tinkoff\api\\BankInfo2
     */
     ...
     * Sets bank_info
     *
     * @param \OpenAPI\Client\tinkoff\api\\BankInfo2 $bank_info bank_info
     *
     * @return self
     */
     ...
     * Gets documents
     *
     * @return \OpenAPI\Client\tinkoff\api\\Document1[]|null
     */
     ...
     * Sets documents
     *
     * @param \OpenAPI\Client\tinkoff\api\\Document1[]|null $documents Документы
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int $id Идентификатор самозанятого
     *
     * @return self
     */
     ...
     * Gets phones
     *
     * @return \OpenAPI\Client\tinkoff\api\\Phone2[]|null
     */
     ...
     * Sets phones
     *
     * @param \OpenAPI\Client\tinkoff\api\\Phone2[]|null $phones Номера телефонов
     *
     * @return self
     */
    ...
    /**
     * Gets registration_info
     *
     * @return \OpenAPI\Client\tinkoff\api\\RegistrationInfo|null
     */
    public function getRegistrationInfo()
    {
        return $this->container['registration_info'];
    }

    /**
     * Sets registration_info
     *
     * @param \OpenAPI\Client\tinkoff\api\\RegistrationInfo|null $registration_info registration_info
     *
     * @return self
     */
    public function setRegistrationInfo($registration_info)
    {
        $this->container['registration_info'] = $registration_info;

        return $this;
    }

    /**
     * Gets self_employed_status
     *
     * @return string
     */
    public function getSelfEmployedStatus()
    {
        return $this->container['self_employed_status'];
    }

    /**
     * Sets self_employed_status
     *
     * @param string $self_employed_status Статус самозанятости (в будущем возможно разширение возможных статусов):<br><ul><li>ACTIVE - Получатель самозанятый, привязан к Тинькофф. Доступны выплаты с чеками</li><li>NOT_ACTIVE - Получатель не самозанятый или не привязан к Тинькофф. Выплаты с чеками недоступны</li><li>REGISTRATION_WAIT - Получатель ожидает постановки на учет в качестве самозанятого. Статус возможен в случае, если в методе создания самозанятого было передано значение registrationInfo</li><li>NOT_CONFIRM - Статус самозанятости неизвестен</li><ul>
     *
     * @return self
     */
    public function setSelfEmployedStatus($self_employed_status)
    {
        $allowedValues = $this->getSelfEmployedStatusAllowableValues();
        if (!in_array($self_employed_status, $allowedValues, true)) {
        ...
        $this->container['self_employed_status'] = $self_employed_status;
