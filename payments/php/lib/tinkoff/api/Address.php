 ...
 *
 * @category Class
 * @description Адрес, по которому необходимо получить доступные интервалы для назначения встречи
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets construction
     *
     * @param string|null $construction Строение
     *
     * @return self
     */
     ...
     * Sets settlement
     *
     * @param string|null $settlement Поселение
     *
     * @return self
     */
     ...
     * Sets zip_code
     *
     * @param string|null $zip_code Почтовый индекс
     *
     * @return self
     */
