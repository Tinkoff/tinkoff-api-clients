...
/**
 * CreateDocument1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateDocument1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDocument1';
    ...
    const TYPE_PASPORT = 'Паспорт';
    const TYPE_INOSTRANNYJ_PASPORT = 'Иностранный паспорт';
    const TYPE_ZAGR_PASPORT_INOSTRANNOGO_GR = 'Загр. паспорт иностранного гр.';
    const TYPE_SLUZHEBNYJ_OFITSIAL_NYJ_PASPORT = 'Служебный/официальный паспорт';
    const TYPE_DIPLOMATICHESKIJ_PASPORT = 'Дипломатический паспорт';
    const TYPE_MIGRATSIONNAJA_KARTA = 'Миграционная карта';
    const TYPE_RAZR_NA_VREMENNOE_PROZHIVANIE = 'Разр. на временное проживание';
    const TYPE_VIZA = 'Виза';
    const TYPE_VID_NA_ZHITEL_STVO = 'Вид на жительство';
    ...
    public function getTypeAllowableValues()
    {
        return [
            self::TYPE_PASPORT,
            self::TYPE_INOSTRANNYJ_PASPORT,
            self::TYPE_ZAGR_PASPORT_INOSTRANNOGO_GR,
            self::TYPE_SLUZHEBNYJ_OFITSIAL_NYJ_PASPORT,
            self::TYPE_DIPLOMATICHESKIJ_PASPORT,
            self::TYPE_MIGRATSIONNAJA_KARTA,
            self::TYPE_RAZR_NA_VREMENNOE_PROZHIVANIE,
            self::TYPE_VIZA,
            self::TYPE_VID_NA_ZHITEL_STVO,
        ];
    }
     ...
     * Sets division
     *
     * @param string|null $division Код подразделения
     *
     * @return self
     */
     ...
     * Sets expire_date
     *
     * @param \DateTime|null $expire_date Дата истечения
     *
     * @return self
     */
     ...
     * Sets organization
     *
     * @param string $organization Кем выдан
     *
     * @return self
     */
