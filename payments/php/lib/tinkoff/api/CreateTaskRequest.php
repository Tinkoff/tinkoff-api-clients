...
class CreateTaskRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'contacts' => '\OpenAPI\Client\tinkoff\api\\Contact[]',
        'template' => 'string'
    ];
     ...
     *
     * @param string|null $comment_for_agent Комментарий к заданию для представителя
     *
     * @return self
     */
     ...
     * Gets contacts
     *
     * @return \OpenAPI\Client\tinkoff\api\\Contact[]|null
     */
     ...
     * Sets contacts
     *
     * @param \OpenAPI\Client\tinkoff\api\\Contact[]|null $contacts Группа объектов с информацией о данных каждого участника задания, подлежащего удостоверению на встрече
     *
     * @return self
     */
     ...
     * Sets template
     *
     * @param string $template Шаблон, определяющий бизнес-логику задания
     *
     * @return self
     */
