...
/**
 * TaxThirdParty Class Doc Comment
 *
 * @category Class
 ...
 */
class TaxThirdParty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxThirdParty';
     ...
     * Sets inn
     *
     * @param string $inn ИНН третьего лица.
     *
     * @return self
     */
    public function setInn($inn)
    {
        ...
        if ((!preg_match("/^(\\d{12}|\\d{10}|0{1})$/", $inn))) {
            throw new \InvalidArgumentException("invalid value for $inn when calling TaxThirdParty., must conform to the pattern /^(\\d{12}|\\d{10}|0{1})$/.");
        }
     ...
     * Sets kpp
     *
     * @param string $kpp КПП третьего лица.
     *
     * @return self
     */
    public function setKpp($kpp)
    {
        ...
        if ((!preg_match("/^(\\d{9}|0)$/", $kpp))) {
            throw new \InvalidArgumentException("invalid value for $kpp when calling TaxThirdParty., must conform to the pattern /^(\\d{9}|0)$/.");
        }
