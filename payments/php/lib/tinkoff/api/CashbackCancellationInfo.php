...
/**
 * CashbackCancellationInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CashbackCancellationInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashbackCancellationInfo';
     ...
     * Sets message
     *
     * @param string $message Ошибка валидации запроса
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type VALIDATION_ERROR
     *
     * @return self
     */
