...
/**
 * ActiveOfferAdvert Class Doc Comment
 *
 * @category Class
 ...
 */
class ActiveOfferAdvert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActiveOfferAdvert';
    ...
    protected static $setters = [
        'text' => 'setText',
        'text_formatted' => 'setTextFormatted',
        'title' => 'setTitle'
    ];
    ...
    protected static $getters = [
        'text' => 'getText',
        'text_formatted' => 'getTextFormatted',
        'title' => 'getTitle'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['text_formatted'] = $data['text_formatted'] ?? null;
     ...
     * Sets text
     *
     * @param string|null $text Рекламный текст оффера
     *
     * @return self
     */
    ...
    {
        return $this->container['text_formatted'];
    }

    /**
     * Sets text_formatted
     *
     * @param string|null $text_formatted Форматированный рекламный текст оффера
     *
     * @return self
     */
    public function setTextFormatted($text_formatted)
    {
        $this->container['text_formatted'] = $text_formatted;
     ...
     * Sets title
     *
     * @param string|null $title Рекламный заголовок оффера
     *
     * @return self
     */
