...
/**
 * SendReceiptResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SendReceiptResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendReceiptResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['offer_ids'] = $data['offer_ids'] ?? null;
     ...
     *
     * @param string $cashback_amount Кэшбэк, начисленный за чек
     *
     * @return self
     */
     ...
     * Sets offer_ids
     *
     * @param int[]|null $offer_ids Список офферов, за которые начислен кэшбэк
     *
     * @return self
     */
     ...
     * Sets total_balance
     *
     * @param string $total_balance Текущий баланс кэшбэка клиента
     *
     * @return self
     */
