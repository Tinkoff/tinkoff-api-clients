...
class CompanyInfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'bank' => '\OpenAPI\Client\tinkoff\api\\Bank',
        'city' => 'string',
        'name' => 'string',
        'opf' => 'string',
        'registration_date' => '\DateTime',
        'requisites' => '\OpenAPI\Client\tinkoff\api\\Requisites'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['opf'] = $data['opf'] ?? null;
        $this->container['registration_date'] = $data['registration_date'] ?? null;
        $this->container['requisites'] = $data['requisites'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['requisites'] === null) {
            $invalidProperties[] = "'requisites' can't be null";
        }
     ...
     * Gets bank
     *
     * @return \OpenAPI\Client\tinkoff\api\\Bank
     */
     ...
     * Sets bank
     *
     * @param \OpenAPI\Client\tinkoff\api\\Bank $bank bank
     *
     * @return self
     */
    ...
    {
        return $this->container['opf'];
    }

    /**
     * Sets opf
     *
     * @param string|null $opf Организационно-правовая форма
     *
     * @return self
     */
    public function setOpf($opf)
    {
        $this->container['opf'] = $opf;
     ...
     *
     * @param \DateTime|null $registration_date Дата регистрации
     *
     * @return self
     */
     ...
     * Gets requisites
     *
     * @return \OpenAPI\Client\tinkoff\api\\Requisites
     */
     ...
     * Sets requisites
     *
     * @param \OpenAPI\Client\tinkoff\api\\Requisites $requisites requisites
     *
     * @return self
     */
