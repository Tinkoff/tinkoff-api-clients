...
/**
 * CancelTaskRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CancelTaskRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelTaskRequest';
     ...
     * Sets reason
     *
     * @param string $reason Причина отмены задания
     *
     * @return self
     */
