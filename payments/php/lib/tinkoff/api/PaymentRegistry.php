...
/**
 * PaymentRegistry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentRegistry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRegistry';
    ...
    protected static $openAPITypes = [
        ...
        'load_date' => 'string',
        'payments' => '\OpenAPI\Client\tinkoff\api\\PaymentInfo[]',
        'payments_count' => 'int',
        'status' => 'string',
        'total_sum' => 'float'
    ];
    ...
    const STATUS_PART_EXEC = 'PART_EXEC';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_sum'] = $data['total_sum'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_sum'] === null) {
            $invalidProperties[] = "'total_sum' can't be null";
        }
     ...
     * Gets payments
     *
     * @return \OpenAPI\Client\tinkoff\api\\PaymentInfo[]|null
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\tinkoff\api\\PaymentInfo[]|null $payments Список платежей внутри реестра
     *
     * @return self
     */
     ...
     * Sets payments_count
     *
     * @param int $payments_count Кол-во платежей в реестре
     *
     * @return self
     */
     ...
     * Sets total_sum
     *
     * @param float $total_sum Общая сумма платежей в реестре
     *
     * @return self
     */
