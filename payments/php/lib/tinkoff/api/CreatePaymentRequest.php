...
class CreatePaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'due_date' => '\DateTime',
        'execution_order' => 'int',
        'from' => '\OpenAPI\Client\tinkoff\api\\PayerRequisites',
        'id' => 'string',
        'meta' => 'object',
        'purpose' => 'string',
        'revenue_type_code' => 'string',
        'tax' => '\OpenAPI\Client\tinkoff\api\\TaxPaymentParameters',
        'to' => '\OpenAPI\Client\tinkoff\api\\ReceiverRequisites',
        'uin' => 'string'
    ];
    ...
    protected static $setters = [
        'amount' => 'setAmount',
        'collection_amount' => 'setCollectionAmount',
    ...
    protected static $getters = [
        'amount' => 'getAmount',
        'collection_amount' => 'getCollectionAmount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['collection_amount'] = $data['collection_amount'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['document_number']) && ($this->container['document_number'] < 1)) {
            $invalidProperties[] = "invalid value for 'document_number', must be bigger than or equal to 1.";
        }
        ...
        if ((mb_strlen($this->container['purpose']) > 210)) {
            $invalidProperties[] = "invalid value for 'purpose', the character length must be smaller than or equal to 210.";
        }
        ...
        if (!is_null($this->container['uin']) && !preg_match("/\\d{20}|\\d{25}|0/", $this->container['uin'])) {
            $invalidProperties[] = "invalid value for 'uin', must be conform to the pattern /\\d{20}|\\d{25}|0/.";
        }
    ...
    /**
     * Gets collection_amount
     *
     * @return float|null
     */
    public function getCollectionAmount()
    {
        return $this->container['collection_amount'];
    }

    /**
     * Sets collection_amount
     *
     * @param float|null $collection_amount Удержанная сумма в рублях
     *
     * @return self
     */
    public function setCollectionAmount($collection_amount)
    {
        $this->container['collection_amount'] = $collection_amount;
     ...
     *
     * @param int|null $document_number Номер распоряжения, определяемый клиентом. Заполняется на усмотрение плательщика
     *
     * @return self
     */
    public function setDocumentNumber($document_number)
    {
        ...
        if (!is_null($document_number) && ($document_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $document_number when calling CreatePaymentRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets due_date
     *
     * @param \DateTime|null $due_date Дата до которой необходимо провести платёж, при неуспешных попытках платежа он будет повторён вплоть до указанной даты. Если дату не передать, то платеж не будет повторён в случае неуспешной попытки. Время на проведение платежа не может быть больше 30 дней.
     *
     * @return self
     */
     ...
     *
     * @param int|null $execution_order Очерёдность платежа
     *
     * @return self
     */
    public function setExecutionOrder($execution_order)
    {
        ...
        if (!is_null($execution_order) && ($execution_order > 5)) {
            throw new \InvalidArgumentException('invalid value for $execution_order when calling CreatePaymentRequest., must be smaller than or equal to 5.');
        }
        if (!is_null($execution_order) && ($execution_order < 1)) {
            throw new \InvalidArgumentException('invalid value for $execution_order when calling CreatePaymentRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets from
     *
     * @return \OpenAPI\Client\tinkoff\api\\PayerRequisites
     */
     ...
     * Sets from
     *
     * @param \OpenAPI\Client\tinkoff\api\\PayerRequisites $from from
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Идентификатор платежа. Должен быть уникален в пределах интеграции
     *
     * @return self
     */
    ...
    {
        if ((mb_strlen($id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $id when calling CreatePaymentRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($id) < 1)) {
     ...
     * Sets meta
     *
     * @param object|null $meta Дополнительные метаданные в формате JSON. Сохраняются на создании платежа и возвращаются при получении статуса
     *
     * @return self
     */
    ...
    public function setPurpose($purpose)
    {
        if ((mb_strlen($purpose) > 210)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling CreatePaymentRequest., must be smaller than or equal to 210.');
        }
        if ((mb_strlen($purpose) < 1)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling CreatePaymentRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $revenue_type_code Код вида выплаты. Подробнее: http://www.consultant.ru/document/cons_doc_LAW_353568/527cf8edd2262cb7068cafd44ed596d9a05dd237/
     *
     * @return self
     */
     ...
     * Gets tax
     *
     * @return \OpenAPI\Client\tinkoff\api\\TaxPaymentParameters|null
     */
     ...
     * Sets tax
     *
     * @param \OpenAPI\Client\tinkoff\api\\TaxPaymentParameters|null $tax tax
     *
     * @return self
     */
     ...
     * Gets to
     *
     * @return \OpenAPI\Client\tinkoff\api\\ReceiverRequisites
     */
     ...
     * Sets to
     *
     * @param \OpenAPI\Client\tinkoff\api\\ReceiverRequisites $to to
     *
     * @return self
     */
     ...
     * Sets uin
     *
     * @param string|null $uin Уникальный идентификатор платежа. Поле платежки 22.  ВАЖНО: При налоговом платеже поле обязательно должно быть заполнено.  Подробнее: https://www.glavbukh.ru/art/98739-uin-v-platejnom-poruchenii-2021
     *
     * @return self
     */
    public function setUin($uin)
    {
        ...
        if (!is_null($uin) && (!preg_match("/\\d{20}|\\d{25}|0/", $uin))) {
            throw new \InvalidArgumentException("invalid value for $uin when calling CreatePaymentRequest., must conform to the pattern /\\d{20}|\\d{25}|0/.");
        }
