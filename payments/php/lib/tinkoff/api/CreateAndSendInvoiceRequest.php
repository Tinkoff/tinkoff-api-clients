...
/**
 * CreateAndSendInvoiceRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateAndSendInvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAndSendInvoiceRequest';
    ...
    protected static $openAPITypes = [
        ...
        'contacts' => '\OpenAPI\Client\tinkoff\api\\Email[]',
        'due_date' => '\DateTime',
        'invoice_date' => '\DateTime',
        'invoice_number' => 'string',
        'items' => '\OpenAPI\Client\tinkoff\api\\InvoiceItemInfo[]',
        'payer' => '\OpenAPI\Client\tinkoff\api\\InvoicePayerInfo'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['account_number']) && !preg_match("/^(\\d{20}|\\d{22})$/", $this->container['account_number'])) {
        ...
        if (!preg_match("/^\\d{1,15}$/", $this->container['invoice_number'])) {
            $invalidProperties[] = "invalid value for 'invoice_number', must be conform to the pattern /^\\d{1,15}$/.";
        }
     ...
     * Sets account_number
     *
     * @param string|null $account_number Рублевый расчетный счет отправителя. Если счет не указан, то для выставления счета будет использоваться главный счет компании.
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if (!is_null($account_number) && (!preg_match("/^(\\d{20}|\\d{22})$/", $account_number))) {
            throw new \InvalidArgumentException("invalid value for $account_number when calling CreateAndSendInvoiceRequest., must conform to the pattern /^(\\d{20}|\\d{22})$/.");
        }
     ...
     * Gets contacts
     *
     * @return \OpenAPI\Client\tinkoff\api\\Email[]|null
     */
     ...
     * Sets contacts
     *
     * @param \OpenAPI\Client\tinkoff\api\\Email[]|null $contacts Контакты для получения счета
     *
     * @return self
     */
     ...
     * Sets due_date
     *
     * @param \DateTime|null $due_date Срок оплаты. Должен быть не меньше даты выставления счета.
     *
     * @return self
     */
     ...
     * Sets invoice_date
     *
     * @param \DateTime|null $invoice_date Дата выставления счета. Если не указана, счет выставляется текущей датой.
     *
     * @return self
     */
     ...
     * Sets invoice_number
     *
     * @param string $invoice_number Номер счета
     *
     * @return self
     */
    public function setInvoiceNumber($invoice_number)
    {
        ...
        if ((!preg_match("/^\\d{1,15}$/", $invoice_number))) {
            throw new \InvalidArgumentException("invalid value for $invoice_number when calling CreateAndSendInvoiceRequest., must conform to the pattern /^\\d{1,15}$/.");
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\tinkoff\api\\InvoiceItemInfo[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\tinkoff\api\\InvoiceItemInfo[]|null $items Позиции счета
     *
     * @return self
     */
     ...
     * Gets payer
     *
     * @return \OpenAPI\Client\tinkoff\api\\InvoicePayerInfo|null
     */
     ...
     * Sets payer
     *
     * @param \OpenAPI\Client\tinkoff\api\\InvoicePayerInfo|null $payer payer
     *
     * @return self
     */
