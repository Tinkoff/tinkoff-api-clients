...
/**
 * SelfEmployedRegistryCreateTypeRequest Class Doc Comment
 *
 * @category Class
 * @description Может принимать одно из двух значений: &lt;ul&gt; &lt;li&gt;IGNORE_ERRORS - реестр будет создан из всех корректных платежей, его идентификатор вернется в поле paymentRegistryId метода /create/result. В случае если корректных платежей не оказалось, реестр не будет создан&lt;/li&gt; &lt;li&gt;FAIL_ERRORS - при наличии ошибочных платежей реестр создан не будет. По умолчанию \&quot;FAIL_ERRORS\&quot;&lt;/li&gt; &lt;/ul&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SelfEmployedRegistryCreateTypeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedRegistryCreateTypeRequest';
