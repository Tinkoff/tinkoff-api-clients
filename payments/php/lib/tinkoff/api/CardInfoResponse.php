...
/**
 * CardInfoResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CardInfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardInfoResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['embossed_name'] = $data['embossed_name'] ?? null;
        $this->container['is_active'] = $data['is_active'] ?? null;
        $this->container['status'] = $data['status'] ?? null;
        $this->container['ucid'] = $data['ucid'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ucid'] === null) {
            $invalidProperties[] = "'ucid' can't be null";
        }
     ...
     * Sets account_number
     *
     * @param string $account_number Номер рассчётного счёта, к которому привязана карта
     *
     * @return self
     */
     ...
     * Sets card_bin
     *
     * @param string $card_bin Первые 6 цифр номера карты (BIN карты)
     *
     * @return self
     */
     ...
     *
     * @param string $card_last_four_digits Последние 4 цифры номера карты
     *
     * @return self
     */
     ...
     * Sets embossed_name
     *
     * @param string $embossed_name Имя держателя карты
     *
     * @return self
     */
     ...
     * Sets is_active
     *
     * @param bool $is_active Флаг активации карты
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус карты:<ul> <li>\"NORM\" &ndash; карта активна</li> <li>\"CLOSED\" &ndash; карта неактивна</li> <li>\"BLOCKED\" &ndash; карта заблокирована</li> </ul>
     *
     * @return self
     */
    ...
    {
        return $this->container['ucid'];
    }

    /**
     * Sets ucid
     *
     * @param int $ucid Уникальный идентификатор карты
     *
     * @return self
     */
    public function setUcid($ucid)
    {
        $this->container['ucid'] = $ucid;
