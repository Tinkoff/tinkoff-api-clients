...
/**
 * ClientOffersRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientOffersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientOffersRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/\\d{2}/", $this->container['region'])) {
            $invalidProperties[] = "invalid value for 'region', must be conform to the pattern /\\d{2}/.";
        }
     ...
     * Sets region
     *
     * @param string $region Регион клиента
     *
     * @return self
     */
    public function setRegion($region)
    {
        ...
        if ((!preg_match("/\\d{2}/", $region))) {
            throw new \InvalidArgumentException("invalid value for $region when calling ClientOffersRequest., must conform to the pattern /\\d{2}/.");
        }
