...
/**
 * CreateSelfEmployedResultResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSelfEmployedResultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSelfEmployedResultResponse';
    ...
    protected static $openAPITypes = [
        'recipient_results' => '\OpenAPI\Client\tinkoff\api\\CreateSelfEmployed[]'
    ];
    ...
    protected static $setters = [
        'recipient_results' => 'setRecipientResults'
    ];
    ...
    protected static $getters = [
        'recipient_results' => 'getRecipientResults'
    ];
    ...
    {
        $this->container['recipient_results'] = $data['recipient_results'] ?? null;
    }
    ...
    /**
     * Gets recipient_results
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreateSelfEmployed[]|null
     */
    public function getRecipientResults()
    {
        return $this->container['recipient_results'];
    }

    /**
     * Sets recipient_results
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreateSelfEmployed[]|null $recipient_results Список результатов создания самозанятых
     *
     * @return self
     */
    public function setRecipientResults($recipient_results)
    {
        $this->container['recipient_results'] = $recipient_results;
