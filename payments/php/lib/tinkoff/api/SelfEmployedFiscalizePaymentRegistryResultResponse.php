...
/**
 * SelfEmployedFiscalizePaymentRegistryResultResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedFiscalizePaymentRegistryResultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedFiscalizePaymentRegistryResultResponse';
     ...
     * Sets status
     *
     * @param string $status Статус регистрации дохода по реестру
     *
     * @return self
     */
