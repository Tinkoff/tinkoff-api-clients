...
class BankStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'income' => 'float',
        'operation' => '\OpenAPI\Client\tinkoff\api\\BankStatementOperation[]',
        'outcome' => 'float',
        'saldo_in' => 'float',
        'saldo_out' => 'float'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['saldo_in'] = $data['saldo_in'] ?? null;
        $this->container['saldo_out'] = $data['saldo_out'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['saldo_in'] === null) {
            $invalidProperties[] = "'saldo_in' can't be null";
        }
        if ($this->container['saldo_out'] === null) {
            $invalidProperties[] = "'saldo_out' can't be null";
        }
     ...
     * Sets income
     *
     * @param float $income Обороты входящих платежей
     *
     * @return self
     */
     ...
     * Gets operation
     *
     * @return \OpenAPI\Client\tinkoff\api\\BankStatementOperation[]|null
     */
     ...
     * Sets operation
     *
     * @param \OpenAPI\Client\tinkoff\api\\BankStatementOperation[]|null $operation Список операций по счету
     *
     * @return self
     */
     ...
     * Sets outcome
     *
     * @param float $outcome Обороты исходящих платежей
     *
     * @return self
     */
     ...
     * @return float
     */
    public function getSaldoIn()
    {
        return $this->container['saldo_in'];
    }

    /**
     * Sets saldo_in
     *
     * @param float $saldo_in Баланс на начало периода
     *
     * @return self
     */
    public function setSaldoIn($saldo_in)
    {
        $this->container['saldo_in'] = $saldo_in;
     ...
     * @return float
     */
    public function getSaldoOut()
    {
        return $this->container['saldo_out'];
    }

    /**
     * Sets saldo_out
     *
     * @param float $saldo_out Баланс на конец периода
     *
     * @return self
     */
    public function setSaldoOut($saldo_out)
    {
        $this->container['saldo_out'] = $saldo_out;
