...
/**
 * ReceiptError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReceiptError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceiptError';
     ...
     * Sets message
     *
     * @param string $message Некорректный чек
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type RECEIPT_ERROR
     *
     * @return self
     */
