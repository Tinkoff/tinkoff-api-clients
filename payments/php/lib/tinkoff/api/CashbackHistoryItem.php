...
/**
 * CashbackHistoryItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CashbackHistoryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashbackHistoryItem';
    ...
    protected static $openAPITypes = [
        'cancellation_info' => '\OpenAPI\Client\tinkoff\api\\CashbackCancellationInfo',
        'cashback' => '\OpenAPI\Client\tinkoff\api\\CashbackInfoHistoryItem[]',
        'receipt' => '\OpenAPI\Client\tinkoff\api\\ReceiptHistoryItem',
        'status' => 'string'
    ];
    ...
    protected static $setters = [
        'cancellation_info' => 'setCancellationInfo',
    ...
    protected static $getters = [
        'cancellation_info' => 'getCancellationInfo',
    ...
    {
        $this->container['cancellation_info'] = $data['cancellation_info'] ?? null;
    ...
    /**
     * Gets cancellation_info
     *
     * @return \OpenAPI\Client\tinkoff\api\\CashbackCancellationInfo|null
     */
    public function getCancellationInfo()
    {
        return $this->container['cancellation_info'];
    }

    /**
     * Sets cancellation_info
     *
     * @param \OpenAPI\Client\tinkoff\api\\CashbackCancellationInfo|null $cancellation_info cancellation_info
     *
     * @return self
     */
    public function setCancellationInfo($cancellation_info)
    {
        $this->container['cancellation_info'] = $cancellation_info;
     ...
     * Gets cashback
     *
     * @return \OpenAPI\Client\tinkoff\api\\CashbackInfoHistoryItem[]|null
     */
     ...
     * Sets cashback
     *
     * @param \OpenAPI\Client\tinkoff\api\\CashbackInfoHistoryItem[]|null $cashback Детали кэшбэка за чек
     *
     * @return self
     */
     ...
     * Gets receipt
     *
     * @return \OpenAPI\Client\tinkoff\api\\ReceiptHistoryItem
     */
     ...
     * Sets receipt
     *
     * @param \OpenAPI\Client\tinkoff\api\\ReceiptHistoryItem $receipt receipt
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус обработки чека. Может принимать следующие значения: <ul> <li>PENDING - в обработке</li> <li>CANCELED - отменен</li> <li>PAID - оплачен</li> </ul>
     *
     * @return self
     */
