...
/**
 * ReissuedVirtualCardInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class ReissuedVirtualCardInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReissuedVirtualCardInfo';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['card_last_four_digits'] = $data['card_last_four_digits'] ?? null;
        $this->container['new_ucid'] = $data['new_ucid'] ?? null;
        $this->container['old_ucid'] = $data['old_ucid'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['card_bin'] === null) {
            $invalidProperties[] = "'card_bin' can't be null";
        }
        if ($this->container['card_last_four_digits'] === null) {
            $invalidProperties[] = "'card_last_four_digits' can't be null";
        }
        if ($this->container['new_ucid'] === null) {
            $invalidProperties[] = "'new_ucid' can't be null";
        }
        if ($this->container['old_ucid'] === null) {
            $invalidProperties[] = "'old_ucid' can't be null";
        }
     ...
     * Sets card_bin
     *
     * @param string $card_bin Первые 6 цифр номера новой карты (BIN карты)
     *
     * @return self
     */
     ...
     *
     * @param string $card_last_four_digits Последние 4 цифры номера новой карты
     *
     * @return self
     */
     ...
     * @return int
     */
    public function getNewUcid()
    {
        return $this->container['new_ucid'];
    }

    /**
     * Sets new_ucid
     *
     * @param int $new_ucid Уникальный идентификатор новой карты
     *
     * @return self
     */
    public function setNewUcid($new_ucid)
    {
        $this->container['new_ucid'] = $new_ucid;
     ...
     * @return int
     */
    public function getOldUcid()
    {
        return $this->container['old_ucid'];
    }

    /**
     * Sets old_ucid
     *
     * @param int $old_ucid Уникальный идентификатор старой карты
     *
     * @return self
     */
    public function setOldUcid($old_ucid)
    {
        $this->container['old_ucid'] = $old_ucid;
