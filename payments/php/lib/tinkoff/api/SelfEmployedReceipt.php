...
/**
 * SelfEmployedReceipt Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedReceipt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedReceipt';
    ...
    protected static $openAPITypes = [
        'error' => '\OpenAPI\Client\tinkoff\api\\ErrorResponse',
        'link' => 'string',
        'number' => 'int',
        'self_employed_info' => '\OpenAPI\Client\tinkoff\api\\SelfEmployeeInfo1',
        'status' => 'string'
    ];
    ...
    const STATUS_FISCALIZE_FAILED = 'FISCALIZE_FAILED';
     ...
     * Gets error
     *
     * @return \OpenAPI\Client\tinkoff\api\\ErrorResponse|null
     */
     ...
     * Sets error
     *
     * @param \OpenAPI\Client\tinkoff\api\\ErrorResponse|null $error error
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link Ссылка на чек
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\tinkoff\api\\SelfEmployeeInfo1
     */
     ...
     *
     * @param \OpenAPI\Client\tinkoff\api\\SelfEmployeeInfo1 $self_employed_info self_employed_info
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Результат регистрации дохода:<br><ul><li>IN_PROGRESS - Доход регистрируется.</li><li>SUCCESS - Доход был успешно зарегистрирован, возвращается fnsLink.</li><li>CANCELED - Чек был сторнирован, возвращается fnsLink.</li><li>FISCALIZE_FAILED - Доход не удалось зарегистрировать в налоговой.</li><li>ERROR - Не удалось получить статус наличия зарегистрированного дохода. <br>Возвращается в случае внутренней ошибки, или если по платежу еще не регистрировался доход.<br>Для повторной регистрации можно вызвать /fiscalize по реестру<br><a href=\"#operation/SelfEmployedFiscalizePaymentRegistry\">Получить результат регистрации дохода по реестру самозанятых</a>.</li><ul>
     *
     * @return self
     */
