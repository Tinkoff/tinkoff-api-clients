...
class BankInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cor_account'] = $data['cor_account'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cor_account'] === null) {
            $invalidProperties[] = "'cor_account' can't be null";
        }
        if (!preg_match("/\\d{20}/", $this->container['cor_account'])) {
            $invalidProperties[] = "invalid value for 'cor_account', must be conform to the pattern /\\d{20}/.";
        }
    ...
    public function setBik($bik)
    {
        ...
        if ((!preg_match("/\\d{9}/", $bik))) {
            throw new \InvalidArgumentException("invalid value for $bik when calling BankInfo., must conform to the pattern /\\d{9}/.");
        }
    ...
    {
        return $this->container['cor_account'];
    }

    /**
     * Sets cor_account
     *
     * @param string $cor_account Корреспондентский счёт банка получателя
     *
     * @return self
     */
    public function setCorAccount($cor_account)
    {

        if ((!preg_match("/\\d{20}/", $cor_account))) {
            throw new \InvalidArgumentException("invalid value for $cor_account when calling BankInfo., must conform to the pattern /\\d{20}/.");
        }

        $this->container['cor_account'] = $cor_account;
     ...
     * Sets name
     *
     * @param string $name Наименование банка получателя
     *
     * @return self
     */
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BankInfo., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BankInfo., must be bigger than or equal to 1.');
        }
