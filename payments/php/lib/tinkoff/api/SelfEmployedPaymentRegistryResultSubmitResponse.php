...
/**
 * SelfEmployedPaymentRegistryResultSubmitResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedPaymentRegistryResultSubmitResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedPaymentRegistryResultSubmitResponse';
    ...
    protected static $openAPITypes = [
        ...
        'payment_errors' => '\OpenAPI\Client\tinkoff\api\\SubmitPaymentError[]',
    ...
    protected static $attributeMap = [
        ...
        'payment_registry_id' => 'paymentRegistryId',
        'status' => 'status'
    ];
    ...
    protected static $setters = [
        'error' => 'setError',
        'payment_errors' => 'setPaymentErrors',
        'payment_registry_id' => 'setPaymentRegistryId',
        'status' => 'setStatus'
    ];
    ...
    protected static $getters = [
        'error' => 'getError',
        'payment_errors' => 'getPaymentErrors',
        'payment_registry_id' => 'getPaymentRegistryId',
        'status' => 'getStatus'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_errors'] = $data['payment_errors'] ?? null;
        $this->container['payment_registry_id'] = $data['payment_registry_id'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_registry_id'] === null) {
            $invalidProperties[] = "'payment_registry_id' can't be null";
        }
     ...
     * Gets payment_errors
     *
     * @return \OpenAPI\Client\tinkoff\api\\SubmitPaymentError[]|null
     */
    public function getPaymentErrors()
    {
        return $this->container['payment_errors'];
    }

    /**
     * Sets payment_errors
     *
     * @param \OpenAPI\Client\tinkoff\api\\SubmitPaymentError[]|null $payment_errors Платежи внутри реестра, содержащие ошибки
     *
     * @return self
     */
    public function setPaymentErrors($payment_errors)
    {
        $this->container['payment_errors'] = $payment_errors;

        return $this;
    }

    /**
     * Gets payment_registry_id
     *
     * @return int
     */
    public function getPaymentRegistryId()
    {
        return $this->container['payment_registry_id'];
    }

    /**
     * Sets payment_registry_id
     *
     * @param int $payment_registry_id Идентификатор платежного реестра
     *
     * @return self
     */
    public function setPaymentRegistryId($payment_registry_id)
    {
        $this->container['payment_registry_id'] = $payment_registry_id;
     ...
     * Sets status
     *
     * @param string $status Статус подписания платежного реестра
     *
     * @return self
     */
