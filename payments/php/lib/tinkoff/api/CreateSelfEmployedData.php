...
/**
 * CreateSelfEmployedData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSelfEmployedData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSelfEmployedData';
    ...
    protected static $openAPITypes = [
        'addresses' => '\OpenAPI\Client\tinkoff\api\\CreateAddress1[]',
        'birth_date' => '\DateTime',
        'birth_place' => 'string',
        'citizenship' => 'string',
        'documents' => '\OpenAPI\Client\tinkoff\api\\CreateDocument1[]',
        'email' => 'string',
        'first_name' => 'string',
        'last_name' => 'string',
        ...
        'middle_name' => 'string',
        'number' => 'int',
        'phones' => '\OpenAPI\Client\tinkoff\api\\CreatePhone1[]',
        'registration_info' => '\OpenAPI\Client\tinkoff\api\\CreateSelfEmployedRegistrationInfo'
    ];
    ...
    protected static $setters = [
        ...
        'latin_first_name' => 'setLatinFirstName',
        'latin_last_name' => 'setLatinLastName',
    ...
    protected static $getters = [
        ...
        'latin_first_name' => 'getLatinFirstName',
        'latin_last_name' => 'getLatinLastName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['latin_first_name'] = $data['latin_first_name'] ?? null;
        $this->container['latin_last_name'] = $data['latin_last_name'] ?? null;
     ...
     * Gets addresses
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreateAddress1[]|null
     */
     ...
     * Sets addresses
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreateAddress1[]|null $addresses Необходимо указать следующие адреса: Жительства, Регистрации
     *
     * @return self
     */
     ...
     * Sets birth_date
     *
     * @param \DateTime $birth_date Дата рождения
     *
     * @return self
     */
     ...
     * Sets birth_place
     *
     * @param string $birth_place Место рождения
     *
     * @return self
     */
     ...
     * Sets citizenship
     *
     * @param string $citizenship Гражданство
     *
     * @return self
     */
     ...
     * Gets documents
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreateDocument1[]|null
     */
     ...
     * Sets documents
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreateDocument1[]|null $documents <br> <b>Для граждан РФ</b> необходимо указать: <ul>   <li>Данные паспорта</li> </ul> <b>Для иностранных граждан</b> необходимо указать: <ul>   <li>Один из основных документов: \"Иностранный паспорт\", \"Загр. паспорт иностранного гр.\", \"Служебный/официальный паспорт\", \"Дипломатический паспорт\"</li>   <li>Один из миграционных документов: \"Миграционная карта\", \"Разр. на временное проживание\", \"Вид на жительство\"</li> </ul>
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string $first_name Имя (кириллица)
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string $last_name Фамилия (кириллица)
     *
     * @return self
     */
    ...
    /**
     * Gets latin_first_name
     *
     * @return string|null
     */
    public function getLatinFirstName()
    {
        return $this->container['latin_first_name'];
    }

    /**
     * Sets latin_first_name
     *
     * @param string|null $latin_first_name Имя (латиница)
     *
     * @return self
     */
    public function setLatinFirstName($latin_first_name)
    {
        $this->container['latin_first_name'] = $latin_first_name;

        return $this;
    }

    /**
     * Gets latin_last_name
     *
     * @return string|null
     */
    public function getLatinLastName()
    {
        return $this->container['latin_last_name'];
    }

    /**
     * Sets latin_last_name
     *
     * @param string|null $latin_last_name Фамилия (латиница)
     *
     * @return self
     */
    public function setLatinLastName($latin_last_name)
    {
        $this->container['latin_last_name'] = $latin_last_name;
     ...
     * Sets middle_name
     *
     * @param string|null $middle_name Отчество (кириллица)
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int $number Идентификатор самозанятого на стороне клиента
     *
     * @return self
     */
     ...
     * Gets phones
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreatePhone1[]|null
     */
     ...
     * Sets phones
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreatePhone1[]|null $phones Необходимо указать: Мобильный телефон
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreateSelfEmployedRegistrationInfo|null
     */
     ...
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreateSelfEmployedRegistrationInfo|null $registration_info registration_info
     *
     * @return self
     */
