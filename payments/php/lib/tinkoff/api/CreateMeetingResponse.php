...
/**
 * CreateMeetingResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateMeetingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets meeting_id
     *
     * @param string $meeting_id Идентификатор назначенной встречи
     *
     * @return self
     */
