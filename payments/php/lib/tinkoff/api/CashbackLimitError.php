...
/**
 * CashbackLimitError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CashbackLimitError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashbackLimitError';
     ...
     * Sets message
     *
     * @param string $message Превышен лимит
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type CASHBACK_LIMIT_ERROR
     *
     * @return self
     */
