 ...
 */
class InnResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InnResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['inn']) && !preg_match("/^(\\d{12})$/", $this->container['inn'])) {
            $invalidProperties[] = "invalid value for 'inn', must be conform to the pattern /^(\\d{12})$/.";
        }
    ...
    public function setInn($inn)
    {
        ...
        if (!is_null($inn) && (!preg_match("/^(\\d{12})$/", $inn))) {
            throw new \InvalidArgumentException("invalid value for $inn when calling InnResponse., must conform to the pattern /^(\\d{12})$/.");
        }
