...
/**
 * CreateSbpPaymentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSbpPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSbpPaymentRequest';
    ...
    protected static $openAPITypes = [
        'amount' => 'float',
        'document_number' => 'int',
        'from' => '\OpenAPI\Client\tinkoff\api\\SbpPayerRequisites',
        'id' => 'string',
        'purpose' => 'string',
        'revenue_type_code' => 'string',
        'to' => '\OpenAPI\Client\tinkoff\api\\SbpReceiverRequisites'
    ];
    ...
    public function setDocumentNumber($document_number)
    {
        ...
        if (!is_null($document_number) && ($document_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $document_number when calling CreateSbpPaymentRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets from
     *
     * @return \OpenAPI\Client\tinkoff\api\\SbpPayerRequisites|null
     */
     ...
     * Sets from
     *
     * @param \OpenAPI\Client\tinkoff\api\\SbpPayerRequisites|null $from from
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Идентификатор платежа. Должен быть уникален в пределах интеграции как для платежей через СБП, так и <a href=\"#operation/PaymentsCorePay\">платежей по банковским реквизитам</a>.
     *
     * @return self
     */
    ...
    {
        if ((mb_strlen($id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $id when calling CreateSbpPaymentRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling CreateSbpPaymentRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets purpose
     *
     * @param string $purpose Назначение платежа, обязательна информация по НДС
     *
     * @return self
     */
    public function setPurpose($purpose)
    {
        if ((mb_strlen($purpose) > 210)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling CreateSbpPaymentRequest., must be smaller than or equal to 210.');
        }
        if ((mb_strlen($purpose) < 1)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling CreateSbpPaymentRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets to
     *
     * @return \OpenAPI\Client\tinkoff\api\\SbpReceiverRequisites
     */
     ...
     * Sets to
     *
     * @param \OpenAPI\Client\tinkoff\api\\SbpReceiverRequisites $to to
     *
     * @return self
     */
