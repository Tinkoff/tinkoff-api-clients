...
/**
 * SelfEmployedPaymentRegistry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedPaymentRegistry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedPaymentRegistry';
    ...
    protected static $openAPITypes = [
        'load_date' => 'string',
        'payments' => '\OpenAPI\Client\tinkoff\api\\SelfEmployedPaymentInfo[]',
        'payments_count' => 'int',
        'status' => 'string',
        'total_sum' => 'float'
    ];
     ...
     * Sets load_date
     *
     * @param string|null $load_date Дата исполнения реестра
     *
     * @return self
     */
     ...
     * Gets payments
     *
     * @return \OpenAPI\Client\tinkoff\api\\SelfEmployedPaymentInfo[]|null
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\tinkoff\api\\SelfEmployedPaymentInfo[]|null $payments Список платежей внутри реестра
     *
     * @return self
     */
