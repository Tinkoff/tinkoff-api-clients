...
/**
 * ActiveOffersResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActiveOffersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActiveOffersResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\tinkoff\api\\ActiveOffer[]'
    ];
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\tinkoff\api\\ActiveOffer[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\tinkoff\api\\ActiveOffer[]|null $data Офферы текущей страницы
     *
     * @return self
     */
