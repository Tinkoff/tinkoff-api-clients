...
/**
 * CreateSelfEmployedRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSelfEmployedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSelfEmployedRequest';
    ...
    protected static $openAPITypes = [
        ...
        'recipients' => '\OpenAPI\Client\tinkoff\api\\CreateSelfEmployedData[]'
    ];
     ...
     * Gets recipients
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreateSelfEmployedData[]|null
     */
     ...
     * Sets recipients
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreateSelfEmployedData[]|null $recipients Список самозанятых на создание
     *
     * @return self
     */
