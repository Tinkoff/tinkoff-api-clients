...
/**
 * SelfEmployedInfoRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedInfoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedInfoRequest';
    ...
    {
        $this->container['recipient_ids'] = $data['recipient_ids'] ?? null;
    }
     ...
     * Sets recipient_ids
     *
     * @param int[]|null $recipient_ids Список идентификаторов самозанятых
     *
     * @return self
     */
