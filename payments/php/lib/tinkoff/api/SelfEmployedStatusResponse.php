...
/**
 * SelfEmployedStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedStatusResponse';
    ...
    protected static $setters = [
        'is_self_employed' => 'setIsSelfEmployed'
    ];
    ...
    protected static $getters = [
        'is_self_employed' => 'getIsSelfEmployed'
    ];
    ...
    {
        $this->container['is_self_employed'] = $data['is_self_employed'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_self_employed'] === null) {
            $invalidProperties[] = "'is_self_employed' can't be null";
        }
    ...
    /**
     * Gets is_self_employed
     *
     * @return bool
     */
    public function getIsSelfEmployed()
    {
        return $this->container['is_self_employed'];
    }

    /**
     * Sets is_self_employed
     *
     * @param bool $is_self_employed Является ли пользователь самозанятым
     *
     * @return self
     */
    public function setIsSelfEmployed($is_self_employed)
    {
        $this->container['is_self_employed'] = $is_self_employed;
