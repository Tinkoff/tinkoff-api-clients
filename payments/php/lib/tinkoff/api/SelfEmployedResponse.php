...
/**
 * SelfEmployedResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedResponse';
    ...
    protected static $openAPITypes = [
        'recipients' => '\OpenAPI\Client\tinkoff\api\\SelfEmployed[]'
    ];
     ...
     * Gets recipients
     *
     * @return \OpenAPI\Client\tinkoff\api\\SelfEmployed[]|null
     */
     ...
     * Sets recipients
     *
     * @param \OpenAPI\Client\tinkoff\api\\SelfEmployed[]|null $recipients Список самозанятых
     *
     * @return self
     */
