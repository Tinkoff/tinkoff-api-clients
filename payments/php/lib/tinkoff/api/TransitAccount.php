...
/**
 * TransitAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class TransitAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransitAccount';
     ...
     * Sets account_number
     *
     * @param string $account_number Номер транзитного банковского счета
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param string $balance Текущий остаток по транзитному счету
     *
     * @return self
     */
