...
class Phone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^((\\+7)([0-9]){10})$/", $this->container['number'])) {
            $invalidProperties[] = "invalid value for 'number', must be conform to the pattern /^((\\+7)([0-9]){10})$/.";
        }
     ...
     * Sets number
     *
     * @param string $number Номер телефона в формате +7xxxxxxxxxx
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((!preg_match("/^((\\+7)([0-9]){10})$/", $number))) {
            throw new \InvalidArgumentException("invalid value for $number when calling Phone., must conform to the pattern /^((\\+7)([0-9]){10})$/.");
        }
