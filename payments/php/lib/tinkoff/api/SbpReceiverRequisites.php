...
/**
 * SbpReceiverRequisites Class Doc Comment
 *
 * @category Class
 ...
 */
class SbpReceiverRequisites implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SbpReceiverRequisites';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[\\d\\w]{12}$/", $this->container['bank_id'])) {
            $invalidProperties[] = "invalid value for 'bank_id', must be conform to the pattern /^[\\d\\w]{12}$/.";
        }
        ...
        if (!preg_match("/^\\+7\\d{10}$/", $this->container['phone'])) {
            $invalidProperties[] = "invalid value for 'phone', must be conform to the pattern /^\\+7\\d{10}$/.";
        }
     ...
     * Sets bank_id
     *
     * @param string $bank_id Идентификатор банка в системе быстрых платежей
     *
     * @return self
     */
    public function setBankId($bank_id)
    {
        ...
        if ((!preg_match("/^[\\d\\w]{12}$/", $bank_id))) {
            throw new \InvalidArgumentException("invalid value for $bank_id when calling SbpReceiverRequisites., must conform to the pattern /^[\\d\\w]{12}$/.");
        }
     ...
     * Sets first_name
     *
     * @param string $first_name Имя получателя
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        if ((mb_strlen($first_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SbpReceiverRequisites., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SbpReceiverRequisites., must be bigger than or equal to 1.');
        }
     ...
     * Sets last_name
     *
     * @param string $last_name Фамилия получателя
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        if ((mb_strlen($last_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SbpReceiverRequisites., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SbpReceiverRequisites., must be bigger than or equal to 1.');
        }
     ...
     * Sets middle_name
     *
     * @param string|null $middle_name Отчество получателя
     *
     * @return self
     */
    public function setMiddleName($middle_name)
    {
        if (!is_null($middle_name) && (mb_strlen($middle_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling SbpReceiverRequisites., must be smaller than or equal to 100.');
        }
        if (!is_null($middle_name) && (mb_strlen($middle_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling SbpReceiverRequisites., must be bigger than or equal to 1.');
        }
     ...
     * Sets phone
     *
     * @param string $phone Номер мобильного телефона получателя
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/^\\+7\\d{10}$/", $phone))) {
            throw new \InvalidArgumentException("invalid value for $phone when calling SbpReceiverRequisites., must conform to the pattern /^\\+7\\d{10}$/.");
        }
