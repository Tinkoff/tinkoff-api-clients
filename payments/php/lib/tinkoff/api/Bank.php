...
class Bank implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bank_inn'] = $data['bank_inn'] ?? null;
        $this->container['bank_name'] = $data['bank_name'] ?? null;
        $this->container['corr_account'] = $data['corr_account'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bank_bic'] === null) {
            $invalidProperties[] = "'bank_bic' can't be null";
        }
        if ($this->container['bank_inn'] === null) {
            $invalidProperties[] = "'bank_inn' can't be null";
        }
        if ($this->container['bank_name'] === null) {
            $invalidProperties[] = "'bank_name' can't be null";
        }
        if ($this->container['corr_account'] === null) {
            $invalidProperties[] = "'corr_account' can't be null";
        }
    ...
    {
        return $this->container['bank_inn'];
    }

    /**
     * Sets bank_inn
     *
     * @param string $bank_inn ИНН
     *
     * @return self
     */
    public function setBankInn($bank_inn)
    {
        $this->container['bank_inn'] = $bank_inn;
    ...
    {
        return $this->container['corr_account'];
    }

    /**
     * Sets corr_account
     *
     * @param string $corr_account Корреспондентский счет
     *
     * @return self
     */
    public function setCorrAccount($corr_account)
    {
        $this->container['corr_account'] = $corr_account;
