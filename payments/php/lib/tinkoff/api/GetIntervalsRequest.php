...
/**
 * GetIntervalsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetIntervalsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetIntervalsRequest';
    ...
    protected static $openAPITypes = [
        'address' => '\OpenAPI\Client\tinkoff\api\\Address',
        'task_ids' => 'string[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['task_ids'] = $data['task_ids'] ?? null;
    }
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\tinkoff\api\\Address
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\tinkoff\api\\Address $address address
     *
     * @return self
     */
     ...
     * Sets task_ids
     *
     * @param string[]|null $task_ids Cписок идентификаторов заданий, по которым необходимо получить доступные интервалы для назначения встреч
     *
     * @return self
     */
