...
/**
 * SbpPayerRequisites Class Doc Comment
 *
 * @category Class
 ...
 */
class SbpPayerRequisites implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SbpPayerRequisites';
     ...
     * Sets account_number
     *
     * @param string|null $account_number Номер расчетного счета для списания. Если не указан, то перевод будет осуществляться с главного счета компании.
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if (!is_null($account_number) && (!preg_match("/^(\\d{20}|\\d{22})$/", $account_number))) {
            throw new \InvalidArgumentException("invalid value for $account_number when calling SbpPayerRequisites., must conform to the pattern /^(\\d{20}|\\d{22})$/.");
        }
