...
/**
 * CreateAddress1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateAddress1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAddress1';
    ...
    const TYPE_ZHITEL_STVA = 'Жительства';
    const TYPE_REGISTRATSII = 'Регистрации';
    ...
    {
        return [
            self::TYPE_ZHITEL_STVA,
            self::TYPE_REGISTRATSII,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['construction'] = $data['construction'] ?? null;
     ...
     * Sets construction
     *
     * @param string|null $construction Корпус
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code Индекс
     *
     * @return self
     */
