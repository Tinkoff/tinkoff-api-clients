...
namespace OpenAPI\Client\tinkoff\api\payments;
...
class PaymentsApi
{
    ...
    /**
     * Operation paymentsCoreGetStatus
     *
     ...
     * @return \OpenAPI\Client\tinkoff\api\\PaymentStatusResponse|\OpenAPI\Client\tinkoff\api\\InvalidRequestResponse|\OpenAPI\Client\tinkoff\api\\AuthenticationFailedResponse|\OpenAPI\Client\tinkoff\api\\AuthorizationFailedResponse|\OpenAPI\Client\tinkoff\api\\BusinessErrorResponse|\OpenAPI\Client\tinkoff\api\\TooManyRequestsErrorResponse|\OpenAPI\Client\tinkoff\api\\InternalServerErrorResponse
     */
    public function paymentsCoreGetStatus($payment_id)
    {
        list($response) = $this->paymentsCoreGetStatusWithHttpInfo($payment_id);
        return $response;
    }

    /**
     * Operation paymentsCoreGetStatusWithHttpInfo
     *
     * 🔒 Получить статус платежа
     *
     * @param  string $payment_id Идентификатор платежа (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\tinkoff\api\\PaymentStatusResponse|\OpenAPI\Client\tinkoff\api\\InvalidRequestResponse|\OpenAPI\Client\tinkoff\api\\AuthenticationFailedResponse|\OpenAPI\Client\tinkoff\api\\AuthorizationFailedResponse|\OpenAPI\Client\tinkoff\api\\BusinessErrorResponse|\OpenAPI\Client\tinkoff\api\\TooManyRequestsErrorResponse|\OpenAPI\Client\tinkoff\api\\InternalServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentsCoreGetStatusWithHttpInfo($payment_id)
    {
        $request = $this->paymentsCoreGetStatusRequest($payment_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\tinkoff\api\\PaymentStatusResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\tinkoff\api\\PaymentStatusResponse', []),
            ...
            $returnType = '\OpenAPI\Client\tinkoff\api\\PaymentStatusResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\tinkoff\api\\PaymentStatusResponse',
    ...
    /**
     * Operation paymentsCoreGetStatusAsync
     *
     * 🔒 Получить статус платежа
     *
     * @param  string $payment_id Идентификатор платежа (required)
     ...
     */
    public function paymentsCoreGetStatusAsync($payment_id)
    {
        return $this->paymentsCoreGetStatusAsyncWithHttpInfo($payment_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation paymentsCoreGetStatusAsyncWithHttpInfo
     *
     * 🔒 Получить статус платежа
     *
     * @param  string $payment_id Идентификатор платежа (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentsCoreGetStatusAsyncWithHttpInfo($payment_id)
    {
        $returnType = '\OpenAPI\Client\tinkoff\api\\PaymentStatusResponse';
        $request = $this->paymentsCoreGetStatusRequest($payment_id);
    ...
    /**
     * Create request for operation 'paymentsCoreGetStatus'
     *
     * @param  string $payment_id Идентификатор платежа (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function paymentsCoreGetStatusRequest($payment_id)
    {
        // verify the required parameter 'payment_id' is set
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_id when calling paymentsCoreGetStatus'
            );
        }

        $resourcePath = '/api/v1/payment/{paymentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation paymentsCorePay
     *
     * 🔒 Выполнить платёж
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreatePaymentRequest $create_payment_request create_payment_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function paymentsCorePay($create_payment_request)
    {
        $this->paymentsCorePayWithHttpInfo($create_payment_request);
    }

    /**
     * Operation paymentsCorePayWithHttpInfo
     *
     * 🔒 Выполнить платёж
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreatePaymentRequest $create_payment_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentsCorePayWithHttpInfo($create_payment_request)
    {
        $request = $this->paymentsCorePayRequest($create_payment_request);
    ...
    /**
     * Operation paymentsCorePayAsync
     *
     * 🔒 Выполнить платёж
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreatePaymentRequest $create_payment_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentsCorePayAsync($create_payment_request)
    {
        return $this->paymentsCorePayAsyncWithHttpInfo($create_payment_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation paymentsCorePayAsyncWithHttpInfo
     *
     * 🔒 Выполнить платёж
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreatePaymentRequest $create_payment_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentsCorePayAsyncWithHttpInfo($create_payment_request)
    {
        $returnType = '';
        $request = $this->paymentsCorePayRequest($create_payment_request);
    ...
    /**
     * Create request for operation 'paymentsCorePay'
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreatePaymentRequest $create_payment_request (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function paymentsCorePayRequest($create_payment_request)
    {
        ...
        if ($create_payment_request === null || (is_array($create_payment_request) && count($create_payment_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_payment_request when calling paymentsCorePay'
            );
        }

        $resourcePath = '/api/v1/payment/ruble-transfer/pay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postApiV1PaymentCreate
     *
     ...
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreatePaymentDraftRequest $create_payment_draft_request create_payment_draft_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\tinkoff\api\\CreatePaymentDraftResponse|\OpenAPI\Client\tinkoff\api\\InvalidRequestResponse|\OpenAPI\Client\tinkoff\api\\AuthenticationFailedResponse|\OpenAPI\Client\tinkoff\api\\AuthorizationFailedResponse|\OpenAPI\Client\tinkoff\api\\BusinessErrorResponse|\OpenAPI\Client\tinkoff\api\\TooManyRequestsErrorResponse|\OpenAPI\Client\tinkoff\api\\InternalServerErrorResponse
     */
    public function postApiV1PaymentCreate($create_payment_draft_request)
    {
        list($response) = $this->postApiV1PaymentCreateWithHttpInfo($create_payment_draft_request);
        return $response;
    }

    /**
     * Operation postApiV1PaymentCreateWithHttpInfo
     *
     * Создать черновик платежного поручения
     *
     * This oepration contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     * URL: https://business.tinkoff.ru/openapi
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreatePaymentDraftRequest $create_payment_draft_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\tinkoff\api\\CreatePaymentDraftResponse|\OpenAPI\Client\tinkoff\api\\InvalidRequestResponse|\OpenAPI\Client\tinkoff\api\\AuthenticationFailedResponse|\OpenAPI\Client\tinkoff\api\\AuthorizationFailedResponse|\OpenAPI\Client\tinkoff\api\\BusinessErrorResponse|\OpenAPI\Client\tinkoff\api\\TooManyRequestsErrorResponse|\OpenAPI\Client\tinkoff\api\\InternalServerErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApiV1PaymentCreateWithHttpInfo($create_payment_draft_request)
    {
        $request = $this->postApiV1PaymentCreateRequest($create_payment_draft_request);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\tinkoff\api\\CreatePaymentDraftResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\tinkoff\api\\CreatePaymentDraftResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\tinkoff\api\\CreatePaymentDraftResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\tinkoff\api\\CreatePaymentDraftResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation postApiV1PaymentCreateAsync
     *
     * Создать черновик платежного поручения
     *
     * This oepration contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1PaymentCreateAsync($create_payment_draft_request)
    {
        return $this->postApiV1PaymentCreateAsyncWithHttpInfo($create_payment_draft_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postApiV1PaymentCreateAsyncWithHttpInfo
     *
     * Создать черновик платежного поручения
     *
     * This oepration contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApiV1PaymentCreateAsyncWithHttpInfo($create_payment_draft_request)
    {
        $returnType = '\OpenAPI\Client\tinkoff\api\\CreatePaymentDraftResponse';
        $request = $this->postApiV1PaymentCreateRequest($create_payment_draft_request);
    ...
    /**
     * Create request for operation 'postApiV1PaymentCreate'
     *
     * This oepration contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     * URL: https://business.tinkoff.ru/openapi
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApiV1PaymentCreateRequest($create_payment_draft_request)
    {
        // verify the required parameter 'create_payment_draft_request' is set
        if ($create_payment_draft_request === null || (is_array($create_payment_draft_request) && count($create_payment_draft_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_payment_draft_request when calling postApiV1PaymentCreate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($create_payment_draft_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_payment_draft_request));
            } else {
                $httpBody = $create_payment_draft_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreateSbpPaymentRequest $create_sbp_payment_request create_sbp_payment_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function sbpPay($create_sbp_payment_request)
    {
        $this->sbpPayWithHttpInfo($create_sbp_payment_request);
    }

    /**
     * Operation sbpPayWithHttpInfo
     *
     * 🔒 Выполнить платёж через систему быстрых платежей (СБП)
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreateSbpPaymentRequest $create_sbp_payment_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function sbpPayWithHttpInfo($create_sbp_payment_request)
    {
        $request = $this->sbpPayRequest($create_sbp_payment_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sbpPayAsync($create_sbp_payment_request)
    {
        return $this->sbpPayAsyncWithHttpInfo($create_sbp_payment_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sbpPayAsyncWithHttpInfo
     *
     * 🔒 Выполнить платёж через систему быстрых платежей (СБП)
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreateSbpPaymentRequest $create_sbp_payment_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sbpPayAsyncWithHttpInfo($create_sbp_payment_request)
    {
        $returnType = '';
        $request = $this->sbpPayRequest($create_sbp_payment_request);
    ...
    /**
     * Create request for operation 'sbpPay'
     *
     * @param  \OpenAPI\Client\tinkoff\api\\CreateSbpPaymentRequest $create_sbp_payment_request (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sbpPayRequest($create_sbp_payment_request)
    {
        // verify the required parameter 'create_sbp_payment_request' is set
        if ($create_sbp_payment_request === null || (is_array($create_sbp_payment_request) && count($create_sbp_payment_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_sbp_payment_request when calling sbpPay'
            );
        }

        $resourcePath = '/api/v1/payment/sbp/pay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_sbp_payment_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_sbp_payment_request));
            } else {
                $httpBody = $create_sbp_payment_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
