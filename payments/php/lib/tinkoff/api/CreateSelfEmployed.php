...
/**
 * CreateSelfEmployed Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSelfEmployed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSelfEmployed';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\tinkoff\api\\FieldValidationError1[]',
        'first_name' => 'string',
        'last_name' => 'string',
        'middle_name' => 'string',
        'number' => 'int',
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\tinkoff\api\\FieldValidationError1[]|null
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\tinkoff\api\\FieldValidationError1[]|null $errors Список ошибок
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int $number Номер самозанятого, переданный клиентом при создании
     *
     * @return self
     */
     ...
     * Sets recipient_id
     *
     * @param int|null $recipient_id Идентификатор самозанятого. Может не прийти, если при создании самозанятого возникли ошибки.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус создания:<br><ul><li>QUEUED - самозанятый в данный момент стоит в очереди на создание</li><li>CREATED - самозанятый создан</li><li>ERROR - самозанятый не был создан (ошибки перечислены в поле <b>errors</b>)</li><ul>
     *
     * @return self
     */
