...
/**
 * PayerRequisites Class Doc Comment
 *
 * @category Class
 ...
 */
class PayerRequisites implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayerRequisites';
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((!preg_match("/^(\\d{20}|\\d{22})$/", $account_number))) {
            throw new \InvalidArgumentException("invalid value for $account_number when calling PayerRequisites., must conform to the pattern /^(\\d{20}|\\d{22})$/.");
        }
