...
/**
 * TaxPaymentParameters Class Doc Comment
 *
 * @category Class
 ...
 */
class TaxPaymentParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxPaymentParameters';
    ...
    protected static $openAPITypes = [
        ...
        'payer_status' => 'string',
        'period' => 'string',
        'third_party' => '\OpenAPI\Client\tinkoff\api\\TaxThirdParty'
    ];
    ...
    {
        $this->container['doc_date'] = $data['doc_date'] ?? null;
        $this->container['doc_number'] = $data['doc_number'] ?? null;
        $this->container['evidence'] = $data['evidence'] ?? null;
        $this->container['kbk'] = $data['kbk'] ?? null;
        $this->container['oktmo'] = $data['oktmo'] ?? null;
        $this->container['payer_status'] = $data['payer_status'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['doc_date'] === null) {
            $invalidProperties[] = "'doc_date' can't be null";
        }
        if (!preg_match("/\\d{2}\\.\\d{2}\\.\\d{4}|0/", $this->container['doc_date'])) {
            $invalidProperties[] = "invalid value for 'doc_date', must be conform to the pattern /\\d{2}\\.\\d{2}\\.\\d{4}|0/.";
        }

        if ($this->container['doc_number'] === null) {
            $invalidProperties[] = "'doc_number' can't be null";
        }
        if (!preg_match("/[A-Za-zА-Яа-я]{2}|0/", $this->container['doc_number'])) {
            $invalidProperties[] = "invalid value for 'doc_number', must be conform to the pattern /[A-Za-zА-Яа-я]{2}|0/.";
        }

        if ($this->container['evidence'] === null) {
            $invalidProperties[] = "'evidence' can't be null";
        }
        if (!preg_match("/[A-Za-zА-Яа-я]{2}|0/", $this->container['evidence'])) {
            $invalidProperties[] = "invalid value for 'evidence', must be conform to the pattern /[A-Za-zА-Яа-я]{2}|0/.";
        }

        if ($this->container['kbk'] === null) {
            $invalidProperties[] = "'kbk' can't be null";
        }
        if (!preg_match("/\\d{20}/", $this->container['kbk'])) {
            $invalidProperties[] = "invalid value for 'kbk', must be conform to the pattern /\\d{20}/.";
        }

        if ($this->container['oktmo'] === null) {
            $invalidProperties[] = "'oktmo' can't be null";
        }
        if (!preg_match("/\\d{8}|\\d{11}/", $this->container['oktmo'])) {
            $invalidProperties[] = "invalid value for 'oktmo', must be conform to the pattern /\\d{8}|\\d{11}/.";
        }

        if ($this->container['payer_status'] === null) {
            $invalidProperties[] = "'payer_status' can't be null";
        }
        if (!preg_match("/\\d{2}/", $this->container['payer_status'])) {
            $invalidProperties[] = "invalid value for 'payer_status', must be conform to the pattern /\\d{2}/.";
        }

        if ($this->container['period'] === null) {
            $invalidProperties[] = "'period' can't be null";
        }
        if (!preg_match("/([A-Za-zА-Яа-я]{2}|\\d{2})\\.\\d{2}\\.\\d{4}|0/", $this->container['period'])) {
            $invalidProperties[] = "invalid value for 'period', must be conform to the pattern /([A-Za-zА-Яа-я]{2}|\\d{2})\\.\\d{2}\\.\\d{4}|0/.";
        }
     ...
     * Sets doc_date
     *
     * @param string $doc_date Дата налогового документа. Поле платежки 109. Формат — ДД.ММ.ГГГГ или 0. Подробнее :https://www.nalog.ru/rn40/news/tax_doc_news/4604512/
     *
     * @return self
     */
    public function setDocDate($doc_date)
    {
        ...
        if ((!preg_match("/\\d{2}\\.\\d{2}\\.\\d{4}|0/", $doc_date))) {
            throw new \InvalidArgumentException("invalid value for $doc_date when calling TaxPaymentParameters., must conform to the pattern /\\d{2}\\.\\d{2}\\.\\d{4}|0/.");
        }
    ...
    public function setDocNumber($doc_number)
    {
        ...
        if ((!preg_match("/[A-Za-zА-Яа-я]{2}|0/", $doc_number))) {
            throw new \InvalidArgumentException("invalid value for $doc_number when calling TaxPaymentParameters., must conform to the pattern /[A-Za-zА-Яа-я]{2}|0/.");
        }
    ...
    public function setEvidence($evidence)
    {
        ...
        if ((!preg_match("/[A-Za-zА-Яа-я]{2}|0/", $evidence))) {
            throw new \InvalidArgumentException("invalid value for $evidence when calling TaxPaymentParameters., must conform to the pattern /[A-Za-zА-Яа-я]{2}|0/.");
        }
     ...
     * Sets kbk
     *
     * @param string $kbk Код бюджетной классификации. Поле платежки 104. Подробнее: https://buhguru.com/spravka-info/kbk-2021.html
     *
     * @return self
     */
    public function setKbk($kbk)
    {
        ...
        if ((!preg_match("/\\d{20}/", $kbk))) {
            throw new \InvalidArgumentException("invalid value for $kbk when calling TaxPaymentParameters., must conform to the pattern /\\d{20}/.");
        }
     ...
     * Sets oktmo
     *
     * @param string $oktmo Код ОКТМО территории, на которой мобилизуются денежные средства от уплаты налога, сбора и иного платежа. Поле платежки 105.  Подробнее: https://nalog-nalog.ru/uplata_nalogov/rekvizity_dlya_uplaty_nalogov_vznosov/oktmo_v_platezhnom_poruchenii_nyuansy/
     *
     * @return self
     */
    public function setOktmo($oktmo)
    {
        ...
        if ((!preg_match("/\\d{8}|\\d{11}/", $oktmo))) {
            throw new \InvalidArgumentException("invalid value for $oktmo when calling TaxPaymentParameters., must conform to the pattern /\\d{8}|\\d{11}/.");
        }
    ...
    public function setPayerStatus($payer_status)
    {
        ...
        if ((!preg_match("/\\d{2}/", $payer_status))) {
            throw new \InvalidArgumentException("invalid value for $payer_status when calling TaxPaymentParameters., must conform to the pattern /\\d{2}/.");
        }
     ...
     * Sets period
     *
     * @param string $period Налоговый период. Поле платежки 107.  Формат — ДД.ММ.ГГГГ, первые два символа могут быть буквами или цифрами; а также поле может быть передано 0.  Подробнее: https://www.nalog.ru/rn40/news/tax_doc_news/6181298/
     *
     * @return self
     */
    public function setPeriod($period)
    {
        ...
        if ((!preg_match("/([A-Za-zА-Яа-я]{2}|\\d{2})\\.\\d{2}\\.\\d{4}|0/", $period))) {
            throw new \InvalidArgumentException("invalid value for $period when calling TaxPaymentParameters., must conform to the pattern /([A-Za-zА-Яа-я]{2}|\\d{2})\\.\\d{2}\\.\\d{4}|0/.");
        }
     ...
     * Gets third_party
     *
     * @return \OpenAPI\Client\tinkoff\api\\TaxThirdParty|null
     */
     ...
     * Sets third_party
     *
     * @param \OpenAPI\Client\tinkoff\api\\TaxThirdParty|null $third_party third_party
     *
     * @return self
     */
