...
/**
 * BusinessErrorResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BusinessErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessErrorResponse';
    ...
    protected static $openAPITypes = [
        'error_code' => 'string',
        'error_details' => 'array<string,string>',
        'error_id' => 'string',
     ...
     * Sets error_details
     *
     * @param array<string,string>|null $error_details error_details
     *
     * @return self
     */
     ...
     * Sets error_id
     *
     * @param string $error_id Уникальный идентификатор ошибки
     *
     * @return self
     */
