...
/**
 * AccountInfo1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountInfo1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountInfo1';
    ...
    const ACCOUNT_TYPE_TENDER = 'Tender';
    const ACCOUNT_TYPE_OVERNIGHT = 'Overnight';
    ...
    public function getAccountTypeAllowableValues()
    {
        return [
            ...
            self::ACCOUNT_TYPE_TENDER,
            self::ACCOUNT_TYPE_OVERNIGHT,
        ];
    }
     ...
     * Sets account_type
     *
     * @param string $account_type Тип счета. Может принимать одно из четырех значений: <ul> <li>Current - расчетный счет</li> <li>Tax - счет Тинькофф Бухгалтерии</li> <li>Tender - специальный счет для участия в госзакупках</li> <li>Overnight - счет Overnight </li> </ul>
     *
     * @return self
     */
    ...
    public function setBankBik($bank_bik)
    {
        ...
        if ((!preg_match("/\\d{9}/", $bank_bik))) {
            throw new \InvalidArgumentException("invalid value for $bank_bik when calling AccountInfo1., must conform to the pattern /\\d{9}/.");
        }
