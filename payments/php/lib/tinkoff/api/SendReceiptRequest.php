...
/**
 * SendReceiptRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SendReceiptRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendReceiptRequest';
    ...
    protected static $attributeMap = [
        ...
        'qr_code_as_string' => 'qrCodeAsString'
    ];
    ...
    protected static $setters = [
        ...
        'qr_code_as_string' => 'setQrCodeAsString'
    ];
    ...
    protected static $getters = [
        ...
        'qr_code_as_string' => 'getQrCodeAsString'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['qr_code_as_string'] = $data['qr_code_as_string'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['qr_code_as_string'] === null) {
            $invalidProperties[] = "'qr_code_as_string' can't be null";
        }
     ...
     * Sets offer_id
     *
     * @param int|null $offer_id id оффера, в рамках которого клиент предполагает получить кэшбэк
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string $phone_number Номер телефона клиента в формате E.164
     *
     * @return self
     */
    ...
    /**
     * Gets qr_code_as_string
     *
     * @return string
     */
    public function getQrCodeAsString()
    {
        return $this->container['qr_code_as_string'];
    }

    /**
     * Sets qr_code_as_string
     *
     * @param string $qr_code_as_string Содержимое qr кода чека
     *
     * @return self
     */
    public function setQrCodeAsString($qr_code_as_string)
    {
        $this->container['qr_code_as_string'] = $qr_code_as_string;
