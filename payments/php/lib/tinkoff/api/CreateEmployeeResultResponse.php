...
/**
 * CreateEmployeeResultResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateEmployeeResultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateEmployeeResultResponse';
    ...
    protected static $openAPITypes = [
        'employee_results' => '\OpenAPI\Client\tinkoff\api\\EmployeesResponse[]'
    ];
    ...
    {
        $this->container['employee_results'] = $data['employee_results'] ?? null;
    }
     ...
     *
     * @return \OpenAPI\Client\tinkoff\api\\EmployeesResponse[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\tinkoff\api\\EmployeesResponse[]|null $employee_results Список результатов создания сотрудников
     *
     * @return self
     */
