...
/**
 * BankStatementOperation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BankStatementOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankStatementOperation';
    ...
    protected static $setters = [
        ...
        'creator_status' => 'setCreatorStatus',
        'date' => 'setDate',
        'draw_date' => 'setDrawDate',
        ...
        'payer_account' => 'setPayerAccount',
        'payer_bank' => 'setPayerBank',
        'payer_bic' => 'setPayerBic',
        'payer_corr_account' => 'setPayerCorrAccount',
        'payer_inn' => 'setPayerInn',
        'payer_kpp' => 'setPayerKpp',
        'payer_name' => 'setPayerName',
        'payment_purpose' => 'setPaymentPurpose',
        'payment_type' => 'setPaymentType',
        'recipient' => 'setRecipient',
        'recipient_account' => 'setRecipientAccount',
        'recipient_bank' => 'setRecipientBank',
        'recipient_bic' => 'setRecipientBic',
        'recipient_corr_account' => 'setRecipientCorrAccount',
        'recipient_inn' => 'setRecipientInn',
        'recipient_kpp' => 'setRecipientKpp',
    ...
    protected static $getters = [
        ...
        'creator_status' => 'getCreatorStatus',
        'date' => 'getDate',
        'draw_date' => 'getDrawDate',
        ...
        'payer_account' => 'getPayerAccount',
        'payer_bank' => 'getPayerBank',
        'payer_bic' => 'getPayerBic',
        'payer_corr_account' => 'getPayerCorrAccount',
        'payer_inn' => 'getPayerInn',
        'payer_kpp' => 'getPayerKpp',
        'payer_name' => 'getPayerName',
        'payment_purpose' => 'getPaymentPurpose',
        'payment_type' => 'getPaymentType',
        'recipient' => 'getRecipient',
        'recipient_account' => 'getRecipientAccount',
        'recipient_bank' => 'getRecipientBank',
        'recipient_bic' => 'getRecipientBic',
        'recipient_corr_account' => 'getRecipientCorrAccount',
        'recipient_inn' => 'getRecipientInn',
        'recipient_kpp' => 'getRecipientKpp',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['charge_date'] = $data['charge_date'] ?? null;
        $this->container['creator_status'] = $data['creator_status'] ?? null;
        $this->container['date'] = $data['date'] ?? null;
        $this->container['draw_date'] = $data['draw_date'] ?? null;
        ...
        $this->container['payer_account'] = $data['payer_account'] ?? null;
        $this->container['payer_bank'] = $data['payer_bank'] ?? null;
        $this->container['payer_bic'] = $data['payer_bic'] ?? null;
        $this->container['payer_corr_account'] = $data['payer_corr_account'] ?? null;
        $this->container['payer_inn'] = $data['payer_inn'] ?? null;
        $this->container['payer_kpp'] = $data['payer_kpp'] ?? null;
        ...
        $this->container['recipient_bank'] = $data['recipient_bank'] ?? null;
        $this->container['recipient_bic'] = $data['recipient_bic'] ?? null;
        $this->container['recipient_corr_account'] = $data['recipient_corr_account'] ?? null;
        $this->container['recipient_inn'] = $data['recipient_inn'] ?? null;
        $this->container['recipient_kpp'] = $data['recipient_kpp'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['creator_status'] === null) {
            $invalidProperties[] = "'creator_status' can't be null";
        }
        if ($this->container['date'] === null) {
            $invalidProperties[] = "'date' can't be null";
        }
        if ($this->container['draw_date'] === null) {
            $invalidProperties[] = "'draw_date' can't be null";
        }
        ...
        if (!preg_match("/\\d{2}/", $this->container['operation_type'])) {
            $invalidProperties[] = "invalid value for 'operation_type', must be conform to the pattern /\\d{2}/.";
        }

        if ($this->container['payer_bank'] === null) {
            $invalidProperties[] = "'payer_bank' can't be null";
        }
        if ($this->container['payer_bic'] === null) {
            $invalidProperties[] = "'payer_bic' can't be null";
        }
        ...
        if ($this->container['recipient_bank'] === null) {
            $invalidProperties[] = "'recipient_bank' can't be null";
        }
        if ($this->container['recipient_bic'] === null) {
            $invalidProperties[] = "'recipient_bic' can't be null";
        }
     ...
     * Sets charge_date
     *
     * @param \DateTime $charge_date Дата поступления средств на р/с получателя
     *
     * @return self
     */
    ...
    {
        return $this->container['creator_status'];
    }

    /**
     * Sets creator_status
     *
     * @param string $creator_status Статус составителя расчетного документа
     *
     * @return self
     */
    public function setCreatorStatus($creator_status)
    {
        $this->container['creator_status'] = $creator_status;
    ...
    {
        return $this->container['draw_date'];
    }

    /**
     * Sets draw_date
     *
     * @param \DateTime $draw_date Дата списания средств с р/с плательщика
     *
     * @return self
     */
    public function setDrawDate($draw_date)
    {
        $this->container['draw_date'] = $draw_date;
     ...
     *
     * @param string|null $execution_order Очередность платежа
     *
     * @return self
     */
     ...
     * Sets kbk
     *
     * @param string|null $kbk Код бюджетной классификации
     *
     * @return self
     */
     ...
     * Sets oktmo
     *
     * @param string|null $oktmo Код ОКТМО территории, на которой мобилизуются денежные средства от уплаты налога, сбора и иного платежа
     *
     * @return self
     */
     ...
     * Sets operation_id
     *
     * @param string $operation_id Уникальный идентификатор операции
     *
     * @return self
     */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Условное обозначение (шифр) документа, проводимого по счету в кредитной организации. Подробнее: http://www.consultant.ru/document/cons_doc_LAW_213488/f0d58093feca12dbef02bd44fd633f1c94b49da1/
     *
     * @return self
     */
    public function setOperationType($operation_type)
    {
        ...
        if ((!preg_match("/\\d{2}/", $operation_type))) {
            throw new \InvalidArgumentException("invalid value for $operation_type when calling BankStatementOperation., must conform to the pattern /\\d{2}/.");
        }
    ...
    {
        return $this->container['payer_account'];
    }

    /**
     * Sets payer_account
     *
     * @param string|null $payer_account Номер счета плательщика
     *
     * @return self
     */
    public function setPayerAccount($payer_account)
    {
        $this->container['payer_account'] = $payer_account;
    ...
    {
        return $this->container['payer_bank'];
    }

    /**
     * Sets payer_bank
     *
     * @param string $payer_bank Банк плательщика
     *
     * @return self
     */
    public function setPayerBank($payer_bank)
    {
        $this->container['payer_bank'] = $payer_bank;
    ...
    {
        return $this->container['payer_bic'];
    }

    /**
     * Sets payer_bic
     *
     * @param string $payer_bic БИК плательщика
     *
     * @return self
     */
    public function setPayerBic($payer_bic)
    {
        $this->container['payer_bic'] = $payer_bic;

        return $this;
    }

    /**
     * Gets payer_corr_account
     *
     * @return string|null
     */
    public function getPayerCorrAccount()
    {
        return $this->container['payer_corr_account'];
    }

    /**
     * Sets payer_corr_account
     *
     * @param string|null $payer_corr_account Кор.счет плательщика
     *
     * @return self
     */
    public function setPayerCorrAccount($payer_corr_account)
    {
        $this->container['payer_corr_account'] = $payer_corr_account;
    ...
    {
        return $this->container['payer_inn'];
    }

    /**
     * Sets payer_inn
     *
     * @param string|null $payer_inn ИНН плательщика
     *
     * @return self
     */
    public function setPayerInn($payer_inn)
    {
        $this->container['payer_inn'] = $payer_inn;
    ...
    {
        return $this->container['payer_kpp'];
    }

    /**
     * Sets payer_kpp
     *
     * @param string|null $payer_kpp КПП плательщика
     *
     * @return self
     */
    public function setPayerKpp($payer_kpp)
    {
        $this->container['payer_kpp'] = $payer_kpp;
     ...
     * Sets payer_name
     *
     * @param string $payer_name Имя плательщика
     *
     * @return self
     */
     ...
     * Sets payment_type
     *
     * @param string|null $payment_type Вид платежа
     *
     * @return self
     */
     ...
     * Sets recipient
     *
     * @param string $recipient Получатель платежа
     *
     * @return self
     */
     ...
     *
     * @param string $recipient_account Номер счета получателя платежа
     *
     * @return self
     */
     ...
     * @return string
     */
    public function getRecipientBank()
    {
        return $this->container['recipient_bank'];
    }

    /**
     * Sets recipient_bank
     *
     * @param string $recipient_bank Банк получателя платежа
     *
     * @return self
     */
    public function setRecipientBank($recipient_bank)
    {
        $this->container['recipient_bank'] = $recipient_bank;
     ...
     * Sets recipient_bic
     *
     * @param string $recipient_bic БИК получателя платежа
     *
     * @return self
     */
    ...
    /**
     * Gets recipient_corr_account
     *
     * @return string|null
     */
    public function getRecipientCorrAccount()
    {
        return $this->container['recipient_corr_account'];
    }

    /**
     * Sets recipient_corr_account
     *
     * @param string|null $recipient_corr_account Кор.счет получателя платежа
     *
     * @return self
     */
    public function setRecipientCorrAccount($recipient_corr_account)
    {
        $this->container['recipient_corr_account'] = $recipient_corr_account;
    ...
    {
        return $this->container['recipient_inn'];
    }

    /**
     * Sets recipient_inn
     *
     * @param string|null $recipient_inn ИНН получателя платежа
     *
     * @return self
     */
    public function setRecipientInn($recipient_inn)
    {
        $this->container['recipient_inn'] = $recipient_inn;
    ...
    {
        return $this->container['recipient_kpp'];
    }

    /**
     * Sets recipient_kpp
     *
     * @param string|null $recipient_kpp КПП получателя
     *
     * @return self
     */
    public function setRecipientKpp($recipient_kpp)
    {
        $this->container['recipient_kpp'] = $recipient_kpp;
     ...
     * Sets tax_doc_date
     *
     * @param string|null $tax_doc_date Дата налогового документа
     *
     * @return self
     */
     ...
     * Sets tax_doc_number
     *
     * @param string|null $tax_doc_number Номер налогового документа
     *
     * @return self
     */
     ...
     * Sets tax_evidence
     *
     * @param string|null $tax_evidence Основание налогового платежа
     *
     * @return self
     */
     ...
     * Sets tax_period
     *
     * @param string|null $tax_period Налоговый период / код таможенного органа
     *
     * @return self
     */
     ...
     * Sets tax_type
     *
     * @param string|null $tax_type Тип налогового платежа
     *
     * @return self
     */
     ...
     * Sets uin
     *
     * @param string|null $uin Уникальный идентификатор платежа. Подробнее: http://www.consultant.ru/law/podborki/unikalnyj_identifikator_platezha/
     *
     * @return self
     */
