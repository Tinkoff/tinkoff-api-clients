...
/**
 * SelfEmployedCreatePaymentRegistryResultResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedCreatePaymentRegistryResultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedCreatePaymentRegistryResultResponse';
    ...
    protected static $openAPITypes = [
        'error' => '\OpenAPI\Client\tinkoff\api\\FieldValidationError',
        'payment_errors' => '\OpenAPI\Client\tinkoff\api\\PaymentError1[]',
     ...
     * Gets error
     *
     * @return \OpenAPI\Client\tinkoff\api\\FieldValidationError|null
     */
     ...
     * Sets error
     *
     * @param \OpenAPI\Client\tinkoff\api\\FieldValidationError|null $error error
     *
     * @return self
     */
     ...
     * Gets payment_errors
     *
     * @return \OpenAPI\Client\tinkoff\api\\PaymentError1[]|null
     */
     ...
     * Sets payment_errors
     *
     * @param \OpenAPI\Client\tinkoff\api\\PaymentError1[]|null $payment_errors Платежи внутри реестра, содержащие ошибки
     *
     * @return self
     */
     ...
     *
     * @param int|null $payment_registry_id Идентификатор платежного реестра
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус создания платежного реестра
     *
     * @return self
     */
