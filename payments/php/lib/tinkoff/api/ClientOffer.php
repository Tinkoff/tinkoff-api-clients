 ...
 */
class ClientOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientOffer';
    ...
    protected static $openAPITypes = [
        'cb_amount' => 'int',
        'cb_percent' => 'int',
        'count_of_realised' => 'int',
        'id' => 'int',
        'merchant_categories' => '\OpenAPI\Client\tinkoff\api\\ClientMerchantCategory[]',
        'view_date' => '\DateTime',
        'web' => 'string',
        'weight' => 'int'
    ];
    ...
    protected static $attributeMap = [
        'cb_amount' => 'cbAmount',
        'cb_percent' => 'cbPercent',
        'count_of_realised' => 'countOfRealised',
        'id' => 'id',
    ...
    protected static $setters = [
        'cb_amount' => 'setCbAmount',
        'cb_percent' => 'setCbPercent',
        'count_of_realised' => 'setCountOfRealised',
        'id' => 'setId',
    ...
    protected static $getters = [
        'cb_amount' => 'getCbAmount',
        'cb_percent' => 'getCbPercent',
        'count_of_realised' => 'getCountOfRealised',
        'id' => 'getId',
    ...
    {
        $this->container['cb_amount'] = $data['cb_amount'] ?? null;
        $this->container['cb_percent'] = $data['cb_percent'] ?? null;
        $this->container['count_of_realised'] = $data['count_of_realised'] ?? null;
        $this->container['id'] = $data['id'] ?? null;
        $this->container['merchant_categories'] = $data['merchant_categories'] ?? null;
        $this->container['view_date'] = $data['view_date'] ?? null;
    ...
    {
        return $this->container['cb_amount'];
    }

    /**
     * Sets cb_amount
     *
     * @param int|null $cb_amount Фиксированный размер бонуса
     *
     * @return self
     */
    public function setCbAmount($cb_amount)
    {
        $this->container['cb_amount'] = $cb_amount;
     ...
     * @return int|null
     */
    public function getCbPercent()
    {
        return $this->container['cb_percent'];
    }

    /**
     * Sets cb_percent
     *
     * @param int|null $cb_percent Процент начисления бонуса
     *
     * @return self
     */
    public function setCbPercent($cb_percent)
    {
        $this->container['cb_percent'] = $cb_percent;

        return $this;
    }

    /**
     * Gets count_of_realised
     *
     * @return int|null
     */
    public function getCountOfRealised()
    {
        return $this->container['count_of_realised'];
    }

    /**
     * Sets count_of_realised
     *
     * @param int|null $count_of_realised Количество совершённых покупок по спецпредложению
     *
     * @return self
     */
    public function setCountOfRealised($count_of_realised)
    {
        $this->container['count_of_realised'] = $count_of_realised;
     ...
     *
     * @return \OpenAPI\Client\tinkoff\api\\ClientMerchantCategory[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\tinkoff\api\\ClientMerchantCategory[]|null $merchant_categories Список категорий партнера у клиента
     *
     * @return self
     */
     ...
     * Sets view_date
     *
     * @param \DateTime|null $view_date Дата просмотра оффера
     *
     * @return self
     */
     ...
     * Sets web
     *
     * @param string|null $web Персонализированная ссылка для клиента
     *
     * @return self
     */
     ...
     * Sets weight
     *
     * @param int|null $weight Вес партнера для клиента. Относительная величина для персонального ранжирования списка офферов
     *
     * @return self
     */
