...
/**
 * DuplicatedError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DuplicatedError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DuplicatedError';
     ...
     * Sets message
     *
     * @param string $message Данный чек уже обработан
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type DUPLICATED_RECEIPT
     *
     * @return self
     */
