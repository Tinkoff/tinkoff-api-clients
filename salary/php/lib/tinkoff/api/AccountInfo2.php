...
/**
 * AccountInfo2 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountInfo2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountInfo2';
    ...
    protected static $openAPITypes = [
        ...
        'balance' => '\OpenAPI\Client\tinkoff\api\\Balance',
        'bank_bik' => 'string',
        'currency' => 'string',
        'name' => 'string',
        'transit_account' => '\OpenAPI\Client\tinkoff\api\\TransitAccount'
    ];
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'transit_account' => 'setTransitAccount'
    ];
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'transit_account' => 'getTransitAccount'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transit_account'] = $data['transit_account'] ?? null;
    }
     ...
     * Sets account_number
     *
     * @param string $account_number Расчетный счет организации
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $activation_date Дата активации
     *
     * @return self
     */
     ...
     * Gets balance
     *
     * @return \OpenAPI\Client\tinkoff\api\\Balance
     */
     ...
     * Sets balance
     *
     * @param \OpenAPI\Client\tinkoff\api\\Balance $balance balance
     *
     * @return self
     */
    ...
    public function setBankBik($bank_bik)
    {
        ...
        if ((!preg_match("/\\d{9}/", $bank_bik))) {
            throw new \InvalidArgumentException("invalid value for $bank_bik when calling AccountInfo2., must conform to the pattern /\\d{9}/.");
        }
     ...
     * Sets currency
     *
     * @param string $currency Код валюты счета по ОКВ (цифрами)
     *
     * @return self
     */
    ...
    /**
     * Gets transit_account
     *
     * @return \OpenAPI\Client\tinkoff\api\\TransitAccount|null
     */
    public function getTransitAccount()
    {
        return $this->container['transit_account'];
    }

    /**
     * Sets transit_account
     *
     * @param \OpenAPI\Client\tinkoff\api\\TransitAccount|null $transit_account transit_account
     *
     * @return self
     */
    public function setTransitAccount($transit_account)
    {
        $this->container['transit_account'] = $transit_account;
