...
/**
 * FieldValidationError1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FieldValidationError1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FieldValidationError1';
     ...
     * Sets field_name
     *
     * @param string $field_name Наименование поля, в котором возникла ошибка, на русском языке
     *
     * @return self
     */
