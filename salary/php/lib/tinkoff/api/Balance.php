...
class Balance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'otb' => 'setOtb',
        'pending_payments' => 'setPendingPayments',
        'pending_requisitions' => 'setPendingRequisitions'
    ];
    ...
    protected static $getters = [
        ...
        'pending_requisitions' => 'getPendingRequisitions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['otb'] = $data['otb'] ?? null;
        $this->container['pending_payments'] = $data['pending_payments'] ?? null;
        $this->container['pending_requisitions'] = $data['pending_requisitions'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['otb'] === null) {
            $invalidProperties[] = "'otb' can't be null";
        }
        if ($this->container['pending_payments'] === null) {
            $invalidProperties[] = "'pending_payments' can't be null";
        }
        if ($this->container['pending_requisitions'] === null) {
            $invalidProperties[] = "'pending_requisitions' can't be null";
        }
     ...
     * Sets authorized
     *
     * @param float $authorized Сумма авторизаций (захолдированные на счете средства)
     *
     * @return self
     */
    ...
    {
        return $this->container['otb'];
    }

    /**
     * Sets otb
     *
     * @param float $otb Доступный остаток
     *
     * @return self
     */
    public function setOtb($otb)
    {
        $this->container['otb'] = $otb;

        return $this;
    }

    /**
     * Gets pending_payments
     *
     * @return float
     */
    public function getPendingPayments()
    {
        return $this->container['pending_payments'];
    }

    /**
     * Sets pending_payments
     *
     * @param float $pending_payments Сумма платежей в картотеке клиента (собственные платежи)
     *
     * @return self
     */
    public function setPendingPayments($pending_payments)
    {
        $this->container['pending_payments'] = $pending_payments;

        return $this;
    }

    /**
     * Gets pending_requisitions
     *
     * @return float
     */
    public function getPendingRequisitions()
    {
        return $this->container['pending_requisitions'];
    }

    /**
     * Sets pending_requisitions
     *
     * @param float $pending_requisitions Сумма платежей в картотеке банка (требования к клиенту)
     *
     * @return self
     */
    public function setPendingRequisitions($pending_requisitions)
    {
        $this->container['pending_requisitions'] = $pending_requisitions;
