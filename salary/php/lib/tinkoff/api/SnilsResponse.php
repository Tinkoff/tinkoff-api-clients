...
/**
 * SnilsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SnilsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SnilsResponse';
    ...
    {
        $this->container['snils'] = $data['snils'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['snils']) && !preg_match("/^(\\d{11})$/", $this->container['snils'])) {
            $invalidProperties[] = "invalid value for 'snils', must be conform to the pattern /^(\\d{11})$/.";
        }
    ...
    public function setSnils($snils)
    {
        ...
        if (!is_null($snils) && (!preg_match("/^(\\d{11})$/", $snils))) {
            throw new \InvalidArgumentException("invalid value for $snils when calling SnilsResponse., must conform to the pattern /^(\\d{11})$/.");
        }

        $this->container['snils'] = $snils;
