...
/**
 * CreatePaymentDraftResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentDraftResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentDraftResponse';
     ...
     * Sets document_id
     *
     * @param string $document_id Идентификатор созданного черновика
     *
     * @return self
     */
