 ...
 */
class ActiveOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActiveOffer';
    ...
    protected static $openAPITypes = [
        'advert' => '\OpenAPI\Client\tinkoff\api\\ActiveOfferAdvert',
        'bound_money_max' => 'int',
        'bound_money_min' => 'int',
        'brand_id' => 'int',
        'cashback_amount' => 'int',
        ...
        'image280' => 'string',
        'image626' => 'string',
        'merchant_categories' => '\OpenAPI\Client\tinkoff\api\\MerchantCategory[]',
        'merchant_id' => 'int',
        'merchant_name' => 'string',
        'merchant_subcategory' => 'string',
        'number_of_contacts' => 'int',
        'number_of_realised' => 'int',
        'offer_type' => 'string',
        'online_sale' => 'bool',
        'open_date' => '\DateTime',
        'phone' => 'string',
        'quantity_grace_statement' => 'int',
        'single' => 'bool',
        'top_border' => 'int',
        'tranche_duration' => 'int',
        'tranche_statement_count' => 'int',
        'web' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'advert' => null,
        'bound_money_max' => 'int64',
        'bound_money_min' => 'int64',
        'brand_id' => 'int64',
        'cashback_amount' => 'int64',
        'cashback_percent' => 'int64',
        'client_rate' => 'int64',
        ...
        'merchant_id' => 'int64',
        'merchant_name' => null,
        'merchant_subcategory' => null,
        'number_of_contacts' => null,
        'number_of_realised' => 'int64',
        'offer_type' => null,
        'online_sale' => null,
        'open_date' => 'date-time',
        'phone' => null,
        'quantity_grace_statement' => 'int64',
        'single' => null,
        'top_border' => 'int64',
        'tranche_duration' => 'int64',
        'tranche_statement_count' => 'int64',
        'web' => null
    ];
    ...
    protected static $attributeMap = [
        'advert' => 'advert',
        'bound_money_max' => 'boundMoneyMax',
        'bound_money_min' => 'boundMoneyMin',
        'brand_id' => 'brandId',
        ...
        'merchant_subcategory' => 'merchantSubcategory',
        'number_of_contacts' => 'numberOfContacts',
        'number_of_realised' => 'numberOfRealised',
        'offer_type' => 'offerType',
        'online_sale' => 'onlineSale',
        'open_date' => 'openDate',
        'phone' => 'phone',
        'quantity_grace_statement' => 'quantityGraceStatement',
        'single' => 'single',
        'top_border' => 'topBorder',
        'tranche_duration' => 'trancheDuration',
        'tranche_statement_count' => 'trancheStatementCount',
        'web' => 'web'
    ];
    ...
    protected static $setters = [
        'advert' => 'setAdvert',
        'bound_money_max' => 'setBoundMoneyMax',
        'bound_money_min' => 'setBoundMoneyMin',
        'brand_id' => 'setBrandId',
        'cashback_amount' => 'setCashbackAmount',
        'cashback_percent' => 'setCashbackPercent',
        'client_rate' => 'setClientRate',
        'close_date' => 'setCloseDate',
        'id' => 'setId',
        'image1252' => 'setImage1252',
        'image280' => 'setImage280',
        'image626' => 'setImage626',
        'merchant_categories' => 'setMerchantCategories',
        'merchant_id' => 'setMerchantId',
        'merchant_name' => 'setMerchantName',
        'merchant_subcategory' => 'setMerchantSubcategory',
        'number_of_contacts' => 'setNumberOfContacts',
        'number_of_realised' => 'setNumberOfRealised',
        'offer_type' => 'setOfferType',
        'online_sale' => 'setOnlineSale',
        'open_date' => 'setOpenDate',
        'phone' => 'setPhone',
        'quantity_grace_statement' => 'setQuantityGraceStatement',
        'single' => 'setSingle',
        'top_border' => 'setTopBorder',
        'tranche_duration' => 'setTrancheDuration',
        'tranche_statement_count' => 'setTrancheStatementCount',
        'web' => 'setWeb'
    ];
    ...
    protected static $getters = [
        'advert' => 'getAdvert',
        'bound_money_max' => 'getBoundMoneyMax',
        'bound_money_min' => 'getBoundMoneyMin',
        'brand_id' => 'getBrandId',
        'cashback_amount' => 'getCashbackAmount',
        'cashback_percent' => 'getCashbackPercent',
        'client_rate' => 'getClientRate',
        'close_date' => 'getCloseDate',
        'id' => 'getId',
        'image1252' => 'getImage1252',
        'image280' => 'getImage280',
        'image626' => 'getImage626',
        'merchant_categories' => 'getMerchantCategories',
        'merchant_id' => 'getMerchantId',
        'merchant_name' => 'getMerchantName',
        'merchant_subcategory' => 'getMerchantSubcategory',
        'number_of_contacts' => 'getNumberOfContacts',
        'number_of_realised' => 'getNumberOfRealised',
        'offer_type' => 'getOfferType',
        'online_sale' => 'getOnlineSale',
        'open_date' => 'getOpenDate',
        'phone' => 'getPhone',
        'quantity_grace_statement' => 'getQuantityGraceStatement',
        'single' => 'getSingle',
        'top_border' => 'getTopBorder',
        'tranche_duration' => 'getTrancheDuration',
        'tranche_statement_count' => 'getTrancheStatementCount',
        'web' => 'getWeb'
    ];
    ...
    {
        $this->container['advert'] = $data['advert'] ?? null;
        $this->container['bound_money_max'] = $data['bound_money_max'] ?? null;
        $this->container['bound_money_min'] = $data['bound_money_min'] ?? null;
        $this->container['brand_id'] = $data['brand_id'] ?? null;
        $this->container['cashback_amount'] = $data['cashback_amount'] ?? null;
        $this->container['cashback_percent'] = $data['cashback_percent'] ?? null;
        $this->container['client_rate'] = $data['client_rate'] ?? null;
        $this->container['close_date'] = $data['close_date'] ?? null;
        $this->container['id'] = $data['id'] ?? null;
        $this->container['image1252'] = $data['image1252'] ?? null;
        $this->container['image280'] = $data['image280'] ?? null;
        $this->container['image626'] = $data['image626'] ?? null;
        $this->container['merchant_categories'] = $data['merchant_categories'] ?? null;
        $this->container['merchant_id'] = $data['merchant_id'] ?? null;
        $this->container['merchant_name'] = $data['merchant_name'] ?? null;
        $this->container['merchant_subcategory'] = $data['merchant_subcategory'] ?? null;
        $this->container['number_of_contacts'] = $data['number_of_contacts'] ?? null;
        $this->container['number_of_realised'] = $data['number_of_realised'] ?? null;
        $this->container['offer_type'] = $data['offer_type'] ?? null;
        $this->container['online_sale'] = $data['online_sale'] ?? null;
        $this->container['open_date'] = $data['open_date'] ?? null;
        $this->container['phone'] = $data['phone'] ?? null;
        $this->container['quantity_grace_statement'] = $data['quantity_grace_statement'] ?? null;
        $this->container['single'] = $data['single'] ?? null;
        $this->container['top_border'] = $data['top_border'] ?? null;
        $this->container['tranche_duration'] = $data['tranche_duration'] ?? null;
        $this->container['tranche_statement_count'] = $data['tranche_statement_count'] ?? null;
     ...
     * Gets advert
     *
     * @return \OpenAPI\Client\tinkoff\api\\ActiveOfferAdvert|null
     */
    public function getAdvert()
    {
        return $this->container['advert'];
    }

    /**
     * Sets advert
     *
     * @param \OpenAPI\Client\tinkoff\api\\ActiveOfferAdvert|null $advert advert
     *
     * @return self
     */
    public function setAdvert($advert)
    {
        $this->container['advert'] = $advert;

        return $this;
    }

    /**
     * Gets bound_money_max
     *
     * @return int|null
     */
    public function getBoundMoneyMax()
    {
        return $this->container['bound_money_max'];
    }

    /**
     * Sets bound_money_max
     *
     * @param int|null $bound_money_max Ограничение по сумме покупке сверху
     *
     * @return self
     */
    public function setBoundMoneyMax($bound_money_max)
    {
        $this->container['bound_money_max'] = $bound_money_max;

        return $this;
    }

    /**
     * Gets bound_money_min
     *
     * @return int|null
     */
    public function getBoundMoneyMin()
    {
        return $this->container['bound_money_min'];
    }

    /**
     * Sets bound_money_min
     *
     * @param int|null $bound_money_min Ограничение по сумме покупке снизу
     *
     * @return self
     */
    public function setBoundMoneyMin($bound_money_min)
    {
        $this->container['bound_money_min'] = $bound_money_min;
     ...
     * Sets brand_id
     *
     * @param int|null $brand_id Уникальный id бренда
     *
     * @return self
     */
     ...
     *
     * @param int|null $cashback_amount Фиксированный размер бонуса
     *
     * @return self
     */
     ...
     *
     * @param int|null $cashback_percent Процент начисления бонуса
     *
     * @return self
     */
    ...
    {
        return $this->container['client_rate'];
    }

    /**
     * Sets client_rate
     *
     * @param int|null $client_rate Процентная ставка годовых на рассрочку
     *
     * @return self
     */
    public function setClientRate($client_rate)
    {
        $this->container['client_rate'] = $client_rate;
     ...
     * Sets close_date
     *
     * @param \DateTime|null $close_date Дата завершения действия оффера для клиентов
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int $id Уникальный id оффера
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getImage1252()
    {
        return $this->container['image1252'];
    }

    /**
     * Sets image1252
     *
     * @param string|null $image1252 Ссылка на картинку оффера размера 1252
     *
     * @return self
     */
    public function setImage1252($image1252)
    {
        $this->container['image1252'] = $image1252;
     ...
     * @return string|null
     */
    public function getImage280()
    {
        return $this->container['image280'];
    }

    /**
     * Sets image280
     *
     * @param string|null $image280 Ссылка на лейбл, лого
     *
     * @return self
     */
    public function setImage280($image280)
    {
        $this->container['image280'] = $image280;
     ...
     * @return string|null
     */
    public function getImage626()
    {
        return $this->container['image626'];
    }

    /**
     * Sets image626
     *
     * @param string|null $image626 Ссылка на картинку оффера размера 626
     *
     * @return self
     */
    public function setImage626($image626)
    {
        $this->container['image626'] = $image626;

        return $this;
    }

    /**
     * Gets merchant_categories
     *
     * @return \OpenAPI\Client\tinkoff\api\\MerchantCategory[]|null
     */
    public function getMerchantCategories()
    {
        return $this->container['merchant_categories'];
    }

    /**
     * Sets merchant_categories
     *
     * @param \OpenAPI\Client\tinkoff\api\\MerchantCategory[]|null $merchant_categories Категории партнера
     *
     * @return self
     */
    public function setMerchantCategories($merchant_categories)
    {
        $this->container['merchant_categories'] = $merchant_categories;
     ...
     * Sets merchant_id
     *
     * @param int|null $merchant_id Уникальный id партнера
     *
     * @return self
     */
     ...
     * Sets merchant_name
     *
     * @param string $merchant_name Наименование партнера
     *
     * @return self
     */
    ...
    /**
     * Gets merchant_subcategory
     *
     * @return string|null
     */
    public function getMerchantSubcategory()
    {
        return $this->container['merchant_subcategory'];
    }

    /**
     * Sets merchant_subcategory
     *
     * @param string|null $merchant_subcategory Подкатегория партнера
     *
     * @return self
     */
    public function setMerchantSubcategory($merchant_subcategory)
    {
        $this->container['merchant_subcategory'] = $merchant_subcategory;

        return $this;
    }

    /**
     * Gets number_of_contacts
     *
     * @return int|null
     */
    public function getNumberOfContacts()
    {
        return $this->container['number_of_contacts'];
    }

    /**
     * Sets number_of_contacts
     *
     * @param int|null $number_of_contacts Количество точек продаж
     *
     * @return self
     */
    public function setNumberOfContacts($number_of_contacts)
    {
        $this->container['number_of_contacts'] = $number_of_contacts;

        return $this;
    }

    /**
     * Gets number_of_realised
     *
     * @return int|null
     */
    public function getNumberOfRealised()
    {
        return $this->container['number_of_realised'];
    }

    /**
     * Sets number_of_realised
     *
     * @param int|null $number_of_realised Количество покупок, на которое распространяется спецпредложение
     *
     * @return self
     */
    public function setNumberOfRealised($number_of_realised)
    {
        $this->container['number_of_realised'] = $number_of_realised;
     ...
     * Sets offer_type
     *
     * @param string $offer_type Тип оффера. Доступные значения 'STANDARD', 'SPECIAL_CREDIT'
     *
     * @return self
     */
    ...
    {
        return $this->container['online_sale'];
    }

    /**
     * Sets online_sale
     *
     * @param bool|null $online_sale Флаг онлайн признака - оффер действует на покупки онлайн
     *
     * @return self
     */
    public function setOnlineSale($online_sale)
    {
        $this->container['online_sale'] = $online_sale;
     ...
     * Sets open_date
     *
     * @param \DateTime|null $open_date Дата начала действия оффера для клиентов
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone Телефон партнера
     *
     * @return self
     */
    ...
    /**
     * Gets quantity_grace_statement
     *
     * @return int|null
     */
    public function getQuantityGraceStatement()
    {
        return $this->container['quantity_grace_statement'];
    }

    /**
     * Sets quantity_grace_statement
     *
     * @param int|null $quantity_grace_statement Количество беспроцентных расчетных периодов
     *
     * @return self
     */
    public function setQuantityGraceStatement($quantity_grace_statement)
    {
        $this->container['quantity_grace_statement'] = $quantity_grace_statement;
     ...
     * Sets single
     *
     * @param bool $single Флаг оффера на одну покупку
     *
     * @return self
     */
    ...
    {
        return $this->container['top_border'];
    }

    /**
     * Sets top_border
     *
     * @param int|null $top_border Верхняя планка кэшбэка
     *
     * @return self
     */
    public function setTopBorder($top_border)
    {
        $this->container['top_border'] = $top_border;

        return $this;
    }

    /**
     * Gets tranche_duration
     *
     * @return int|null
     */
    public function getTrancheDuration()
    {
        return $this->container['tranche_duration'];
    }

    /**
     * Sets tranche_duration
     *
     * @param int|null $tranche_duration Срок начисления ставки по рассрочке. В днях
     *
     * @return self
     */
    public function setTrancheDuration($tranche_duration)
    {
        $this->container['tranche_duration'] = $tranche_duration;

        return $this;
    }

    /**
     * Gets tranche_statement_count
     *
     * @return int|null
     */
    public function getTrancheStatementCount()
    {
        return $this->container['tranche_statement_count'];
    }

    /**
     * Sets tranche_statement_count
     *
     * @param int|null $tranche_statement_count Длина рассрочки в расчетных периодах
     *
     * @return self
     */
    public function setTrancheStatementCount($tranche_statement_count)
    {
        $this->container['tranche_statement_count'] = $tranche_statement_count;
     ...
     * Sets web
     *
     * @param string|null $web Сайт партнера
     *
     * @return self
     */
