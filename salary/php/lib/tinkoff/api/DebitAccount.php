...
/**
 * DebitAccount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DebitAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DebitAccount';
    ...
    protected static $openAPITypes = [
        ...
        'bank' => '\OpenAPI\Client\tinkoff\api\\BankInfo',
        'name' => 'string'
    ];
     ...
     * Sets account_number
     *
     * @param string $account_number Счёт получателя платежа
     *
     * @return self
     */
     ...
     * Gets bank
     *
     * @return \OpenAPI\Client\tinkoff\api\\BankInfo
     */
     ...
     * Sets bank
     *
     * @param \OpenAPI\Client\tinkoff\api\\BankInfo $bank bank
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Получатель (ФИО)
     *
     * @return self
     */
