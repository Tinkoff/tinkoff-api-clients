...
class AddressResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'city' => 'setCity',
        'claddr_code' => 'setCladdrCode',
        'country' => 'setCountry',
        'district' => 'setDistrict',
        'fias_code' => 'setFiasCode',
        'house' => 'setHouse',
        'housing' => 'setHousing',
    ...
    protected static $getters = [
        ...
        'city' => 'getCity',
        'claddr_code' => 'getCladdrCode',
        'country' => 'getCountry',
        'district' => 'getDistrict',
        'fias_code' => 'getFiasCode',
        'house' => 'getHouse',
        'housing' => 'getHousing',
    ...
    const ADDRESS_TYPE_RESIDENCE_ADDRESS = 'RESIDENCE_ADDRESS';
    const ADDRESS_TYPE_REGISTRATION_ADDRESS = 'REGISTRATION_ADDRESS';
    const ADDRESS_TYPE_WORK_ADDRESS = 'WORK_ADDRESS';
    ...
    {
        return [
            self::ADDRESS_TYPE_RESIDENCE_ADDRESS,
            self::ADDRESS_TYPE_REGISTRATION_ADDRESS,
            self::ADDRESS_TYPE_WORK_ADDRESS,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['apartment'] = $data['apartment'] ?? null;
        $this->container['building'] = $data['building'] ?? null;
        $this->container['city'] = $data['city'] ?? null;
        $this->container['claddr_code'] = $data['claddr_code'] ?? null;
        $this->container['country'] = $data['country'] ?? null;
        $this->container['district'] = $data['district'] ?? null;
        $this->container['fias_code'] = $data['fias_code'] ?? null;
        $this->container['house'] = $data['house'] ?? null;
        ...
        $this->container['settlement'] = $data['settlement'] ?? null;
     ...
     * Sets address
     *
     * @param string|null $address Полный адрес
     *
     * @return self
     */
     ...
     * Sets address_type
     *
     * @param string $address_type Тип адреса. Может принимать одно из трех значений: <ul> <li>REGISTRATION_ADDRESS - адрес регистрации</li> <li>WORK_ADDRESS - рабочий адрес</li> <li>RESIDENCE_ADDRESS - домашний адрес</li> </ul>
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getCladdrCode()
    {
        return $this->container['claddr_code'];
    }

    /**
     * Sets claddr_code
     *
     * @param string|null $claddr_code Код адреса в КЛАДР
     *
     * @return self
     */
    public function setCladdrCode($claddr_code)
    {
        $this->container['claddr_code'] = $claddr_code;
    ...
    {
        return $this->container['fias_code'];
    }

    /**
     * Sets fias_code
     *
     * @param string|null $fias_code Код адреса в ФИАС
     *
     * @return self
     */
    public function setFiasCode($fias_code)
    {
        $this->container['fias_code'] = $fias_code;
     ...
     * Sets housing
     *
     * @param string|null $housing Корпус
     *
     * @return self
     */
     ...
     * Sets latitude
     *
     * @param double|null $latitude Широта
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param double|null $longitude Долгота
     *
     * @return self
     */
     ...
     * Sets zip_code
     *
     * @param string|null $zip_code Индекс
     *
     * @return self
     */
