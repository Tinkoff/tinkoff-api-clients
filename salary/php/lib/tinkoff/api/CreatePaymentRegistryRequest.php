...
/**
 * CreatePaymentRegistryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentRegistryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentRegistryRequest';
    ...
    protected static $openAPITypes = [
        ...
        'load_date' => 'string',
        'payments' => '\OpenAPI\Client\tinkoff\api\\CreatePaymentInfo[]',
        'registry_create_type' => '\OpenAPI\Client\tinkoff\api\\EmployeeRegistryCreateTypeRequest'
    ];
    ...
    {
        $this->container['company_account_number'] = $data['company_account_number'] ?? null;
     ...
     *
     * @param string|null $company_account_number Номер счёта компании, с которого будут списаны деньги, для оплаты реестра (при наличии РКО в Тинькофф).<br> Если номер счёта не передан - средства будут списаны с основного счёта компании.
     *
     * @return self
     */
     ...
     * Gets payments
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreatePaymentInfo[]|null
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreatePaymentInfo[]|null $payments Список платежей внутри реестра
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\tinkoff\api\\EmployeeRegistryCreateTypeRequest|null
     */
     ...
     *
     * @param \OpenAPI\Client\tinkoff\api\\EmployeeRegistryCreateTypeRequest|null $registry_create_type registry_create_type
     *
     * @return self
     */
