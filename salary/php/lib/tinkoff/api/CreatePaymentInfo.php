...
/**
 * CreatePaymentInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentInfo';
    ...
    protected static $openAPITypes = [
        ...
        'employee_info' => '\OpenAPI\Client\tinkoff\api\\EmployeeInfo',
        'number' => 'int',
     ...
     * Sets account_number
     *
     * @param string $account_number Номер счета сотрудника
     *
     * @return self
     */
     ...
     * Gets employee_info
     *
     * @return \OpenAPI\Client\tinkoff\api\\EmployeeInfo
     */
     ...
     * Sets employee_info
     *
     * @param \OpenAPI\Client\tinkoff\api\\EmployeeInfo $employee_info employee_info
     *
     * @return self
     */
     ...
     *
     * @param string $payment_purpose Назначение платежа данному сотруднику в рамках зарплатного реестра
     *
     * @return self
     */
     ...
     * Sets period_end
     *
     * @param \DateTime|null $period_end Конец периода платежа
     *
     * @return self
     */
     ...
     * Sets period_start
     *
     * @param \DateTime|null $period_start Начало периода платежа
     *
     * @return self
     */
