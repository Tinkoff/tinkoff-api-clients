 ...
 */
class Requisites implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Requisites';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(\\d{12}|\\d{10})$/", $this->container['inn'])) {
    ...
    {
        return $this->container['foreign_name'];
    }

    /**
     * Sets foreign_name
     *
     * @param string|null $foreign_name Зарубежное имя компании
     *
     * @return self
     */
    public function setForeignName($foreign_name)
    {
        $this->container['foreign_name'] = $foreign_name;
     ...
     * Sets full_name
     *
     * @param string $full_name Полное имя компании
     *
     * @return self
     */
    ...
    public function setInn($inn)
    {
        ...
        if ((!preg_match("/^(\\d{12}|\\d{10})$/", $inn))) {
            throw new \InvalidArgumentException("invalid value for $inn when calling Requisites., must conform to the pattern /^(\\d{12}|\\d{10})$/.");
        }
