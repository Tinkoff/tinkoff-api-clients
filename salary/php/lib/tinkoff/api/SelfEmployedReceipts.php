...
/**
 * SelfEmployedReceipts Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedReceipts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedReceipts';
    ...
    protected static $openAPITypes = [
        ...
        'receipts' => '\OpenAPI\Client\tinkoff\api\\SelfEmployedReceipt[]',
        'status' => 'string'
    ];
     ...
     * Gets receipts
     *
     * @return \OpenAPI\Client\tinkoff\api\\SelfEmployedReceipt[]|null
     */
     ...
     * Sets receipts
     *
     * @param \OpenAPI\Client\tinkoff\api\\SelfEmployedReceipt[]|null $receipts Результат регистрации дохода
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус запроса на получение чеков
     *
     * @return self
     */
