 ...
 */
class SpendLimit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpendLimit';
     ...
     * Sets limit_remain
     *
     * @param float $limit_remain Доступный остаток расходного лимита в валюте счёта, к которому привязана карта
     *
     * @return self
     */
     ...
     * Sets limit_value
     *
     * @param float $limit_value Лимит на покупки и снятия наличных в валюте счёта, к которому привязана карта
     *
     * @return self
     */
