...
class Interval implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets end_interval
     *
     * @param string $end_interval Время окончания интервала, локальное время в формате ISO 8601
     *
     * @return self
     */
     ...
     * Sets start_interval
     *
     * @param string $start_interval Время начала интервала, локальное время в формате ISO 8601
     *
     * @return self
     */
