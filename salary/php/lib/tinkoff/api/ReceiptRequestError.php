...
/**
 * ReceiptRequestError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReceiptRequestError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceiptRequestError';
     ...
     * Sets message
     *
     * @param string $message Ошибка обращения в ФНС
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type RECEIPT_REQUEST_ERROR
     *
     * @return self
     */
