...
/**
 * DriverLicensesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DriverLicensesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DriverLicensesResponse';
    ...
    protected static $openAPITypes = [
        'licenses' => '\OpenAPI\Client\tinkoff\api\\DriverLicenseResponse[]'
    ];
     ...
     * Gets licenses
     *
     * @return \OpenAPI\Client\tinkoff\api\\DriverLicenseResponse[]|null
     */
     ...
     * Sets licenses
     *
     * @param \OpenAPI\Client\tinkoff\api\\DriverLicenseResponse[]|null $licenses Водительские удостоверения физического лица
     *
     * @return self
     */
