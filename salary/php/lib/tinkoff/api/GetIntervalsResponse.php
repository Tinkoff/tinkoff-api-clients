...
/**
 * GetIntervalsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetIntervalsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetIntervalsResponse';
    ...
    protected static $openAPITypes = [
        ...
        'intervals' => '\OpenAPI\Client\tinkoff\api\\Interval[]',
        'time_offset' => 'string'
    ];
     ...
     * Gets intervals
     *
     * @return \OpenAPI\Client\tinkoff\api\\Interval[]|null
     */
     ...
     * Sets intervals
     *
     * @param \OpenAPI\Client\tinkoff\api\\Interval[]|null $intervals Cписок объектов, содержащих информацию о начале и окончании временного интервала
     *
     * @return self
     */
     ...
     * Sets time_offset
     *
     * @param string $time_offset Временная зона адреса, для которого выбирается временной интервал, в формате ISO 8601, например, \"+03:00\"
     *
     * @return self
     */
