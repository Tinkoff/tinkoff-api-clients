...
/**
 * SelfEmployeeInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class SelfEmployeeInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployeeInfo';
     ...
     * Sets recipient_id
     *
     * @param int|null $recipient_id Идентификатор самозанятого. Возвращается в случае, если реестр в статусах DRAFT, ACCEPTED, PART_EXEC, EXECUTED
     *
     * @return self
     */
