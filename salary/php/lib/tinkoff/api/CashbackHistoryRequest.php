...
/**
 * CashbackHistoryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CashbackHistoryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashbackHistoryRequest';
     ...
     * Sets offset
     *
     * @param int $offset Номер элемента(смещение), начиная с которого возвращать результат
     *
     * @return self
     */
