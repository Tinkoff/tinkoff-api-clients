...
class Operation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rrn'] = $data['rrn'] ?? null;
     ...
     * Sets rrn
     *
     * @param string $rrn Идентификатор банковской транзакции
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $transaction_date Дата совершения операции в UTC(формат yyyy-MM-ddTHH:mm:ssZ)
     *
     * @return self
     */
