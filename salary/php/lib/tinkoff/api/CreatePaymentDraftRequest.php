...
namespace OpenAPI\Client\tinkoff\api\;

use \ArrayAccess;
use \OpenAPI\Client\ObjectSerializer;

/**
 * CreatePaymentDraftRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentDraftRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentDraftRequest';
    ...
    protected static $openAPITypes = [
        ...
        'bank_acnt' => 'string',
        'bank_bik' => 'string',
        'collection_amount_number' => 'float',
        'date' => '\DateTime',
    ...
    protected static $openAPIFormats = [
        ...
        'recipient_corr_account_number' => null,
        'recipient_name' => null,
        'revenue_type_code' => null,
        'tax_doc_date' => null,
        'tax_doc_number' => null,
        'tax_evidence' => null,
        'tax_payer_status' => null,
        'tax_period' => null,
        'uin' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'bank_acnt' => 'bankAcnt',
        'bank_bik' => 'bankBik',
        'collection_amount_number' => 'collectionAmountNumber',
        'date' => 'date',
        ...
        'recipient_corr_account_number' => 'recipientCorrAccountNumber',
    ...
    protected static $setters = [
        ...
        'amount' => 'setAmount',
        'bank_acnt' => 'setBankAcnt',
        'bank_bik' => 'setBankBik',
        'collection_amount_number' => 'setCollectionAmountNumber',
        'date' => 'setDate',
        ...
        'recipient_corr_account_number' => 'setRecipientCorrAccountNumber',
        'recipient_name' => 'setRecipientName',
        'revenue_type_code' => 'setRevenueTypeCode',
        'tax_doc_date' => 'setTaxDocDate',
        'tax_doc_number' => 'setTaxDocNumber',
        'tax_evidence' => 'setTaxEvidence',
        'tax_payer_status' => 'setTaxPayerStatus',
    ...
    protected static $getters = [
        ...
        'amount' => 'getAmount',
        'bank_acnt' => 'getBankAcnt',
        'bank_bik' => 'getBankBik',
        'collection_amount_number' => 'getCollectionAmountNumber',
        'date' => 'getDate',
        ...
        'recipient_corr_account_number' => 'getRecipientCorrAccountNumber',
        'recipient_name' => 'getRecipientName',
        'revenue_type_code' => 'getRevenueTypeCode',
        'tax_doc_date' => 'getTaxDocDate',
        'tax_doc_number' => 'getTaxDocNumber',
        'tax_evidence' => 'getTaxEvidence',
        'tax_payer_status' => 'getTaxPayerStatus',
    ...
    const REVENUE_TYPE_CODE__1 = '1';
    const REVENUE_TYPE_CODE__2 = '2';
    const REVENUE_TYPE_CODE__3 = '3';
     ...
     * @return string[]
     */
    public function getRevenueTypeCodeAllowableValues()
    {
        return [
            self::REVENUE_TYPE_CODE__1,
            self::REVENUE_TYPE_CODE__2,
            self::REVENUE_TYPE_CODE__3,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bank_acnt'] = $data['bank_acnt'] ?? null;
        $this->container['bank_bik'] = $data['bank_bik'] ?? null;
        $this->container['collection_amount_number'] = $data['collection_amount_number'] ?? null;
        $this->container['date'] = $data['date'] ?? null;
        $this->container['document_number'] = $data['document_number'] ?? null;
        $this->container['execution_order'] = $data['execution_order'] ?? null;
        $this->container['inn'] = $data['inn'] ?? null;
        $this->container['kbk'] = $data['kbk'] ?? null;
        $this->container['kpp'] = $data['kpp'] ?? null;
        $this->container['oktmo'] = $data['oktmo'] ?? null;
        $this->container['payment_purpose'] = $data['payment_purpose'] ?? null;
        $this->container['recipient_corr_account_number'] = $data['recipient_corr_account_number'] ?? null;
        $this->container['recipient_name'] = $data['recipient_name'] ?? null;
        $this->container['revenue_type_code'] = $data['revenue_type_code'] ?? null;
        $this->container['tax_doc_date'] = $data['tax_doc_date'] ?? null;
        $this->container['tax_doc_number'] = $data['tax_doc_number'] ?? null;
        $this->container['tax_evidence'] = $data['tax_evidence'] ?? null;
        $this->container['tax_payer_status'] = $data['tax_payer_status'] ?? null;
        $this->container['tax_period'] = $data['tax_period'] ?? null;
        $this->container['uin'] = $data['uin'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bank_acnt'] === null) {
            $invalidProperties[] = "'bank_acnt' can't be null";
        }
        ...
        if (!preg_match("/^(\\d{1,6})$/", $this->container['document_number'])) {
            $invalidProperties[] = "invalid value for 'document_number', must be conform to the pattern /^(\\d{1,6})$/.";
        }

        if (!is_null($this->container['execution_order']) && ($this->container['execution_order'] > 5)) {
            $invalidProperties[] = "invalid value for 'execution_order', must be smaller than or equal to 5.";
        }

        if (!is_null($this->container['execution_order']) && ($this->container['execution_order'] < 1)) {
            $invalidProperties[] = "invalid value for 'execution_order', must be bigger than or equal to 1.";
        }

        if ($this->container['inn'] === null) {
            $invalidProperties[] = "'inn' can't be null";
        }
        if (!preg_match("/^(\\d{12}|\\d{10}|0{1})$/", $this->container['inn'])) {
            $invalidProperties[] = "invalid value for 'inn', must be conform to the pattern /^(\\d{12}|\\d{10}|0{1})$/.";
        }
        ...
        if (!preg_match("/^(\\d{9}|0)$/", $this->container['kpp'])) {
            $invalidProperties[] = "invalid value for 'kpp', must be conform to the pattern /^(\\d{9}|0)$/.";
        }
        ...
        $allowedValues = $this->getRevenueTypeCodeAllowableValues();
        if (!is_null($this->container['revenue_type_code']) && !in_array($this->container['revenue_type_code'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'revenue_type_code', must be one of '%s'",
                $this->container['revenue_type_code'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['tax_doc_date'] === null) {
            $invalidProperties[] = "'tax_doc_date' can't be null";
        }
        if ($this->container['tax_doc_number'] === null) {
            $invalidProperties[] = "'tax_doc_number' can't be null";
        }
        if ($this->container['tax_evidence'] === null) {
            $invalidProperties[] = "'tax_evidence' can't be null";
        }
        if ($this->container['tax_payer_status'] === null) {
            $invalidProperties[] = "'tax_payer_status' can't be null";
        }
     ...
     * Sets account_number
     *
     * @param string $account_number Номер счета плательщика
     *
     * @return self
     */
     ...
     * @return string
     */
    public function getBankAcnt()
    {
        return $this->container['bank_acnt'];
    }

    /**
     * Sets bank_acnt
     *
     * @param string $bank_acnt Номер счета получателя
     *
     * @return self
     */
    public function setBankAcnt($bank_acnt)
    {
        $this->container['bank_acnt'] = $bank_acnt;
     ...
     * Sets bank_bik
     *
     * @param string $bank_bik БИК банка
     *
     * @return self
     */
    ...
    /**
     * Gets collection_amount_number
     *
     * @return float|null
     */
    public function getCollectionAmountNumber()
    {
        return $this->container['collection_amount_number'];
    }

    /**
     * Sets collection_amount_number
     *
     * @param float|null $collection_amount_number Удержанная сумма в рублях. Актуально только при платежах в пользу физлиц.
     *
     * @return self
     */
    public function setCollectionAmountNumber($collection_amount_number)
    {
        $this->container['collection_amount_number'] = $collection_amount_number;
     ...
     * Sets date
     *
     * @param \DateTime|null $date Дата и время исполнения платежа. Может быть в будущем, либо данное поле может быть не передано. **Если поле не передано, подписанный документ будет принят к исполнению немедленно.**
     *
     * @return self
     */
     ...
     *
     * @param string $document_number Номер распоряжения, определяемый клиентом.
     *
     * @return self
     */
    public function setDocumentNumber($document_number)
    {
        ...
        if ((!preg_match("/^(\\d{1,6})$/", $document_number))) {
            throw new \InvalidArgumentException("invalid value for $document_number when calling CreatePaymentDraftRequest., must conform to the pattern /^(\\d{1,6})$/.");
        }
     ...
     *
     * @param int|null $execution_order Очередность платежа
     *
     * @return self
     */
    public function setExecutionOrder($execution_order)
    {
        ...
        if (!is_null($execution_order) && ($execution_order > 5)) {
            throw new \InvalidArgumentException('invalid value for $execution_order when calling CreatePaymentDraftRequest., must be smaller than or equal to 5.');
        }
        if (!is_null($execution_order) && ($execution_order < 1)) {
            throw new \InvalidArgumentException('invalid value for $execution_order when calling CreatePaymentDraftRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets inn
     *
     * @param string $inn ИНН получателя. Если платеж выполняется в пользу физ. лица, и его ИНН неизвестен, в поле ИНН необходимо указать значение - \"0\". Во всех остальных случаях необходимо передавать фактический ИНН получателя.
     *
     * @return self
     */
    public function setInn($inn)
    {
        ...
        if ((!preg_match("/^(\\d{12}|\\d{10}|0{1})$/", $inn))) {
            throw new \InvalidArgumentException("invalid value for $inn when calling CreatePaymentDraftRequest., must conform to the pattern /^(\\d{12}|\\d{10}|0{1})$/.");
        }
     ...
     * Sets kbk
     *
     * @param string $kbk Код бюджетной классификации. Поле платежки 104. Если платеж не налоговый, в запросе поставьте 0.
     *
     * @return self
     */
     ...
     * Sets kpp
     *
     * @param string $kpp КПП. Если у получателя платежа нет КПП (например, это физлицо или ИП), то укажите КПП \"0\"
     *
     * @return self
     */
    public function setKpp($kpp)
    {
        ...
        if ((!preg_match("/^(\\d{9}|0)$/", $kpp))) {
            throw new \InvalidArgumentException("invalid value for $kpp when calling CreatePaymentDraftRequest., must conform to the pattern /^(\\d{9}|0)$/.");
        }
     ...
     * Sets oktmo
     *
     * @param string $oktmo Код ОКТМО территории, на которой мобилизуются денежные средства от уплаты налога, сбора и иного платежа. Если платеж не налоговый, в запросе поставьте 0.
     *
     * @return self
     */
     ...
     *
     * @param string $payment_purpose Назначение платежа
     *
     * @return self
     */
    public function setPaymentPurpose($payment_purpose)
    {
        if ((mb_strlen($payment_purpose) > 210)) {
            throw new \InvalidArgumentException('invalid length for $payment_purpose when calling CreatePaymentDraftRequest., must be smaller than or equal to 210.');
        }
        if ((mb_strlen($payment_purpose) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_purpose when calling CreatePaymentDraftRequest., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets recipient_corr_account_number
     *
     * @return string|null
     */
    public function getRecipientCorrAccountNumber()
    {
        return $this->container['recipient_corr_account_number'];
    }

    /**
     * Sets recipient_corr_account_number
     *
     * @param string|null $recipient_corr_account_number Корреспондентский счёт банка получателя. В случае налогового платежа обязательно указывается номер счета банка получателя средств (номер банковского счета, входящего в состав единого казначейского счета (ЕКС)) (подробнее https://www.nalog.ru/rn50/news/activities_fts/10104005/)
     *
     * @return self
     */
    public function setRecipientCorrAccountNumber($recipient_corr_account_number)
    {
        $this->container['recipient_corr_account_number'] = $recipient_corr_account_number;
     ...
     * Sets recipient_name
     *
     * @param string $recipient_name Получатель
     *
     * @return self
     */
    ...
    /**
     * Gets revenue_type_code
     *
     * @return string|null
     */
    public function getRevenueTypeCode()
    {
        return $this->container['revenue_type_code'];
    }

    /**
     * Sets revenue_type_code
     *
     * @param string|null $revenue_type_code Код вида выплаты. Обязательно заполняется при платежах в пользу физлиц. Подробнее: https://www.audit-it.ru/news/account/1013406.html
     *
     * @return self
     */
    public function setRevenueTypeCode($revenue_type_code)
    {
        $allowedValues = $this->getRevenueTypeCodeAllowableValues();
        if (!is_null($revenue_type_code) && !in_array($revenue_type_code, $allowedValues, true)) {
        ...
        $this->container['revenue_type_code'] = $revenue_type_code;
    ...
    {
        return $this->container['tax_doc_date'];
    }

    /**
     * Sets tax_doc_date
     *
     * @param string $tax_doc_date Дата налогового документа. Поле платежки 109. Формат — ДД.ММ.ГГГГ. Если платеж не налоговый, в запросе поставьте 0.
     *
     * @return self
     */
    public function setTaxDocDate($tax_doc_date)
    {
        $this->container['tax_doc_date'] = $tax_doc_date;
     ...
     * @return string
     */
    public function getTaxDocNumber()
    {
        return $this->container['tax_doc_number'];
    }

    /**
     * Sets tax_doc_number
     *
     * @param string $tax_doc_number Номер налогового документа. Поле платежки 108. Если платеж не налоговый, в запросе поставьте 0.
     *
     * @return self
     */
    public function setTaxDocNumber($tax_doc_number)
    {
        $this->container['tax_doc_number'] = $tax_doc_number;
     ...
     * @return string
     */
    public function getTaxEvidence()
    {
        return $this->container['tax_evidence'];
    }

    /**
     * Sets tax_evidence
     *
     * @param string $tax_evidence Основание налогового платежа. Поле платежки 106. Если платеж не налоговый, в запросе поставьте 0.
     *
     * @return self
     */
    public function setTaxEvidence($tax_evidence)
    {
        $this->container['tax_evidence'] = $tax_evidence;

        return $this;
    }

    /**
     * Gets tax_payer_status
     *
     * @return string
     */
    public function getTaxPayerStatus()
    {
        return $this->container['tax_payer_status'];
    }

    /**
     * Sets tax_payer_status
     *
     * @param string $tax_payer_status Статус составителя расчетного документа. Поле платежки 101. Если платеж не налоговый, в запросе поставьте 0.
     *
     * @return self
     */
    public function setTaxPayerStatus($tax_payer_status)
    {
        $this->container['tax_payer_status'] = $tax_payer_status;
     ...
     * Sets tax_period
     *
     * @param string $tax_period Налоговый период. Поле платежки 107. Формат — ДД.ММ.ГГГГ, первые два символа могут быть буквами. Если платеж не налоговый, в запросе поставьте 0.
     *
     * @return self
     */
     ...
     * Sets uin
     *
     * @param string $uin Уникальный идентификатор платежа. Если платеж не налоговый, в запросе поставьте 0.
     *
     * @return self
     */
