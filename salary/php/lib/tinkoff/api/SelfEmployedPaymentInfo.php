...
/**
 * SelfEmployedPaymentInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedPaymentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedPaymentInfo';
    ...
    protected static $openAPITypes = [
        ...
        'self_employed_info' => '\OpenAPI\Client\tinkoff\api\\SelfEmployeeInfo',
        'status' => 'string',
        'sum' => 'float'
    ];
    ...
    protected static $setters = [
        ...
        'self_employed_info' => 'setSelfEmployedInfo',
        'status' => 'setStatus',
        'sum' => 'setSum'
    ];
    ...
    protected static $getters = [
        ...
        'self_employed_info' => 'getSelfEmployedInfo',
        'status' => 'getStatus',
        'sum' => 'getSum'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['self_employed_info'] = $data['self_employed_info'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['self_employed_info'] === null) {
            $invalidProperties[] = "'self_employed_info' can't be null";
        }
     ...
     * Sets account_number
     *
     * @param string|null $account_number Номер счета самозанятого
     *
     * @return self
     */
     ...
     *
     * @param float|null $collection_amount Удержанная сумма
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int|null $number Идентификатор платежа на стороне клиента. Не возвращается в случае, если платежный реестр был создан через Личный Кабинет
     *
     * @return self
     */
     ...
     *
     * @param string|null $revenue_type_code Код вида дохода
     *
     * @return self
     */
    ...
    /**
     * Gets self_employed_info
     *
     * @return \OpenAPI\Client\tinkoff\api\\SelfEmployeeInfo
     */
    public function getSelfEmployedInfo()
    {
        return $this->container['self_employed_info'];
    }

    /**
     * Sets self_employed_info
     *
     * @param \OpenAPI\Client\tinkoff\api\\SelfEmployeeInfo $self_employed_info self_employed_info
     *
     * @return self
     */
    public function setSelfEmployedInfo($self_employed_info)
    {
        $this->container['self_employed_info'] = $self_employed_info;
     ...
     * Sets status
     *
     * @param string $status Статус платежа:<br><ul><li>WAITING - Платёж ожидает отправки реестра</li><li>ACCEPTED - Платёж ожидает исполнения реестра</li><li>EXECUTED - Платёж исполнен</li><li>REJECTED - Платёж отклонён банком</li><li>CANCELLED - Платёж отменён</li><li>DELETED - Платёж удалён</li><ul>
     *
     * @return self
     */
