...
/**
 * ClientOffersResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientOffersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientOffersResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\tinkoff\api\\ClientOffer[]'
    ];
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\tinkoff\api\\ClientOffer[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\tinkoff\api\\ClientOffer[]|null $data Клиентские офферы текущей страницы
     *
     * @return self
     */
