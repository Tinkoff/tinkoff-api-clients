...
/**
 * PaymentError1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentError1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentError1';
     ...
     * Sets account_number
     *
     * @param string|null $account_number Номер счёта самозанятого
     *
     * @return self
     */
