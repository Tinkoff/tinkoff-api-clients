...
/**
 * SubmitPaymentError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubmitPaymentError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitPaymentError';
     ...
     * Sets account_number
     *
     * @param string|null $account_number Номер счёта сотрудника
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\tinkoff\api\\FieldValidationError[]|null $errors Ошибки валидации
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int $number Идентификатор платежа, переданный клиентом при создании
     *
     * @return self
     */
