...
/**
 * CreatePhone1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePhone1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePhone1';
    ...
    const TYPE_MOBIL_NYJ = 'Мобильный';
    const TYPE_PO_MESTU_ZHITEL_STVA = 'По месту жительства';
    const TYPE_RABOCHIJ = 'Рабочий';
    ...
    public function getTypeAllowableValues()
    {
        return [
            self::TYPE_MOBIL_NYJ,
            self::TYPE_PO_MESTU_ZHITEL_STVA,
            self::TYPE_RABOCHIJ,
        ];
    }
