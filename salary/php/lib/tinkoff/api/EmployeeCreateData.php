...
/**
 * EmployeeCreateData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmployeeCreateData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeCreateData';
    ...
    protected static $openAPITypes = [
        'addresses' => '\OpenAPI\Client\tinkoff\api\\CreateAddress[]',
        'birth_date' => '\DateTime',
        'birth_place' => 'string',
        'citizenship' => 'string',
        'documents' => '\OpenAPI\Client\tinkoff\api\\CreateDocument[]',
        'email' => 'string',
        'first_name' => 'string',
        'job_info' => '\OpenAPI\Client\tinkoff\api\\CreateJobInfo',
        'last_name' => 'string',
        'latin_first_name' => 'string',
        'latin_last_name' => 'string',
        'middle_name' => 'string',
        'number' => 'int',
        'phones' => '\OpenAPI\Client\tinkoff\api\\CreatePhone[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['job_info'] = $data['job_info'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['job_info'] === null) {
            $invalidProperties[] = "'job_info' can't be null";
        }
     ...
     * Gets addresses
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreateAddress[]|null
     */
     ...
     * Sets addresses
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreateAddress[]|null $addresses Необходимо указать следующие адреса: Жительства, Регистрации, Работы
     *
     * @return self
     */
     ...
     * Gets documents
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreateDocument[]|null
     */
     ...
     * Sets documents
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreateDocument[]|null $documents <br> <b>Для граждан РФ</b> необходимо указать: <ul>   <li>Данные паспорта</li> </ul> <b>Для иностранных граждан</b> необходимо указать: <ul>   <li>Один из основных документов: \"Иностранный паспорт\", \"Загр. паспорт иностранного гр.\", \"Служебный/официальный паспорт\", \"Дипломатический паспорт\"</li>   <li>Один из миграционных документов: \"Миграционная карта\", \"Разр. на временное проживание\", \"Вид на жительство\"</li> </ul>
     *
     * @return self
     */
     ...
     * Gets job_info
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreateJobInfo
     */
    public function getJobInfo()
    {
        return $this->container['job_info'];
    }

    /**
     * Sets job_info
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreateJobInfo $job_info job_info
     *
     * @return self
     */
    public function setJobInfo($job_info)
    {
        $this->container['job_info'] = $job_info;
     ...
     * Sets number
     *
     * @param int $number Идентификатор сотрудника на стороне клиента
     *
     * @return self
     */
     ...
     * Gets phones
     *
     * @return \OpenAPI\Client\tinkoff\api\\CreatePhone[]|null
     */
     ...
     * Sets phones
     *
     * @param \OpenAPI\Client\tinkoff\api\\CreatePhone[]|null $phones Необходимо указать: Мобильный телефон
     *
     * @return self
     */
