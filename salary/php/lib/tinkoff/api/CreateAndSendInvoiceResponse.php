...
/**
 * CreateAndSendInvoiceResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateAndSendInvoiceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAndSendInvoiceResponse';
    ...
    {
        $this->container['pdf_url'] = $data['pdf_url'] ?? null;
    }
     ...
     * Sets pdf_url
     *
     * @param string $pdf_url Ссылка на pdf выставленного счета
     *
     * @return self
     */
