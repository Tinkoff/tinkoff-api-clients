...
/**
 * ReceiverRequisites Class Doc Comment
 *
 * @category Class
 ...
 */
class ReceiverRequisites implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceiverRequisites';
    ...
    protected static $attributeMap = [
        ...
        'bank_name' => 'bankName',
        'bik' => 'bik',
        'corr_account_number' => 'corrAccountNumber',
        'inn' => 'inn',
        'kpp' => 'kpp',
        'name' => 'name'
    ];
    ...
    protected static $setters = [
        ...
        'bik' => 'setBik',
        'corr_account_number' => 'setCorrAccountNumber',
        'inn' => 'setInn',
        'kpp' => 'setKpp',
        'name' => 'setName'
    ];
    ...
    protected static $getters = [
        ...
        'bik' => 'getBik',
        'corr_account_number' => 'getCorrAccountNumber',
        'inn' => 'getInn',
        'kpp' => 'getKpp',
        'name' => 'getName'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bik'] = $data['bik'] ?? null;
        $this->container['corr_account_number'] = $data['corr_account_number'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(\\d{20}|\\d{22})$/", $this->container['account_number'])) {
            $invalidProperties[] = "invalid value for 'account_number', must be conform to the pattern /^(\\d{20}|\\d{22})$/.";
        }
        ...
        if ($this->container['bik'] === null) {
            $invalidProperties[] = "'bik' can't be null";
        }
        if (!preg_match("/\\d{9}/", $this->container['bik'])) {
            $invalidProperties[] = "invalid value for 'bik', must be conform to the pattern /\\d{9}/.";
        }

        if ($this->container['corr_account_number'] === null) {
            $invalidProperties[] = "'corr_account_number' can't be null";
        }
        if (!preg_match("/\\d{20}/", $this->container['corr_account_number'])) {
            $invalidProperties[] = "invalid value for 'corr_account_number', must be conform to the pattern /\\d{20}/.";
        }
     ...
     * Sets account_number
     *
     * @param string $account_number Номер расчетного счета
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((!preg_match("/^(\\d{20}|\\d{22})$/", $account_number))) {
            throw new \InvalidArgumentException("invalid value for $account_number when calling ReceiverRequisites., must conform to the pattern /^(\\d{20}|\\d{22})$/.");
        }
     ...
     * Sets bank_name
     *
     * @param string $bank_name Наименование банка получателя
     *
     * @return self
     */
    public function setBankName($bank_name)
    {
        if ((mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling ReceiverRequisites., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bank_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling ReceiverRequisites., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['bik'];
    }

    /**
     * Sets bik
     *
     * @param string $bik БИК банка получателя
     *
     * @return self
     */
    public function setBik($bik)
    {
        ...
        if ((!preg_match("/\\d{9}/", $bik))) {
            throw new \InvalidArgumentException("invalid value for $bik when calling ReceiverRequisites., must conform to the pattern /\\d{9}/.");
        }

        $this->container['bik'] = $bik;

        return $this;
    }

    /**
     * Gets corr_account_number
     *
     * @return string
     */
    public function getCorrAccountNumber()
    {
        return $this->container['corr_account_number'];
    }

    /**
     * Sets corr_account_number
     *
     * @param string $corr_account_number Корреспондентский счёт банка получателя
     *
     * @return self
     */
    public function setCorrAccountNumber($corr_account_number)
    {

        if ((!preg_match("/\\d{20}/", $corr_account_number))) {
            throw new \InvalidArgumentException("invalid value for $corr_account_number when calling ReceiverRequisites., must conform to the pattern /\\d{20}/.");
        }

        $this->container['corr_account_number'] = $corr_account_number;
    ...
    public function setInn($inn)
    {
        ...
        if ((!preg_match("/^(\\d{12}|\\d{10}|0{1})$/", $inn))) {
            throw new \InvalidArgumentException("invalid value for $inn when calling ReceiverRequisites., must conform to the pattern /^(\\d{12}|\\d{10}|0{1})$/.");
        }
    ...
    public function setKpp($kpp)
    {
        ...
        if (!is_null($kpp) && (!preg_match("/^(\\d{9})$/", $kpp))) {
            throw new \InvalidArgumentException("invalid value for $kpp when calling ReceiverRequisites., must conform to the pattern /^(\\d{9})$/.");
        }
