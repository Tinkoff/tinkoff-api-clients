...
/**
 * CardInfoSeqResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CardInfoSeqResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardInfoSeqResponse';
    ...
    protected static $openAPITypes = [
        'cards' => '\OpenAPI\Client\tinkoff\api\\CardInfoResponse[]',
        'limit' => 'int',
        'offset' => 'int',
        'total_number' => 'int'
    ];
     ...
     * Gets cards
     *
     * @return \OpenAPI\Client\tinkoff\api\\CardInfoResponse[]|null
     */
     ...
     * Sets cards
     *
     * @param \OpenAPI\Client\tinkoff\api\\CardInfoResponse[]|null $cards Список карт компании
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int $limit Количество карт на странице
     *
     * @return self
     */
     ...
     * Sets offset
     *
     * @param int $offset Количество пропущенных карт
     *
     * @return self
     */
     ...
     * Sets total_number
     *
     * @param int $total_number Общее количество карт
     *
     * @return self
     */
