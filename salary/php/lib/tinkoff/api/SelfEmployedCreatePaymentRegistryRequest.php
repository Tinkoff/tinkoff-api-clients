...
/**
 * SelfEmployedCreatePaymentRegistryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedCreatePaymentRegistryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedCreatePaymentRegistryRequest';
    ...
    protected static $openAPITypes = [
        ...
        'load_date' => 'string',
        'payments' => '\OpenAPI\Client\tinkoff\api\\SelfEmployedCreatePaymentInfo[]',
        'registry_create_type' => '\OpenAPI\Client\tinkoff\api\\SelfEmployedRegistryCreateTypeRequest',
        'tax_holding' => 'bool'
    ];
    ...
    protected static $attributeMap = [
        ...
        'load_date' => 'loadDate',
        'payments' => 'payments',
        'registry_create_type' => 'registryCreateType',
        'tax_holding' => 'taxHolding'
    ];
    ...
    protected static $setters = [
        ...
        'registry_create_type' => 'setRegistryCreateType',
        'tax_holding' => 'setTaxHolding'
    ];
    ...
    protected static $getters = [
        ...
        'registry_create_type' => 'getRegistryCreateType',
        'tax_holding' => 'getTaxHolding'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['registry_create_type'] = $data['registry_create_type'] ?? null;
        $this->container['tax_holding'] = $data['tax_holding'] ?? null;
    }
     ...
     * Sets correlation_id
     *
     * @param string $correlation_id Идентификатор, связывающий запрос создания с запросом получения ответа
     *
     * @return self
     */
     ...
     * Sets load_date
     *
     * @param string|null $load_date Дата отправки реестра
     *
     * @return self
     */
     ...
     * Gets payments
     *
     * @return \OpenAPI\Client\tinkoff\api\\SelfEmployedCreatePaymentInfo[]|null
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\tinkoff\api\\SelfEmployedCreatePaymentInfo[]|null $payments Список платежей внутри реестра
     *
     * @return self
     */
    ...
    /**
     * Gets registry_create_type
     *
     * @return \OpenAPI\Client\tinkoff\api\\SelfEmployedRegistryCreateTypeRequest|null
     */
    public function getRegistryCreateType()
    {
        return $this->container['registry_create_type'];
    }

    /**
     * Sets registry_create_type
     *
     * @param \OpenAPI\Client\tinkoff\api\\SelfEmployedRegistryCreateTypeRequest|null $registry_create_type registry_create_type
     *
     * @return self
     */
    public function setRegistryCreateType($registry_create_type)
    {
        $this->container['registry_create_type'] = $registry_create_type;
     ...
     * @return bool|null
     */
    public function getTaxHolding()
    {
        return $this->container['tax_holding'];
    }

    /**
     * Sets tax_holding
     *
     * @param bool|null $tax_holding Если true, то Тинькофф переведет 6% от суммы платежа на налоговую копилку для последующей оплаты налогов. Если false, самозанятый получит полную сумму и налог удержан не будет. По умолчанию false.
     *
     * @return self
     */
    public function setTaxHolding($tax_holding)
    {
        $this->container['tax_holding'] = $tax_holding;
