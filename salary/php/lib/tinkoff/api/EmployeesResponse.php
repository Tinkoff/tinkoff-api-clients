 ...
 */
class EmployeesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeesResponse';
    ...
    protected static $openAPITypes = [
        'employee_id' => 'int',
        'errors' => '\OpenAPI\Client\tinkoff\api\\FieldValidationError[]',
        'first_name' => 'string',
        'last_name' => 'string',
        'middle_name' => 'string',
        'number' => 'int',
     ...
     * Sets employee_id
     *
     * @param int|null $employee_id Идентификатор сотрудника в Зарплатном Проекте. Может не прийти, если при создании сотрудника возникли ошибки.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\tinkoff\api\\FieldValidationError[]|null $errors Список ошибок
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int $number Номер сотрудника, переданный клиентом при создании
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус создания:<br><ul><li>QUEUED - сотрудник в данный момент стоит в очереди на создание</li><li>CREATED - сотрудник создан в Зарплатном Проекте</li><li>ERROR - сотрудник не был создан в Зарплатном Проекте (ошибки перечислены в поле <b>errors</b>)</li><ul>
     *
     * @return self
     */
