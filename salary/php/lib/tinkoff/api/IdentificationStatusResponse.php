...
/**
 * IdentificationStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IdentificationStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdentificationStatusResponse';
    ...
    {
        $this->container['is_identified'] = $data['is_identified'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_identified'] === null) {
            $invalidProperties[] = "'is_identified' can't be null";
        }
    ...
    {
        return $this->container['is_identified'];
    }

    /**
     * Sets is_identified
     *
     * @param bool $is_identified Идентифицирован ли пользователь
     *
     * @return self
     */
    public function setIsIdentified($is_identified)
    {
        $this->container['is_identified'] = $is_identified;
