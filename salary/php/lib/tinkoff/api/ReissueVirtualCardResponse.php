...
/**
 * ReissueVirtualCardResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReissueVirtualCardResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReissueVirtualCardResponse';
     ...
     * Sets correlation_id
     *
     * @param string $correlation_id Идентификатор заявки на перевыпуск виртуальной карты
     *
     * @return self
     */
