...
/**
 * DeliveryTask Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryTask';
    ...
    protected static $openAPITypes = [
        'documents' => '\OpenAPI\Client\tinkoff\api\\DeliveryTaskDocument[]',
        'id' => 'string',
        'meet_result' => 'string',
        'resolution' => 'string',
        'status' => 'string',
    ...
    protected static $setters = [
        ...
        'id' => 'setId',
        'meet_result' => 'setMeetResult',
        'resolution' => 'setResolution',
        'status' => 'setStatus',
        'sub_resolution' => 'setSubResolution',
    ...
    protected static $getters = [
        ...
        'id' => 'getId',
        'meet_result' => 'getMeetResult',
        'resolution' => 'getResolution',
        'status' => 'getStatus',
        'sub_resolution' => 'getSubResolution',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['meet_result'] = $data['meet_result'] ?? null;
        $this->container['resolution'] = $data['resolution'] ?? null;
        $this->container['status'] = $data['status'] ?? null;
        $this->container['sub_resolution'] = $data['sub_resolution'] ?? null;
     ...
     * Gets documents
     *
     * @return \OpenAPI\Client\tinkoff\api\\DeliveryTaskDocument[]|null
     */
     ...
     * Sets documents
     *
     * @param \OpenAPI\Client\tinkoff\api\\DeliveryTaskDocument[]|null $documents Группа объектов с информацией о документах, относящихся к заданию. Может быть пустым, если документы не нужны в качестве результатов задания
     *
     * @return self
     */
    ...
    {
        return $this->container['meet_result'];
    }

    /**
     * Sets meet_result
     *
     * @param string|null $meet_result meet_result
     *
     * @return self
     */
    public function setMeetResult($meet_result)
    {
        $this->container['meet_result'] = $meet_result;
     ...
     * Sets resolution
     *
     * @param string|null $resolution Результат задания
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getSubResolution()
    {
        return $this->container['sub_resolution'];
    }

    /**
     * Sets sub_resolution
     *
     * @param string|null $sub_resolution Детальное описание результата задания
     *
     * @return self
     */
    public function setSubResolution($sub_resolution)
    {
        $this->container['sub_resolution'] = $sub_resolution;
     ...
     * Sets template
     *
     * @param string $template Шаблон задания
     *
     * @return self
     */
