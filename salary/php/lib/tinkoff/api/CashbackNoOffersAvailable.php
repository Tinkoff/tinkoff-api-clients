...
/**
 * CashbackNoOffersAvailable Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CashbackNoOffersAvailable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashbackNoOffersAvailable';
     ...
     * Sets message
     *
     * @param string $message Офферы для данного чека не найдены
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type CASHBACK_NO_OFFERS_AVAILABLE
     *
     * @return self
     */
