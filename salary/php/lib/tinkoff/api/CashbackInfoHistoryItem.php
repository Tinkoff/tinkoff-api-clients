...
/**
 * CashbackInfoHistoryItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CashbackInfoHistoryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashbackInfoHistoryItem';
     ...
     * Sets amount
     *
     * @param string $amount Сумма кэшбэка
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime $date Дата начисления кэшбэка
     *
     * @return self
     */
     ...
     * Sets offer_id
     *
     * @param int $offer_id В рамках какого оффера было начисление
     *
     * @return self
     */
