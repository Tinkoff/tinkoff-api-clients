...
/**
 * ReissueVirtualCardResultResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReissueVirtualCardResultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReissueVirtualCardResultResponse';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'info' => '\OpenAPI\Client\tinkoff\api\\ReissuedVirtualCardInfo'
    ];
     ...
     * Sets status
     *
     * @param string $status Статус заявки на перевыпуск виртуальной карты. status = READY - карта успешно перевыпущена, вы можете ей пользоваться
     *
     * @return self
     */
     ...
     * Gets info
     *
     * @return \OpenAPI\Client\tinkoff\api\\ReissuedVirtualCardInfo
     */
     ...
     * Sets info
     *
     * @param \OpenAPI\Client\tinkoff\api\\ReissuedVirtualCardInfo $info info
     *
     * @return self
     */
