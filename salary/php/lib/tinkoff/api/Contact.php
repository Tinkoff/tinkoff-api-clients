...
class Contact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'birth_date' => '\DateTime',
        'documents' => '\OpenAPI\Client\tinkoff\api\\IdentificationDocument[]',
        'first_name' => 'string',
        'id' => 'string',
        'last_name' => 'string',
        'middle_name' => 'string',
        'phones' => '\OpenAPI\Client\tinkoff\api\\Phone[]',
        'role' => 'string'
    ];
     ...
     * Gets documents
     *
     * @return \OpenAPI\Client\tinkoff\api\\IdentificationDocument[]|null
     */
     ...
     * Sets documents
     *
     * @param \OpenAPI\Client\tinkoff\api\\IdentificationDocument[]|null $documents Документы удостоверяющие личность. Для роли REALTOR может быть пустым
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Уникальный идентификатор контакта
     *
     * @return self
     */
     ...
     * Gets phones
     *
     * @return \OpenAPI\Client\tinkoff\api\\Phone[]|null
     */
     ...
     * Sets phones
     *
     * @param \OpenAPI\Client\tinkoff\api\\Phone[]|null $phones Телефон
     *
     * @return self
     */
