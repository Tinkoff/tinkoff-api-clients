...
/**
 * SelfEmployedFiscalizePaymentRegistryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedFiscalizePaymentRegistryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedFiscalizePaymentRegistryRequest';
     ...
     *
     * @param int $payment_registry_id Номер платежного реестра
     *
     * @return self
     */
