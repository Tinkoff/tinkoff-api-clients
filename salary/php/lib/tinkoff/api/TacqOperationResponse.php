...
/**
 * TacqOperationResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TacqOperationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TacqOperationResponse';
    ...
    protected static $openAPITypes = [
        ...
        'operations' => '\OpenAPI\Client\tinkoff\api\\Operation[]'
    ];
     ...
     *
     * @param \DateTime|null $last_transaction_date Последняя дата совершения транзакции для выборки в UTC (формат yyyy-MM-ddTHH:mm:ssZ)
     *
     * @return self
     */
     ...
     * Gets operations
     *
     * @return \OpenAPI\Client\tinkoff\api\\Operation[]|null
     */
     ...
     * Sets operations
     *
     * @param \OpenAPI\Client\tinkoff\api\\Operation[]|null $operations Список операций по терминалу
     *
     * @return self
     */
