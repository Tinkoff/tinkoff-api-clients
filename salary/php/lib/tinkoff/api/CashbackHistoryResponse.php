...
/**
 * CashbackHistoryResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CashbackHistoryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashbackHistoryResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\tinkoff\api\\CashbackHistoryItem[]'
    ];
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\tinkoff\api\\CashbackHistoryItem[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\tinkoff\api\\CashbackHistoryItem[]|null $data История начисления кэшбэка по чекам
     *
     * @return self
     */
