...
/**
 * CreateSelfEmployedRegistrationInfo Class Doc Comment
 *
 * @category Class
 * @description Если значение передано, Тинькофф поставит исполнителя на учет как самозанятого. Функция доступна клиентам, которые получили от исполнителей согласие на регистрацию
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateSelfEmployedRegistrationInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSelfEmployedRegistrationInfo';
    ...
    protected static $setters = [
        'activity_codes' => 'setActivityCodes',
        'oktmo' => 'setOktmo'
    ];
    ...
    protected static $getters = [
        'activity_codes' => 'getActivityCodes',
        'oktmo' => 'getOktmo'
    ];
    ...
    {
        $this->container['activity_codes'] = $data['activity_codes'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['activity_codes'] === null) {
            $invalidProperties[] = "'activity_codes' can't be null";
        }
    ...
    {
        return $this->container['activity_codes'];
    }

    /**
     * Sets activity_codes
     *
     * @param string[] $activity_codes Коды активностей
     *
     * @return self
     */
    public function setActivityCodes($activity_codes)
    {
        $this->container['activity_codes'] = $activity_codes;
