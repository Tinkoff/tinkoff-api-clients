...
/**
 * SelfEmployedCreatePaymentInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SelfEmployedCreatePaymentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfEmployedCreatePaymentInfo';
     ...
     * Sets account_number
     *
     * @param string $account_number Номер счета самозанятого
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param int $number Идентификатор платежа на стороне клиента
     *
     * @return self
     */
