...
/**
 * ClientMerchantCategory Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientMerchantCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientMerchantCategory';
     ...
     *
     * @param int|null $category_weight Вес категории для клиента
     *
     * @return self
     */
     ...
     *
     * @param int|null $merchant_category_weight Вес партнера в категории для клиента
     *
     * @return self
     */
