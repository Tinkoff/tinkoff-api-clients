...
/**
 * DriverLicenseResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DriverLicenseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DriverLicenseResponse';
     ...
     * Sets doc_number
     *
     * @param string $doc_number Номер документа водительского удостоверения
     *
     * @return self
     */
     ...
     * Sets issue_date
     *
     * @param \DateTime|null $issue_date Дата выдачи водительского удостоверения
     *
     * @return self
     */
