...
public class Operation {
  ...
  public Operation amount(Long amount) {
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "Сумма операции")
  ...
  public Operation cardNumber(String cardNumber) {
  ...
  **/
  ...
  public Operation rrn(String rrn) {
   ...
   * @return rrn
  **/
  @ApiModelProperty(required = true, value = "Идентификатор банковской транзакции")
  ...
  public Operation transactionDate(OffsetDateTime transactionDate) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Дата совершения операции в UTC(формат yyyy-MM-ddTHH:mm:ssZ)")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Тип операции")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, operation.amount) &&
        Objects.equals(this.cardNumber, operation.cardNumber) &&
        Objects.equals(this.rrn, operation.rrn) &&
        Objects.equals(this.transactionDate, operation.transactionDate) &&
        Objects.equals(this.type, operation.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, cardNumber, rrn, transactionDate, type);
  }
